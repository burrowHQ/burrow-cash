  ...
  [3005],
  {
    ...
    9745: (e, t, s) => {
      ...
      const r = n.forwardRef((e, t) => {
        const { icon: s = "", ...r } = e;
        return n.createElement("span", { ...r, ref: t, dangerouslySetInnerHTML: { __html: s } });
      });
    },
    76460: (e, t, s) => {
      "use strict";
    ...
    70412: (e, t, s) => {
      "use strict";
      s.d(t, { hoverMouseEventFilter: () => i, useAccurateHover: () => a, useHover: () => r });
      var n = s(50959);
      function r() {
    ...
    46618: (e, t, s) => {
      ...
      var n = s(50959),
        ...
        f = s(63869);
      function g(e) {
        return n.createElement("div", { className: o()(f.separator, e.className) });
      }
      var S = s(21043);
      function y(e) {
        const {
      ...
      var k = s(88275),
        ...
        L = s(61380),
        F = s(64553);
      const O = { isVisibleScrollbar: !0, shouldMeasure: !0, hideButtonsFrom: 1 };
      function W(e) {
      ...
      function N(e) {
        return n.createElement("div", {
          className: a(F.fadeRight, e.className, { [F.isVisible]: e.isVisible }),
        });
      }
      function T(e) {
      ...
      function B(e) {
        return n.createElement(
          "div",
          { className: a(e.className, { [F.isVisible]: e.isVisible }), onClick: e.onClick },
          n.createElement(
            "div",
          ...
          ((o = class extends n.PureComponent {
            constructor(e) {
              super(e),
                ...
                (this._handleResizeContent = ([e]) => {
                  ...
                  const { shouldDecreaseWidthContent: s, buttonsWidthIfDecreasedWidthContent: n } =
                    this.props;
                  s && n
            ...
            render() {
              const {
                ...
                { isVisibleRightButton: g, isVisibleLeftButton: S } = this.state,
                y = d && h;
              return n.createElement(
                _.Measure,
                ...
                (d) =>
                  n.createElement(
                    "div",
                    { className: F.wrapOverflow, onMouseOver: m, onMouseOut: v, ref: d },
                    n.createElement(
                      "div",
                      ...
                      n.createElement(
                        "div",
                        {
                          className: a(F.scrollWrap, p, { [F.noScrollBar]: !o }),
                      ...
                      c && n.createElement(t, { onClick: this._handleScrollRight, isVisible: g }),
                    ),
                  ),
              );
            }
              ...
              return e.map((e) =>
                n.createElement(
                  ...
                  ((e) => {
                    switch (e.type) {
                      case "Button":
                        return n.createElement(r.Custom, { ...e.params, isFake: t });
                      case "TradingViewStyledButton":
                        return n.createElement(r.CustomTradingViewStyledButton, {
                          ...e.params,
                          className: X.button,
                          displayMode: s,
                        });
                      case "Dropdown":
                        return n.createElement(r.Dropdown, { displayMode: s, params: e.params });
                      default:
                        return null;
                    }
                  })(e),
        ...
        render() {
          ...
          return n.createElement(
                        ...
                        n.createElement(
                          ...
                          (function (e) {
                                    ...
                                    if (n.isValidElement(e)) {
                                      switch ([t - 1, t, t + 1].indexOf(s)) {
                                        case 0:
                                          ...
                                          break;
                                        case 1:
                                          const s = { noLeftDecoration: !0, noRightDecoration: !0 };
                            ...
                            n.Children.toArray([
                              ...
                              !o &&
                                (e.Properties || e.Fullscreen || (!U && e.Screenshot)) &&
                                n.createElement(
                                  y,
                                  { key: "properties" },
                                  !o &&
            ...
            e.Publish &&
              !o &&
              !h &&
              n.createElement(e.Publish, { id: P.PublishDesktop, className: X.desktopPublish }),
          );
        }
      ...
      class le {
        ...
        getDefaultIntervals() {
          return null === this._chartApiInstance
            ? []
            : this._chartApiInstance.defaultResolutions().map($.normalizeIntervalString);
        }
        getCustomIntervals() {
        ...
        add(e, t, s) {
          ...
          return this._isIntervalDefault(n) || r.includes(n)
            ? null
            : (this._customIntervalsService.set((0, $.sortResolutions)([...r, n])), n);
        }
        remove(e) {
      ...
      class ve {
        ...
        addFavorite(e) {
          const t = this.favId(e);
          this._favorites.push(fe(t)), this._favoritesChanged.fire(t), this._saveFavs();
        }
        removeFavorite(e) {
          const t = this.favId(e),
            s = this._findFavIndex(t);
          -1 !== s && (this._favorites.splice(s, 1), this._favoritesChanged.fire(t)),
            this._saveFavs();
        }
        favId(e) {
        ...
        _saveFavs() {
          ...
          this._settings.setJSON("studyMarket.favorites", e, { forceFlush: !0 }),
            re.TVXWindowEvents.emit("StudyFavoritesChanged", JSON.stringify({ favorites: e }));
        }
        _stateToSave() {
      ...
      class Ve extends n.PureComponent {
        constructor(e) {
          ...
          this._favoriteChartStylesService = h || new J(re.TVXWindowEvents, ne, E);
          const b = we(this.props.defaultFavoriteIntervals);
          (this._favoriteIntervalsService = l || new ee(re.TVXWindowEvents, ne, b)),
            (this._intervalsMenuViewStateService = new ye(re.TVXWindowEvents, ne)),
        ...
        componentDidUpdate(e, t) {
          ...
          s !== t.isVisible && (h.emit("toggle_header", s), this._negotiateResizer()),
        ...
        _setDisplayMode() {
          const { availableWidth: e } = this.state,
            ...
            s = { full: this._fullWidth, medium: this._favoritesWidth, small: this._collapseWidth },
      ...
      class Le {
        constructor(e, t) {
          (this._component = null),
            ...
            (this._container = e),
            r.render(n.createElement(Ve, { ...t, ref: this._handleRef }), this._container);
        }
        destroy() {
