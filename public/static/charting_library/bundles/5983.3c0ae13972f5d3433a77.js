  ...
  [5983],
  {
    ...
    56073: (e, t, n) => {
      ...
      function i(e, t = !1) {
        ...
        return (
          "border-box" !== n.boxSizing &&
            i.push(n.paddingTop, n.paddingBottom, n.borderTopWidth, n.borderBottomWidth),
      ...
      function a(e, t = !1) {
        ...
        return (
          "border-box" !== n.boxSizing &&
            i.push(n.paddingLeft, n.paddingRight, n.borderLeftWidth, n.borderRightWidth),
    ...
    75983: (e, t, n) => {
      ...
      function b(e) {
        const {
          ...
          k = (0, a.useMemo)(() => t.reduce((e, t, n) => (l(t) && e.push(n), e), []), [t, l]),
          w = (0, a.useCallback)(() => {
        ...
        const s = (0, a.useCallback)(
          (n, a) => {
            ...
            return (function ({
              ...
              const d = [...n];
              if (((u = l.map((e) => d[e]).reduce((e, t) => e + t, 0) + a), s === i.EndFirst))
      ...
      function E(e) {
        ...
        const {
          ...
          S = (0, a.useRef)(
            null !== (n = null === (t = e.itemsRefs) || void 0 === t ? void 0 : t.current) &&
              void 0 !== n
              ? n
              : new Map(),
          ),
          ...
          X = (0, a.useCallback)(
            (e, t) => {
              o ||
                ...
                (E(e),
                "number" == typeof t
                  ? (clearTimeout(M.current), (M.current = setTimeout(() => O(e), t)))
                  : O(e));
            },
            [o, E, O],
          ),
          ...
          P = B({
            isRtl: g,
            items: (0, a.useMemo)(() => l.filter((e) => !o && !e.disabled), [l, o]),
            activationType: r,
        ...
        const [K, L] = (0, R.useKeepActiveItemIntoView)({
          ...
          q = l.map((e) => {
            ...
            const i = T(e),
              a = f(e),
              l =
                null !== (n = null !== (t = e.disabled) && void 0 !== t ? t : o) &&
                void 0 !== n &&
                n,
              s = !l && (Y ? i : a);
            return {
      ...
      const M = (0, a.forwardRef)((e, t) => {
        ...
        return a.createElement(
          ...
          d && "string" == typeof m
            ? a.createElement(
                "span",
                { className: s()(T["ellipsis-children"], "apply-overflow-tooltip") },
                m,
              )
            : m,
        );
        ...
        const {
          ...
          C = (function (e, t) {
            ...
            return (
              ...
              (0, a.useCallback)(() => {
                const i = (0, y.ensureNotNull)(t.current).getBoundingClientRect(),
                  a = n.current[e];
                return {
                  x: i.left,
      ...
      function ne(e) {
        ...
        return l(te["scroll-wrap"], te[`size-${t}`], "scroll" === n && te["enable-scroll"], i);
      }
      function ie() {
        const [e, t] = (0, a.useState)(!1);
        return (
      ...
      function ce(e) {
        const {
          ...
          S = ie(),
          I = (function (e) {
            const t = (0, _.useSafeMatchMedia)(ee["media-mf-phone-landscape"], !0),
              n = ie();
          ...
          ve = (0, a.useCallback)(
            (e) => {
              var t;
              return null !== (t = se.find((t) => t.id === e.id)) && void 0 !== t ? t : {};
            },
            [se],
          ),
          ge = (0, a.useCallback)(() => {
        ...
        const we = (function (e, t, n) {
          const [i, l] = (0, a.useState)(),
            ...
            r = (e) => {
              var t;
              const n = null !== (t = e.parentElement) && void 0 !== t ? t : void 0;
              if (void 0 === n) return;
        ...
        return a.createElement(
          ...
          a.createElement(
            ...
            a.createElement(
              ...
              q.map((e) => a.createElement(X, { ...ve(e), key: e.id, item: e, fake: !0 })),
              a.createElement(Z, {
                size: d,
                disabled: c,
                isOpened: $,
