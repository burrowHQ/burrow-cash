  ...
  [731],
  {
    ...
    9745: (e, t, o) => {
      ...
      const a = r.forwardRef((e, t) => {
        const { icon: o = "", ...a } = e;
        return r.createElement("span", { ...a, ref: t, dangerouslySetInnerHTML: { __html: o } });
      });
    },
    99663: (e, t, o) => {
      "use strict";
      ...
      const r = (() => {
        ...
        return () => {
          ...
          if (void 0 === e) {
            ...
            null === (t = o.parentNode) || void 0 === t || t.removeChild(o), (e = a - s);
          }
          return e;
        };
      })();
      ...
      function c(e) {
        ...
        if (e && 1 == ++i) {
          ...
          "hidden" !== e.toLowerCase() &&
            ...
            (a(o, "right", `${r()}px`), (t.style.paddingRight = `${i + r()}px`), (l = !0)),
    ...
    14283: (e, t, o) => {
      ...
      var D = o(46148);
      function z(e) {
        const { compareModel: t, selectedCompareOptionIndex: n } = (0, k.useEnsuredContext)(_),
          ...
          i = (0, r.useMemo)(
            () =>
              (function (e) {
                return [
                  {
                    label: e ? a.t(null, void 0, o(17547)) : a.t(null, void 0, o(82642)),
                    compareOption: e ? D.CompareOption.SameScale : D.CompareOption.SamePctScale,
                  },
                  {
                    label: a.t(null, void 0, o(34420)),
                    compareOption: D.CompareOption.NewPriceScale,
                  },
                  { label: a.t(null, void 0, o(67242)), compareOption: D.CompareOption.NewPane },
                ];
              })(s),
            [s],
          );
        return [
          (0, r.useMemo)(() => {
            var e, t;
            return null !== (t = null === (e = i[n]) || void 0 === e ? void 0 : e.compareOption) &&
              void 0 !== t
              ? t
              : i[0].compareOption;
          }, [i, n]),
      ...
      var L = o(85286);
      function T(e) {
        const { fullSymbolName: t, isSelected: n, className: s, isYield: l } = e,
          {
            isMobile: d,
            searchRef: u,
            setMode: m,
        ...
        return d
          ? r.createElement(
              ...
              r.createElement(
                ...
                r.createElement("div", { className: L.header }, a.t(null, void 0, o(79589))),
          ...
          : r.createElement(
              "div",
              { className: c()(L.wrap, s), "data-name": "compare-buttons-group" },
              S.map(({ label: e, compareOption: t }) =>
                r.createElement(
                  M,
                  {
      ...
      function R(e) {
        const { handleListWidth: t } = (0, d.ensureNotNull)(
          ...
          k = (0, h.useWatchedValueReadonly)({ watchedValue: n.highlightedSymbol() }),
                ...
                (function () {
                  ...
                  if (!Boolean(x.length) && !Boolean(w.length)) {
                    ...
                    return r.createElement(
                      ...
                      r.createElement("div", { className: H.text }, a.t(null, void 0, o(42078))),
                    );
                  }
                  return r.createElement(
                    r.Fragment,
          ...
          super(e),
            ...
            (this._getContextValue = () => {
              ...
              return {
                compareModel: e,
                selectedCompareOptionIndex: t,
                setSelectedCompareOptionIndex: this._setSelectedCompareOptionIndex,
                hoveredItemId: r,
            ...
            (this.state = {
              ...
              allowExtendTimeScale: Boolean(O.getBool("showAddSymbolDialog.extendCheckboxState")),
            });
        }
        render() {
          const { children: e } = this.props;
          return r.createElement(_.Provider, { value: this._getContextValue() }, e);
        }
      }
      var F = o(68335),
        U = o(35057),
      ...
      function K(e) {
        ...
        return (
          ...
          r.createElement(U.AdaptivePopupDialog, {
            ...e,
            className: l(q.dialog, !m && (p ? q.tabletDialog : q.desktopDialog)),
            onKeyDown: function (e) {
              ...
              switch (a) {
                case 13: {
                  if (A)
                    return void (function () {
                      if (-1 === C) return;
                      const e = L[C];
                      e.checked ? y.removeStudy(e) : y.applyStudy(e.symbol, R, D);
                      N(-1);
                    })();
                  const t = V();
                  ...
                  e.preventDefault();
                  const a =
                    null === (r = null == o ? void 0 : o.current) || void 0 === r
                      ? void 0
                      : r.value.trim();
                  return void (
                    a &&
                ...
                case 27:
                  return e.preventDefault(), B ? void d("symbolSearch") : void v();
              }
              if (!A && "good" !== b) return;
        ...
        function K() {
          var e;
          null === (e = E.current) || void 0 === e || e.scrollIntoView({ block: "nearest" });
        }
        function V() {
          if (!T) return;
      ...
      function ee(e) {
        const { searchRef: t, setMode: o } = (0, k.useEnsuredContext)(
          ...
          { currentMode: a } = (0, k.useEnsuredContext)($.SymbolSearchDialogBodyContext);
        return (
          (0, r.useEffect)(() => {
            const e = t.current;
            if (e)
      ...
      function ae(e) {
        ...
        return r.createElement(
          ...
          r.createElement(
            ...
            r.createElement(te.CheckboxInput, { checked: t, value: t ? "on" : "off", onChange: n }),
            r.createElement("span", { className: re.label }, a.t(null, void 0, o(71046))),
          ),
        );
      }
      ...
      function se(e) {
        return new J({
          wrapper: ((t = e), (e) => r.createElement(W, { ...e, compareModel: t })),
          dialog: K,
          contentItem: A,
          initialScreen: R,
          searchInput: ee,
          ...
          onSearchComplete: (t) => {
            ...
            if (void 0 !== o) {
              (0, i.getSymbolSearchCompleteOverrideFunction)()(t[0].symbol, t[0].result).then(
                (t) => {
    ...
    70412: (e, t, o) => {
      "use strict";
      o.d(t, { hoverMouseEventFilter: () => n, useAccurateHover: () => s, useHover: () => a });
      var r = o(50959);
      function a() {
        ...
        return r.createElement(
          X,
          {
            ...
            onContextMenu: function (e) {
              q && V && (0, n.trackEvent)(q.category, q.event, `${q.label}_rightClick`);
            },
            onMouseUp: function (e) {
              if (1 === e.button && w && q) {
                let e = q.label;
                K && (e += "_mouseWheelClick"), (0, n.trackEvent)(q.category, q.event, e);
              }
            },
            onMouseOver: L,
            onMouseOut: z,
          ...
          (void 0 !== v || f) &&
            r.createElement("span", { className: B.shortcut }, (Q = v) && Q.split("+").join(" + ")),
          void 0 !== M &&
            r.createElement(
              "span",
              {
                onClick: A ? d : void 0,
                className: a(p, B.toolbox, { [B.showOnHover]: I, [B.showOnFocus]: C }),
              },
              M,
            ),
        );
        ...
        return (
          ...
          (0, r.useLayoutEffect)(() => {
            if (s.CheckMobile.iOS())
              return (
                null !== i.current && (0, a.disableBodyScroll)(i.current, { allowTouchMove: l(i) }),
                () => {
