  ...
  [8167],
  {
    41339: (e, t, i) => {
      ...
      var a = i(295),
        ...
        c = i(88640),
        p = i(94474);
      const u = new o.TranslatedString("change price Y coordinate", r.t(null, void 0, i(66266))),
        h = new o.TranslatedString("change bar X coordinate", r.t(null, void 0, i(23723))),
      ...
      function g(e, t, i, n, r, o) {
        ...
        return (0, a.createCoordinatesPropertyDefinition)(
          ...
          { id: (0, p.removeSpaces)(`${o}Coordinates${r}`), title: r, ...s.info, ...l.info },
        );
      }
      const w = /^([+*\-\/]?)((?:\d*)|(?:\d+\.\d*))$/;
      function m(e, t, i) {
                ...
                e.forEach((e) => {
                  ...
                  switch (a) {
                    case "": {
                      ...
                      (o -= e.price),
                        (t -= e.index),
                        (r = i.map((e) => ({ ...e, index: e.index + t, price: e.price + o })));
                      break;
                    }
                    case "-":
                    case "+": {
                      ...
                      "-" === a && ((e *= -1), (t *= -1)),
                        (r = i.map((i) => ({ ...i, index: i.index + e, price: i.price + t })));
                      break;
                    }
                    case "*": {
                  ...
                  t.undoHistory().pushUndoCommand(
                    new l({ lineToolId: e.id(), chartModel: t.model(), newPositionPoints: r }),
                  );
                });
              });
            } finally {
    ...
    97456: (e, t, i) => {
      ...
      const p = new r.TranslatedString(
        ...
        h = new r.TranslatedString("change {title} seconds from", n.t(null, void 0, i(2822))),
        y = new r.TranslatedString("change {title} seconds to", n.t(null, void 0, i(66161))),
        P = new r.TranslatedString(
          "change {title} visibility on minutes",
          n.t(null, void 0, i(64370)),
        ),
        f = new r.TranslatedString("change {title} minutes from", n.t(null, void 0, i(15106))),
        g = new r.TranslatedString("change {title} minutes to", n.t(null, void 0, i(91633))),
        w = new r.TranslatedString(
          "change {title} visibility on hours",
          n.t(null, void 0, i(68971)),
        ),
        m = new r.TranslatedString("change {title} hours from", n.t(null, void 0, i(35388))),
        _ = new r.TranslatedString("change {title} hours to", n.t(null, void 0, i(78586))),
        b = new r.TranslatedString(
          "change {title} visibility on days",
          n.t(null, void 0, i(29088)),
        ),
        v = new r.TranslatedString("change {title} days from", n.t(null, void 0, i(41377))),
        S = new r.TranslatedString("change {title} days to", n.t(null, void 0, i(13355))),
        T = new r.TranslatedString(
          "change {title} visibility on weeks",
          n.t(null, void 0, i(24941)),
        ),
        C = new r.TranslatedString("change {title} weeks from", n.t(null, void 0, i(21339))),
        V = new r.TranslatedString("change {title} weeks to", n.t(null, void 0, i(68643))),
        D = new r.TranslatedString(
          "change {title} visibility on months",
          n.t(null, void 0, i(6659)),
        ),
        W = new r.TranslatedString("change {title} months from", n.t(null, void 0, i(59635))),
        k = new r.TranslatedString("change {title} months to", n.t(null, void 0, i(74266))),
        x =
