(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [5009],
  {
    ...
    64530: (e, t, n) => {
      ...
      function c(e) {
        const { url: t, ...n } = e;
        return t ? a.createElement("a", { ...n, href: t }) : a.createElement("div", { ...n });
      }
      var u = n(12228);
      function m(e) {
        const {
        ...
        return a.createElement(
          ...
          {
            ...b,
            className: i()(u.itemRow, g && !y && u.active, p && u.mobile, y && u.selected),
    ...
    19785: (e, t, n) => {
      "use strict";
      n.d(t, { createRegExpList: () => i, getHighlightedChars: () => r, rankedSearch: () => o });
      var a = n(1722);
      function o(e) {
        const {
          data: t,
            ...
            return (
              n.forEach((e) => {
                ...
                if (
                  ...
                  return (
                    (d = 4), void (m = null === (n = t.match(f)) || void 0 === n ? void 0 : n.index)
                  );
                if ((0, a.isString)(t) && f.test(t))
                  return (
                    (d = 3), void (m = null === (r = t.match(f)) || void 0 === r ? void 0 : r.index)
                  );
                if ((0, a.isString)(i) && f.test(i))
                  return (
                    (d = 2), void (m = null === (l = i.match(f)) || void 0 === l ? void 0 : l.index)
                  );
                if ((0, a.isString)(i) && h.test(i))
                  return (
                    (d = 2), void (m = null === (s = i.match(h)) || void 0 === s ? void 0 : s.index)
                  );
                if (Array.isArray(u))
                  for (const e of u)
                    if (f.test(e))
                      return (
                        (d = 1),
                        void (m = null === (c = e.match(f)) || void 0 === c ? void 0 : c.index)
                      );
              }),
    ...
    24637: (e, t, n) => {
      ...
      function l(e) {
        const { queryString: t, rules: n, text: l, className: s } = e,
          c = (0, a.useMemo)(() => (0, i.getHighlightedChars)(t, l, n), [t, n, l]);
        return a.createElement(
          a.Fragment,
          null,
          c.length
            ? l
                ...
                .map((e, t) =>
                  a.createElement(
                    ...
                    { key: t },
                    c[t]
                      ? a.createElement("span", { className: o(r.highlighted, s) }, e)
        ...
        return a.createElement(
          X,
          {
            ...
            onContextMenu: function (e) {
              Y && V && (0, i.trackEvent)(Y.category, Y.event, `${Y.label}_rightClick`);
            },
            onMouseUp: function (e) {
              if (1 === e.button && E && Y) {
                let e = Y.label;
                U && (e += "_mouseWheelClick"), (0, i.trackEvent)(Y.category, Y.event, e);
              }
            },
            onMouseOver: F,
            onMouseOut: M,
          ...
          (void 0 !== g || y) &&
            a.createElement("span", { className: I.shortcut }, (G = g) && G.split("+").join(" + ")),
          void 0 !== x &&
            a.createElement(
              "span",
              {
                onClick: T ? u : void 0,
                className: o(f, I.toolbox, { [I.showOnHover]: L, [I.showOnFocus]: D }),
              },
              x,
            ),
        );
    ...
    12811: (e, t, n) => {
      ...
      function c(e, t) {
        return (n) => {
          ...
          let b = null !== (c = t.verticalAttachEdge) && void 0 !== c ? c : s.verticalAttachEdge,
            C =
              null !== (u = t.verticalDropDirection) && void 0 !== u ? u : s.verticalDropDirection;
          b === a.AutoStrict &&
            (h < f.y + f.height + p + d
    ...
    34557: (e, t, n) => {
      ...
      function p(e) {
        ...
        return a.createElement(
          "div",
          {
            ...o,
            ref: r,
            className: i(v.sortButton, "apply-common-tooltip", "common-tooltip-vertical"),
            onClick: function () {
              s(!l);
            },
          },
      ...
      function C(e) {
        ...
        return a.createElement(_.PopupMenuItem, {
          ...
          label: a.createElement(
            ...
            a.createElement(f.Icon, { className: b.icon, icon: 0 === l ? g : y }),
      ...
      function z(e) {
        ...
        return (
          ...
          a.createElement(
            ...
            "overlay" === s &&
              a.createElement(M.OverlayScrollContainer, { ...h, className: F.overlayScrollWrap }),
        ...
        Q = (function (e) {
          ...
          return (0, a.forwardRef)(({ style: e, ...o }, i) => {
            ...
            return a.createElement("div", {
              ref: i,
              style: { ...e, height: `${((0, D.isNumber)(r) ? r : parseFloat(r)) + t + n}px` },
              ...o,
            });
          });
        })({ paddingBottom: 6 });
      ...
      function ae(e) {
        const { charts: t, onClose: o, favoriteChartsService: i, chartWidgetCollection: d } = e,
          [h, f] = (0, a.useState)(""),
          [g, y] = (0, a.useState)(h),
          [v, _] = (0, a.useState)([]),
          b = (0, a.useRef)(null),
          ...
          [S, A] = (0, a.useState)(() => c.getJSON("loadChartDialog.viewState", G)),
          x = (0, a.useRef)(null),
          N = (0, a.useRef)(null),
          M = (0, a.useMemo)(
