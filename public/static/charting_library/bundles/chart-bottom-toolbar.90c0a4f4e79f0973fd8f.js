  ...
  [7260],
  {
                ...
                (n = [].concat(t(n), [h])),
                  ...
                  (e.ontouchmove = function (t) {
                    ...
                    1 === t.targetTouches.length &&
                      ...
                      !d(s.target) &&
                        ((r && 0 === r.scrollTop && 0 < n) ||
                        ((a = r) && a.scrollHeight - a.scrollTop <= a.clientHeight && n < 0)
                          ? u(s)
                          : s.stopPropagation()));
                  }),
                  i ||
                    (document.addEventListener("touchmove", u, s ? { passive: !1 } : void 0),
                    (i = !0));
              }
            } else {
              (p = r),
            ...
            (e.clearAllBodyScrollLocks = function () {
              a
                ? (n.forEach(function (e) {
                  ...
                  i &&
                    (document.removeEventListener("touchmove", u, s ? { passive: !1 } : void 0),
                    (i = !1)),
                  (n = []),
                  (o = -1))
                : (h(), (n = []));
    ...
    26996: (e, t, s) => {
      ...
      var r = s(50959),
        ...
        i = s.n(n);
      function o(e) {
        const { className: t, size: s = "medium", staticPosition: n, color: o = "black" } = e,
          l = a(i().item, i()[o], i()[s]);
      ...
      function p(e) {
        ...
        return a
          ...
          : r.createElement(
              ...
              !I && S && r.createElement(c.Hint, { className: m.shortcut, text: S }),
    ...
    54079: (e, t, s) => {
      ...
      const u = (0, r.forwardRef)(function (e, t) {
        const {
          ...
          g = o.PLATFORM_ACCESSIBILITY_ENABLED ? { role: "toolbar", "aria-orientation": u } : {},
    ...
    33279: (e, t, s) => {
      ...
      var r = s(50959),
        ...
        y = s(36274);
      const S = (e) =>
          n.t(null, { plural: "{str} minutes", count: e, replace: { str: `${e}` } }, s(60144)),
        E = (e) =>
          n.t(null, { plural: "{str} hours", count: e, replace: { str: `${e}` } }, s(17174)),
        k = (e) =>
          n.t(null, { plural: "{str} months", count: e, replace: { str: `${e}` } }, s(28039)),
        C = {
          ...
          "1D": {
            ...
            text:
              ((w = 1),
              n.t(null, { plural: "{str} days", count: w, replace: { str: `${w}` } }, s(74262))),
          },
          "1W": {
            resolution: "1W",
            text:
          ...
          "12M": {
            ...
            text:
              ((x = 1),
              n.t(null, { plural: "{str} years", count: x, replace: { str: `${x}` } }, s(8222))),
          },
        };
      var x, T, w;
      function M(e) {
        const t = (function (e) {
            ...
            if (!r.isValid()) {
              if ("YTD" === t) return n.t(null, { context: "timeframe_title" }, s(87556));
              if ("ALL" === t) return n.t(null, { context: "timeframe_title" }, s(74944));
        ...
        return (
          ((t = class extends r.PureComponent {
            constructor(e, t) {
              ...
              const s = (this._binding = (0, v.ensureDefined)(D.get(t.chartWidget)));
              this.state = s.state();
            }
            componentDidMount() {
        ...
        constructor(e, t) {
          super(e, t),
            (this._timeFormatter = new ge.TimeFormatter(
              (0, be.getHourMinuteSecondFormat)(fe.timeHoursFormatProperty.value()),
            )),
            ...
            (this._showMenu = (e) => {
              ...
              ye.ContextMenuManager.showMenu(
                ...
                { returnFocus: !0, takeFocus: !0, isKeyboardEvent: (0, me.isKeyboardClick)(e) },
          ...
          (this._tickInterval = setInterval(this._tickClock, 1e3)),
            e.withModel(null, () => {
              ...
              t
                ...
                fe.timeHoursFormatProperty.subscribe(this, this._timeHoursFormatPropertyChanged);
            });
        }
        componentWillUnmount() {
          const { chartWidget: e } = this.context;
          clearInterval(this._tickInterval),
            e.withModel(null, () => {
              ...
              t
                ...
                fe.timeHoursFormatProperty.unsubscribe(this, this._timeHoursFormatPropertyChanged);
            });
        }
        render() {
      ...
      const Ie = (0, b.registryContextType)(),
        Le = new Me.TranslatedString("toggle log scale", n.t(null, void 0, s(60166)));
      const De = (0, b.registryContextType)(),
        Be = new Me.TranslatedString("toggle auto scale", n.t(null, void 0, s(63060)));
      const Ne = (0, b.registryContextType)(),
        Re = new Me.TranslatedString("toggle percentage scale", n.t(null, void 0, s(68642)));
      ...
      var je = s(42142),
        ...
        Ue = s(11678),
        Fe = s(97086);
      const Oe = new Me.TranslatedString("change session", n.t(null, void 0, s(65303))),
        Ye = { hint: n.t(null, void 0, s(25866)), headerMenuText: n.t(null, void 0, s(44794)) },
        ...
        _menuItems() {
          ...
          for (const n of t) {
            const t = { category: "SetSession", event: n.id },
              i = () => {
                e.model().setProperty(s.properties().childs().sessionId, n.id, Oe);
              };
            a.push(
              r.createElement(p.AccessibleMenuItem, {
                key: n.id,
              ...
              super(e, t),
                ...
                (this._handleSelect = () => {
                  const e = this.context.chartWidget.model(),
                    ...
                    s = t.priceScale(),
                    r = s.mode();
                  t.priceScale().isLockScale() || e.setPriceScaleMode({ log: !r.log }, s, Le);
                }),
                (0, b.validateRegistry)(t, { chartWidget: i.any.isRequired }),
      ...
      class ht extends r.PureComponent {
              ...
              (e, t, a) => {
                if (r.isValidElement(e) && "string" != typeof e.type) {
                  ...
                  if ("string" == typeof i.className) {
                    const l = { className: o(i.className, t === a.length - 1 && Ze.last) },
                      c = s(),
            ...
            r.createElement(
              ...
              s &&
                r.createElement(
                  ...
                  r.createElement(
                    "div",
                    { className: Ze.inline, onClick: this._trackTimezonesButtonClick },
                    r.createElement(Ce, {
                      className: Ze.item,
        ...
        _applyResizing() {
          ...
          this._rangeExpanded &&
            this._rangeExpanded.classList.toggle(Ze.collapsed, "expanded" !== e),
            this._rangeCollapsed &&
              this._rangeCollapsed.classList.toggle(Ze.collapsed, "collapsed" !== e);
          let s = !1,
            r = !1;
    ...
    6598: (e) => {
      e.exports = {
        ar: ["{str} عام", "{str} عام", "{str} عام", "{str} عام", "{str} عام", "{str} عام"],
        ca_ES: "{str} year",
        cs: "{str} year",
