...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [8882],
  {
    73955: (e, t, r) => {
      ...
      function n(e, t, r, n = null) {
        ...
        const s = {
          ...
          visible: null !== (o = e.visible) && void 0 !== o ? o : new i.WatchedValue(!0).readonly(),
        };
        return null !== n && (s.icon = n), s;
      }
    },
    20345: (e, t, r) => {
      r.d(t, { convertToInt: () => o, floor: () => n, limitedPrecision: () => s });
      var i = r(10786);
      function n(e) {
        return Math.floor(e);
      }
    ...
    3347: (e, t, r) => {
      r.d(t, { convertToDefinitionProperty: () => o, makeProxyDefinitionProperty: () => n });
      var i = r(51768);
      function n(e, t, r) {
        const i = new Map(),
          n = void 0 !== t ? t[0] : (e) => e,
    ...
    295: (e, t, r) => {
      ...
      var y = r(11542);
      const v = [
          { id: "bottom", value: "bottom", title: y.t(null, void 0, r(65994)) },
          { id: "middle", value: "middle", title: y.t(null, void 0, r(76476)) },
          { id: "top", value: "top", title: y.t(null, void 0, r(91757)) },
        ],
        b = [
          { id: "left", value: "left", title: y.t(null, void 0, r(19286)) },
          { id: "center", value: "center", title: y.t(null, void 0, r(72171)) },
          { id: "right", value: "right", title: y.t(null, void 0, r(21141)) },
        ],
        P = [
          { id: "horizontal", value: "horizontal", title: y.t(null, void 0, r(77405)) },
          { id: "vertical", value: "vertical", title: y.t(null, void 0, r(44085)) },
        ],
        D = [10, 11, 12, 14, 16, 20, 24, 28, 32, 40].map((e) => ({ title: String(e), value: e })),
        T = [1, 2, 3, 4],
        m = y.t(null, void 0, r(92960)),
        g = y.t(null, void 0, r(90581));
      function h(e, t) {
      ...
      function W(e, t, r) {
        return { id: t, title: r, groupType: "leveledLines", definitions: new R.WatchedValue(e) };
      }
      var z = r(3347);
      function M(e, t, r) {
        const i = new Map(),
          ...
          s = {
            ...
            subscribe: (t, r) => {
              ...
              let o = i.get(t);
              void 0 === o ? ((o = new Map()), o.set(r, n), i.set(t, o)) : o.set(r, n),
                e.subscribe(n);
            },
            unsubscribe: (t, r) => {
              const n = i.get(t);
      ...
      function B(e, t, r, i, n) {
        ...
        return (
          (o.setValue = (r) => {
            n && e.beginUndoMacro(i), e.setProperty(t, r, i), n && e.endUndoMacro();
          }),
          o
        );
      }
