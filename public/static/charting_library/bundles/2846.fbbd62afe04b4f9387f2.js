  ...
  [2846],
  {
    59142: function (e, o) {
      ...
      (n = [o]),
        (l = function (e) {
          ...
          function o(e) {
            if (Array.isArray(e)) {
              for (var o = 0, l = Array(e.length); o < e.length; o++) l[o] = e[o];
              return l;
            }
            return Array.from(e);
          }
                ...
                (t = [].concat(o(t), [h])),
                  ...
                  (e.ontouchmove = function (o) {
                    ...
                    1 === o.targetTouches.length &&
                      ...
                      !v(l.target) &&
                        ((n && 0 === n.scrollTop && 0 < t) ||
                        ((i = n) && i.scrollHeight - i.scrollTop <= i.clientHeight && t < 0)
                          ? d(l)
                          : l.stopPropagation()));
                  }),
                  r ||
                    (document.addEventListener("touchmove", d, l ? { passive: !1 } : void 0),
                    (r = !0));
              }
            } else {
              (u = n),
            ...
            (e.clearAllBodyScrollLocks = function () {
              i
                ? (t.forEach(function (e) {
                  ...
                  r &&
                    (document.removeEventListener("touchmove", d, l ? { passive: !1 } : void 0),
                    (r = !1)),
                  (t = []),
                  (a = -1))
                : (h(), (t = []));
        ...
        void 0 === (i = "function" == typeof l ? l.apply(o, n) : l) || (e.exports = i);
    },
    14877: (e) => {
      e.exports = {
    ...
    36189: (e, o, l) => {
      ...
      var n = l(11542),
        ...
        s = l(48010),
        c = l(14877);
      const v = { add: n.t(null, void 0, l(44629)), remove: n.t(null, void 0, l(72482)) };
      function d(e) {
    ...
    86656: (e, o, l) => {
        ...
        return (
          ...
          (0, n.useLayoutEffect)(() => {
            if (r.CheckMobile.iOS())
              return (
                null !== a.current && (0, i.disableBodyScroll)(a.current, { allowTouchMove: s(a) }),
                () => {
      ...
      function s(e) {
        return (o) => {
          ...
          return !l.contains(o) || (null !== n && l.contains(n) && n.contains(o));
        };
      }
    },
    71468: (e, o, l) => {
    ...
    80982: (e, o, l) => {
      "use strict";
      l.d(o, { isLineToolsGroupWithSections: () => r, lineTools: () => t, lineToolsFlat: () => a });
      var n = l(11542),
        i = l(1722);
      const t = [
        {
          ...
          sections: [
            {
              ...
              items: [{ name: "LineToolBrush" }, { name: "LineToolHighlighter" }],
            },
            {
        ...
        },
        {
          ...
          sections: [
            ...
            { title: n.t(null, void 0, l(39176)), items: [null, null, null].filter(i.isExistent) },
          ],
          trackLabel: null,
        },
      ];
      ...
      const a = t
        .map(function (e) {
          return r(e) ? e.sections.map((e) => e.items).flat() : e.items;
        })
        .flat();
    },
    78036: (e, o, l) => {
      ...
      const h = (0, v.humanReadableModifiers)(v.Modifiers.Shift, !1),
        ...
        T = {
          ...
          LineToolGannFan: {},
          LineToolGannSquare: {
            hotKey: (0, t.hotKeySerialize)({ keys: [h], text: i.t(null, void 0, l(10289)) }),
          },
          LineToolHeadAndShoulders: {},
          LineToolHorzLine: {
            hotKey: (0, t.hotKeySerialize)({ keys: [m, "H"], text: "{0} + {1}" }),
          },
          LineToolHorzRay: {},
          LineToolIcon: {},
          LineToolEmoji: {},
          ...
          LineToolRay: {},
          LineToolRectangle: {
            hotKey: (0, t.hotKeySerialize)({ keys: [h], text: i.t(null, void 0, l(81591)) }),
          },
          LineToolCircle: {},
          ...
          LineToolVertLine: {
            hotKey: (0, t.hotKeySerialize)({ keys: [m, "V"], text: "{0} + {1}" }),
          },
          LineToolCrossLine: {},
          LineToolHighlighter: {},
          LineToolGhostFeed: {},
          ...
          hideAllDrawings: {
            ...
            hotKey: (0, t.hotKeySerialize)({ keys: [u, m, "H"], text: "{0} + {1} + {2}" }),
          },
          lockAllDrawings: { iconActive: a.drawingToolsIcons.lockAllDrawingsActive },
          magnet: { hotKey: (0, t.hotKeySerialize)({ keys: [u], text: "{0}" }) },
          measure: {
            hotKey: (0, t.hotKeySerialize)({ keys: [h], text: i.t(null, void 0, l(32868)) }),
          },
      ...
      Object.entries(T)
        .map(([e, o]) => {
          var l, i;
          const t = null !== (l = r.lineToolsIcons[e]) && void 0 !== l ? l : a.drawingToolsIcons[e];
          (0, n.assert)(!!t, `Icon is not defined for drawing "${e}"`);
          const v = null !== (i = c.lineToolsLocalizedNames[e]) && void 0 !== i ? i : s[e];
          (0, n.assert)(!!v, `Localized name is not defined for drawing "${e}"`);
          return {
            ...o,
            name: e,
            icon: t,
    ...
    71810: (e, o, l) => {
      ...
      !(function (e) {
        function o() {
          ...
          e.favorites = [];
          let s = !1;
          const c = Boolean(void 0 === (0, i.getValue)("chart.favoriteDrawings")),
            v = (0, i.getJSON)("chart.favoriteDrawings", []);
          if (0 === v.length && c && "undefined" != typeof window) {
            const e = JSON.parse(
              null !==
                (n = null === (o = window.urlParams) || void 0 === o ? void 0 : o.favorites) &&
                void 0 !== n
                ? n
                : "{}",
            ).drawingTools;
        ...
        (function (e) {
          ...
          (e.favoriteAdded = new n.Delegate()),
            ...
            (e.favorite = function (e) {
              return e < 0 || e >= l() ? "" : a.favorites[e];
            }),
            (e.addFavorite = function (l, n) {
              return (
                !(i(l) || !o(l) || "performance" === l) &&
                (a.favorites.push(l), a.saveFavorites(n), e.favoriteAdded.fire(l), !0)
              );
            }),
