(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [4862],
  {
    ...
    78274: (e, t, n) => {
      "use strict";
      n.d(t, { AfterSlot: () => u, EndSlot: () => c, MiddleSlot: () => a, StartSlot: () => l });
      var o = n(50959),
        r = n(97754),
        i = n(7236),
        s = n.n(i);
    ...
    31261: (e, t, n) => {
      ...
      function b(e) {
        ...
        const {
          ...
          S = t ? void 0 : b ? -1 : r,
          y = t ? void 0 : b ? r : -1,
          { isMouseDown: C, handleMouseDown: T, handleMouseUp: w } = (0, d.useIsMouseDown)(),
    ...
    37404: (e, t, n) => {
      ...
      let o = null;
      function r(e) {
        return Promise.all([n.e(4781), n.e(9465), n.e(7413), n.e(3263), n.e(1702)])
          .then(n.bind(n, 41662))
          .then((t) => {
    ...
    56396: (e, t, n) => {
      ...
      const je = (e) => e.nodes,
        ...
        qe = (0, Re.createSelector)(je, (e) => Object.values(e).filter((e) => 0 === e.level)),
      ...
      const Je = (0, Re.createSelector)([je, qe, Pe], (e, t, n) => {
          const o = new Set(n);
          return t.reduce((t, n) => [...t, ...tt(e, (0, M.ensureDefined)(n), o)], []);
        }),
      ...
      function* nt(e) {
        ...
        yield (0, w.put)(((e) => ({ type: $, nodes: e }))(o)), yield (0, w.put)(we(t));
        !Ze(yield (0, w.select)()) &&
          t.length > 0 &&
      ...
      function* it(e, t) {
        for (;;) {
          ...
          const l = r.findIndex((e) => e.id === s),
            ...
            c = dt(o, a, r, l),
            { id: u } = c;
          e ? e([u], a) : yield (0, w.put)(we([u])), t && t(u), yield (0, w.put)(De(u));
        }
      }
      function* st(e, t = () => !0) {
        for (;;) {
          ...
          if (1 === n) r ? i.push(o) : i.splice(i.indexOf(o), 1);
            ...
            -1 === n && (n = s.reduce((e, t, n) => (i.includes(t.id) ? n : e), -1));
      ...
      function* lt(e = () => !0, t) {
        const { dropTarget: n, dropType: o, isHoveredLeft: r, boundBox: i, isLastChild: s } = t,
        ...
        u.map((e) => e.id).includes(d.id)
          ...
          : h &&
            e(u, d, o) &&
            (yield (0, w.put)(
              ((e, t, n) => ({ type: le, node: e, dropType: t, boundBox: n }))(d, o, i),
            ));
      }
      function* at(e) {
      ...
      function dt(e, t, n, o) {
        ...
        for (
          ;
          !i || (Math.abs(s) < r && (l = i).level > 1 && !He(e, (0, M.ensureDefined)(l.parentId)));
      ...
      const bt = (0, pt.combineReducers)({
            ...
            case q: {
              ...
              for (const t of Object.keys(e))
                if (!o.includes(t)) {
                  ...
                  e && (r[e] = { ...r[e], children: r[e].children.filter((e) => e !== t) }),
                    delete r[t];
                }
              for (const e of n) {
                const t = e.id;
            ...
            case ve: {
              ...
              for (const t of n) {
                ...
                if (n.parentId) {
                  ...
                  l[n.parentId] = { ...o, children: o.children.filter((e) => e !== t) };
                }
        ...
        disabled: function (e = [], t) {
          return t.type === ge ? [...t.ids] : e;
        },
        scrollToId: function (e = null, t) {
          return t.type === he ? (null === t.nodeId ? null : { id: t.nodeId }) : e;
        },
      });
      var _t = n(40933),
        St = n(20037),
      ...
      class Lt extends o.PureComponent {
          ...
          super(...arguments),
            ...
            (this._handleRef = (e) => {
              ...
              (0, M.ensureDefined)(n)(this._ref),
                ...
                (0, M.ensureDefined)(o)((0, Tt.getEmptyImage)(), { captureDraggingState: !0 });
            }),
        ...
        render() {
          return o.createElement(xt, { ...this.props, reference: this._handleRef });
        }
        getNode() {
      ...
      const xt = (e) => {
          const {
            ...
            S = (0, o.useRef)(null),
            y = (0, wt.createSafeMulticastEventHandler)((e) => (S.current = e), h);
      ...
      function Rt(e, t) {
        ...
        let i = !1,
          s = o.parentId;
        for (; s && !i; ) (i = Ge(e, s)), (s = We(e, s).parentId);
        return {
          ...o,
          isSelected: r,
          isChildOfSelected: i,
      ...
      const Ot = (0, H.connect)(Rt, jt, null, { context: At })(function (e) {
      ...
      const $t = o.forwardRef((e, t) => {
        ...
        return (
          ...
          o.createElement("div", { ref: n, style: { height: "100%", width: "100%" } })
        );
      });
      function qt(e) {
        const t = (0, o.useRef)(null),
      ...
      const tn = (0, H.connect)(
        ...
        const { dropType: t, boundBox: n, isDragging: r, level: i, transform: s = Jt } = e;
        return Wt(function () {
          if (!r || !t || !n) return null;
          const l = { [Xt.dropTarget]: "inside" !== t, [Xt.dropTargetInside]: "inside" === t },
            { width: a, height: c } = n,
            [u, d] = s(e),
      ...
      const cn = o.forwardRef(function (e, t) {
        const {
            navigationKeys: n,
            renderList: r,
            stopMultiSelect: i,
        ...
        (0, o.useEffect)(() => {
          ...
          (0, o.useEffect)(() => {
            const e = (e) => {
                [E.Modifiers.Mod, E.Modifiers.Shift].includes((0, E.modifiersFromEvent)(e)) && s();
              },
              t = (e) => {
                l &&
                  ![E.Modifiers.Mod, E.Modifiers.Shift].includes((0, E.modifiersFromEvent)(e)) &&
                  i();
              };
            return (
                ...
                const n = (0, M.ensureNotNull)(e.current),
                  o = (e) => {
                    if (e.target instanceof Element) {
                      const n = (0, M.ensureNotNull)(e.target.closest("[draggable]"));
        ...
        const F = (0, o.useCallback)((e) => {
          ...
          W = (0, o.useCallback)(
            (e) => {
              const t = z.current[e];
              return "padding" === t.type ? 6 : "function" == typeof b ? b(e, t) : b;
            },
            [b],
          ),
          G = (0, o.useCallback)((e) => (0, M.ensure)(z.current[e].node.key), []),
          H = (0, o.useMemo)(
            () =>
              null === m
                ? { index: -1 }
        ...
        const [V, U, K, Z] = (0, Yt.useOverlayScroll)(),
          Y = (0, o.useRef)(null);
        (0, o.useEffect)(() => (0, M.ensureNotNull)(Y.current).resetAfterIndex(0, !0), [P]),
          (0, o.useEffect)(() => (0, M.ensureNotNull)(Y.current).scrollToItem(H.index), [H]);
        const $ = (0, o.useRef)(null),
          ...
          X = (0, o.useRef)({
            startScroll(e) {
              const t = () => {
                null !== K.current &&
                  ((Q.current = requestAnimationFrame(t)), K.current.scrollBy({ top: e }));
              };
              this.stopScroll(), t();
            },
            stopScroll() {
        ...
        return (
          ...
          (0, o.useEffect)(() => {
            ...
            function e(e) {
              ...
              const { viewModel: n } = A,
                o = n.selection();
              e.defaultPrevented || e.currentTarget !== e.target || o.selected().length || y();
            }
            const t = R.current;
            return (
            ...
            o.createElement(
              "div",
              {
                ...
                onKeyDown: function (e) {
                  ...
                  if (e.defaultPrevented || (0, Pt.isNativeUIInteraction)(t, e.target)) return;
                  ...
                  (38 === t || (void 0 !== n && "previous" === n[t])) && (e.preventDefault(), C());
                  (40 === t || (void 0 !== n && "next" === n[t])) && (e.preventDefault(), y());
                  if ((8 === t || 46 === t) && A) {
                    const { viewModel: e } = A,
                      t = e.selection(),
                      n = t.selected();
              ...
              o.createElement(Zt.OverlayScrollContainer, { ...V, className: sn.overlayScrollWrap }),
        ...
        function J(e) {
          var t;
          null === (t = K.current) || void 0 === t || t.scrollTo({ left: 0, top: e });
        }
      });
          ...
          const t = (0, o.useRef)(null),
            [{ isOver: n }, r] = (0, _t.useDrop)({
              ...
              hover: (n, o) => {
                ...
                const l =
                  null !==
                    (i = null === (r = t.current) || void 0 === r ? void 0 : r.getListElement()) &&
                  void 0 !== i
                    ? i
                    : null;
                if (null === l) return;
                ...
                ((n, o, r) => {
                  ...
                  if ((l > 40 && s > 40) || (s <= 40 && l <= 40))
                    return void (null === (i = t.current) || void 0 === i || i.stopScroll());
                  ((n, o, r, i) => {
                    var s, l, a, c;
                    o || n
                      ? "touch" === e.drag
                        ? null === (s = t.current) || void 0 === s || s.startScroll(o ? -5 : 5)
                        : null === (l = t.current) || void 0 === l || l.startScroll(o ? -2 : 2)
                      : (r || i) &&
                        ("touch" === e.drag
                          ? null === (a = t.current) || void 0 === a || a.startScroll(r ? -10 : 10)
                          : null === (c = t.current) || void 0 === c || c.startScroll(r ? -5 : 5));
                  })(l > 20 && l <= 40, s > 20 && s <= 40, s <= 20, l <= 20);
                })(s.y, a.bottom, a.top);
              },
              collect: (e) => ({ isOver: e.isOver() }),
            });
          return o.createElement(cn, { ...e, isOver: n, connectDropTarget: r, ref: t });
        }),
      ...
      function hn(e) {
        ...
        return (
          ...
          null === v ? null : o.createElement(pn, { store: v, scrollToId: f, ...g })
        );
      }
      const pn = o.memo(function (e) {
        ...
        return (
          ...
          o.createElement(
            ...
            o.createElement(H.Provider, { store: t, context: At }, o.createElement(un, { ...r })),
          )
        );
      });
      function fn(e, t) {
      ...
      function* bn() {
        for (;;) {
          ...
          1 === e && fn("Multi select", "Ctrl"), 2 === e && fn("Multi select", "Shift");
        }
      }
      function* _n(e) {
        for (;;) {
          ...
          if (t) {
            ...
            1 === t.level && "inside" !== n && o.some((e) => 2 === e.level)
              ...
              ? 1 === o.length && o[0].parentId !== t.parentId && (i = "Existing pane")
              : (i = "To the group"),
              fn(i, gn(r));
          }
        }
      ...
      function Mn(e) {
        ...
        return o.createElement(
          ...
          o.createElement(
            ...
            o.createElement(
              "div",
              { className: In.wrap, onContextMenu: Tn.preventDefaultForContextMenu },
      ...
      function An(e) {
        ...
        return o.createElement(D.Icon, { className: g()(xn.button, n && xn.disabled, t), ...r });
      }
      var Rn = n(77975);
      ...
      function qn(e) {
        const {
          ...
          [B, P] = (0, o.useState)(!1),
          [z, F] =
            ((0, Rn.useWatchedValueReadonly)({ watchedValue: g.getChartLayout() }),
            (0, o.useState)(!1)),
          W = (0, o.useRef)(null);
        (0, o.useEffect)(() => {
          const e = {};
          ...
          t.subscribe((e) => C(e)),
            u.onIsActualIntervalChange().subscribe(e, () => R(u.isActualInterval())),
            u.onSyncStateChanged().subscribe(e, () => O(u.getDrawingSyncState()));
          ...
          (0, o.useEffect)(() => {
            b && S.current && (S.current.focus(), S.current.setSelectionRange(0, y.length));
          }, [b]),
          (0, o.useEffect)(() => {
            const e = {};
            return (
          ...
          (0, o.useEffect)(() => {
            !s && W.current && (clearTimeout(W.current), (W.current = null)), _(!1);
          }, [s]);
        const G = {};
        if (c) {
          const e = g.entity(c);
        ...
        const H = Nn.enabled("test_show_object_tree_debug")
          ...
          Z = !!v && v.isDialog,
          Y = A && N ? Kn : Zn,
          $ = u.hasChildren() ? p.t(null, void 0, n(38207)) : p.t(null, void 0, n(39781));
        let q = null;
        return (
          T &&
            T.type === kn.Svg &&
            (q = o.createElement(D.Icon, { icon: T.content || "", className: Yn.icon })),
          o.createElement(
            "span",
            {
              className: f(
              ...
              onMouseDown: function (e) {
                b && !(0, M.ensureNotNull)(S.current).contains(e.target) && F(!0);
              },
              onClick:
                1 === m
                  ? Q
                ...
                o.createElement(
                  ...
                  u.canBeLocked() &&
                    o.createElement(An, {
                      title: I ? Bn : Pn,
                      icon: I ? Vn : Un,
                      className: f(Yn.button, (V || I) && Yn.visible, "apply-common-tooltip"),
                      onClick: function (e) {
                        if (e.defaultPrevented) return;
                  ...
                  o.createElement(An, {
                    ...
                    onClick: A
                      ...
                      : function (e) {
                          if (e.defaultPrevented) return;
                          e.preventDefault(), g.openProperties(u, Gn.TabNames.visibility);
                        },
                    title: (function () {
                      if (!A) return $;
                      return N ? zn : Fn;
                  ...
                  u.canBeRemoved() &&
                    o.createElement(An, {
                      title: Wn,
                      icon: Hn,
                      className: f(Yn.button, (K || V) && Yn.visible, "apply-common-tooltip"),
                      onClick: function (e) {
                        if (e.defaultPrevented) return;
              ...
              o.createElement(Ln.InputControl, {
                ...
                onKeyDown: function (e) {
                  27 === (0, E.hashFromEvent)(e)
                    ...
                    : 13 === (0, E.hashFromEvent)(e) && (e.preventDefault(), X());
                },
        ...
        function Q(e) {
          e.defaultPrevented ||
            b ||
            !u.fullyConstructed() ||
            (e.preventDefault(), e.persist(), g.openContextMenu(u, () => _(!0), e));
        }
        function X() {
      ...
      function Jn(e) {
        ...
        return (
          ...
          o.createElement(
            o.Fragment,
            null,
            o.createElement(S.MatchMedia, { rule: C.DialogBreakpoints.TabletSmall }, (e) =>
              o.createElement(y.AdaptivePopupDialog, {
                ...
                onClose: r,
                ref: h,
                render: () => o.createElement(eo, { isSmallTablet: e, viewModel: t }),
            ...
            o.createElement(
              ...
              s &&
                o.createElement(
                  ...
                  o.createElement(T.ManageDrawings, { onClose: M, chartWidget: i, isMobile: !0 }),
                ),
            ),
          )
        );
        function E() {
          s && !window.matchMedia(C.DialogBreakpoints.TabletSmall).matches && l(!1);
        }
        function M() {
          l(!1);
        }
      ...
      function eo(e) {
        const { isSmallTablet: t, viewModel: n } = e,
          r = (0, o.useMemo)(() => ({ size: t ? 1 : 0, smallSizeTreeNodeAction: 0 }), [t]);
        return o.createElement(
          Et.Provider,
          { value: r },
          o.createElement(Mn, { nodeRenderer: $n, showHeader: !1, viewModel: n, isDialog: !0 }),
        );
      }
      var to = n(16216),
        no = n(98310),
      ...
      class lo {
        constructor(e) {
          (this._onChange = new oo.Delegate()),
            (this._recalculate = () => {
              const e = this._groupModel.groups().map((e) => io(e.id, e.instanceId())),
        ...
        buildTree() {
          ...
          for (const t of this._controller.model().panes()) {
            ...
            for (const n of this._groupModel.groups()) {
              ...
              if (r.pane() === t) {
                const o = [...n.lineTools()]
                  ...
                  .map((e) => io(e.id(), e.instanceId()));
                (e[r.id()] = co(r.id(), 1, t.id(), o)), e[t.id()].children.push(r.id());
            ...
            e[t.id()].children.sort((e, t) => {
              ...
              return (0, M.ensureNotNull)(o.zOrder()) - (0, M.ensureNotNull)(n.zOrder());
            });
          }
      ...
      var uo = n(36298),
        ...
        Co = n(28824),
        To = n(57674);
      const wo = new uo.TranslatedString("show {title}", p.t(null, void 0, n(87358))),
        Io = new uo.TranslatedString("hide {title}", p.t(null, void 0, n(70301))),
        Eo = new uo.TranslatedString("lock {title}", p.t(null, void 0, n(50193))),
        Mo = new uo.TranslatedString("unlock {title}", p.t(null, void 0, n(92421))),
        Do = new uo.TranslatedString(
          "change {sourceTitle} title to {newSourceTitle}",
          p.t(null, void 0, n(40001)),
        ),
        ko = new uo.TranslatedString("insert source(s) after", p.t(null, void 0, n(8343))),
        No = !1;
      function Lo(e, t) {
      ...
      function Ao(e) {
        return new uo.TranslatedString(e.name(), e.title(So.TitleDisplayTarget.DataWindow));
      }
      ...
      class Bo {
        constructor(e, t) {
          (this._syncStateChanged = new oo.Delegate()),
            (this._updateSyncState = () => {
              this._syncStateChanged.fire((0, M.ensureNotNull)(this.getDrawingSyncState()));
            }),
            (this._undoModel = e),
            (this._dataSource = t),
            (0, po.isLineTool)(t)
        ...
        canBeLocked() {
          return (0, po.isLineTool)(this._dataSource) && this._dataSource.userEditEnabled();
        }
        canBeRemoved() {
          return (
        ...
        isActualInterval() {
          return (
            (!(0, po.isLineTool)(this._dataSource) && !(0, fo.isStudy)(this._dataSource)) ||
            this._dataSource.isActualInterval()
          );
        }
        onIsActualIntervalChange() {
          return (0, po.isLineTool)(this._dataSource) || (0, fo.isStudy)(this._dataSource)
            ? this._dataSource.onIsActualIntervalChange()
            : Ro;
        }
        isLocked() {
          return (
            !!(0, po.isLineTool)(this._dataSource) && this._dataSource.properties().frozen.value()
          );
        }
        onVisibilityChanged() {
        ...
        getIcon() {
          ...
          if (e && t)
            ...
            } else "svgContent" === t.type && (o = { type: kn.Svg, content: t.content });
          return o;
        }
        onIconChanged() {
        ...
        setName(e) {
          if ((0, po.isLineTool)(this._dataSource)) {
            const t = Do.format({
              sourceTitle: this._dataSource.properties().title.value() || Ao(this._dataSource),
              newSourceTitle: e,
            });
            this._undoModel.setProperty(this._dataSource.properties().title, e, t, No);
          }
        }
        isCopiable() {
        ...
        pane() {
          return (0, M.ensureNotNull)(this._undoModel.model().paneForSource(this._dataSource));
        }
        allowsMovingbetweenPanes() {
          return !(0, po.isLineTool)(this._dataSource);
        }
        canBeAddedToGroup() {
          return (0, po.isLineTool)(this._dataSource) && this._dataSource.boundToSymbol();
        }
        ...
        canBeSyncedInLayout() {
          return (0, po.isLineTool)(this._dataSource) && this._dataSource.isSynchronizable();
        }
        onSyncStateChanged() {
          ...
          if ((0, po.isLineTool)(this._dataSource)) {
            ...
            null !== t
              ? ((0, M.assert)(!e.some((e) => e.hasChildren())),
                i.forEach((e) => {
                  (0, po.isLineTool)(e) && (t.containsLineTool(e) || o.addLineToolToGroup(t, e));
                }))
              : r();
          } else r();
      ...
      class Po {
        constructor(e, t) {
          (this._onVisibilityChanged = new oo.Delegate()),
            ...
            (this._paneId = (0, M.ensureNotNull)(e.model().paneForSource(this._lineTools[0])).id());
          const n = () => {
        ...
        getDrawingSyncState() {
          ...
          if (jo) {
            const t =
              null === (e = this._lineTools[0]) || void 0 === e ? void 0 : e.sharingMode().value();
          ...
          return this._lineTools.every((e) => null !== e.linkKey().value()) ? 1 : 0;
        }
        doNotAffectChartInvalidation() {
          return No;
        }
      ...
      class zo {
        ...
        getObjectById(e) {
          if (this._entitiesCache.has(e)) return (0, M.ensureDefined)(this._entitiesCache.get(e));
        ...
        contextMenuActions(e, t, n) {
          const o = new bo.ActionsProvider(e, n),
            r = [];
          return t.forEach((e) => e.addSourcesToArray(r)), o.contextMenuActionsForSources(r);
        }
        insertBefore(e, t) {
      ...
      const Qo = new uo.TranslatedString("move objects", p.t(null, void 0, n(40566))),
        Xo = new uo.TranslatedString("lock objects", p.t(null, void 0, n(68163))),
        Jo = new uo.TranslatedString("unlock objects", p.t(null, void 0, n(66824))),
        er = new uo.TranslatedString("show objects", p.t(null, void 0, n(63549))),
        tr = new uo.TranslatedString("hide objects", p.t(null, void 0, n(28506))),
        nr = new uo.TranslatedString("remove objects", p.t(null, void 0, n(57428)));
      class or {
        constructor(e) {
          (this._nodes = {}),
            (this._onChange = new oo.Delegate()),
            ...
            (this._ensuredEntity = (e) => (0, M.ensureNotNull)(this._getEntityById(e))),
            (this._chart = e),
            this._init();
        }
        destroy() {
            ...
            : (this.selection().set([e]),
              null !== n
                ? this._controller.mainSeries() === n
                  ? this._chart
                      .value()
                      .showGeneralChartProperties(void 0, { shouldReturnFocus: !0 })
                  : ((0, po.isLineTool)(n) || (0, fo.isStudy)(n)) &&
                    this._chart
                      .value()
                      .showChartPropertiesForSource(n, t, { shouldReturnFocus: !0 })
                : this._chart
                    .value()
        ...
        canSelectionBeUnmerged() {
          const e = this._getSelectedEntities();
          return 1 === e.length && this.canNodeWithIdBeUnmerged(so(e[0].id()).persistentId);
        }
        canNodeWithIdBeUnmerged(e) {
          const t = this._model.dataSourceForId(e);
          return (
            null !== t && (0, Fo.isPriceDataSource)(t) && this._model.isUnmergeAvailableForSource(t)
          );
        }
        unmergeSelectionUp() {
        ...
        copySelection() {
          const e = this._getSelectedEntities(),
            t = e.map((e) =>
              (0, M.ensureNotNull)(this._model.dataSourceForId(so(e.id()).persistentId)),
            );
          this._chart.value().chartWidgetCollection().clipboard.uiRequestCopy(t), fn("Copy", gn(e));
        }
        cloneSelection() {
          const e = this._getSelectedEntities(),
            t = e.map((e) =>
        ...
        rename(e, t) {
          ...
          1 === n.length && n.some((e) => e.canBeRenamed()) && (t(), fn("Rename", gn(n)));
        }
        async openContextMenu(e, t, n) {
          ...
          let i;
          if (this._objects.some((e) => e.hasChildren())) i = this._getActionsForGroupItem(e, t, r);
          else {
          ...
          if (i.length > 0) {
            ...
            (a = s
              ...
              : {
                  menuName: "ObjectTreeContextMenu",
                  detail: { type: "study", id: (null == r ? void 0 : r.id()) || null },
                }),
              Wo.ContextMenuManager.showMenu(i, n, { takeFocus: !0, returnFocus: !0 }, a, () => {
        ...
        getNextNodeIdAfterRemove(e) {
          ...
          if (
            (null === (t = i.pane().mainDataSource()) || void 0 === t ? void 0 : t.id()) === o &&
          ...
          const s = (0, M.ensureDefined)(n.find((e) => e.id === r.parentId)).children;
          return 1 === s.length
        ...
        _getActionsForGroupItem(e, t, n) {
          ...
          const r = [];
          1 === this._objects.length && r.unshift(this._getRenameAction(t), new Go.Separator()),
            n && r.unshift(this._getGroupAction(), new Go.Separator());
          const i = (0, bo.createSyncDrawingActions)(this._chart.value(), o.filter(po.isLineTool));
          ...
          return (
            r.push(
              ...
              new Go.Action({
                actionId: s.actionId,
                options: { label: s.label, icon: s.icon, onExecute: () => this.openProperties(e) },
              }),
            ),
            r
          );
        ...
        _unmergeSelection(e) {
          ...
          const n = t[0],
            o = (0, M.ensureNotNull)(this._model.dataSourceForId(so(n.id()).persistentId));
          if (!(0, Fo.isPriceDataSource)(o)) throw new Error("Entity is not IPriceDataSource");
        ...
        _normalizeTargetAndDropType(e, t) {
          ...
          return (
            "inside" === t &&
              ((t = "before"),
              (n = (0, M.ensureNotNull)(this.entity([...n.childrenIds()].shift() || "")))),
            [n, t]
          );
        }
    ...
    54079: (e, t, n) => {
      ...
      const d = (0, o.forwardRef)(function (e, t) {
        const {
          ...
          g = l.PLATFORM_ACCESSIBILITY_ENABLED ? { role: "toolbar", "aria-orientation": d } : {},
        ...
        return (
          (0, o.useLayoutEffect)(() => {
            ...
            const e = (0, r.ensureNotNull)(v.current),
              t = () => {
                const t = (0, l.queryTabbableElements)(e).sort(l.navigationOrderComparator);
                if (0 === t.length) {
                  const [t] = (0, l.queryFocusableElements)(e).sort(l.navigationOrderComparator);
                  if (void 0 === t) return;
          ...
          o.createElement("div", {
            ...
            onKeyDown: (0, i.createSafeMulticastEventHandler)(function (e) {
              ...
              if (h && 27 === t) return e.preventDefault(), void document.activeElement.blur();
