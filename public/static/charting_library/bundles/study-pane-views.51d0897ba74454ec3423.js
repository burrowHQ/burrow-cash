  ...
  [507],
  {
    ...
    21335: (t, e, i) => {
            ...
            i.histograms.forEach((n) => {
              ...
              if (
                (n.bars.forEach((s) => {
                  ...
                  const m = Math.max((l.percentWidth * f) / 100 - s.subBarValues.length, 0);
                  let x = u;
      ...
      function g(t, e, i, s, r, n) {
        const { fontSize: o, verticalOffset: l } = (function (t, e, i) {
            return {
              fontSize: Math.min(Math.round((1.7 * t) / i.length), Math.round(0.6 * e)),
          ...
          p = c + 3 * u,
          f = e + l;
        return { text: n, color: r.valuesColor, fontSize: o, align: h, point: new d.Point(p, f) };
      }
      function m(t, e, i) {
