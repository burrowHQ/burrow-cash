  ...
  [6456],
  {
    ...
    94720: (e, t, n) => {
      ...
      function u(e) {
        ...
        return r.createElement(
          r.Fragment,
          null,
          p && r.createElement(a.Icon, { icon: p, className: l()["start-icon-wrap"] }),
          s && r.createElement("span", { className: l().content }, s),
          d && !o && r.createElement(a.Icon, { icon: d, className: l()["end-icon-wrap"] }),
          m &&
            (function (e) {
              return (
                e.primaryText &&
      ...
      function f(e) {
        const { reference: t, tooltipText: n, ...i } = e,
          ...
          l = d({ ...i, isGrouped: o, cellState: a, disablePositionAdjustment: s });
        return r.createElement(
          "button",
          {
            ...v(i),
      ...
      function b(e) {
        const { intent: t, size: n, appearance: r, useFullWidth: i, icon: o, ...a } = e;
        return { ...a, color: y(t), size: _(n), variant: g(r), stretch: i, startIcon: o };
      }
      function C(e) {
      ...
      const r = (() => {
        ...
        return () => {
          ...
          if (void 0 === e) {
            ...
            null === (t = n.parentNode) || void 0 === t || t.removeChild(n), (e = i - a);
          }
          return e;
        };
      })();
      ...
      function c(e) {
        ...
        if (e && 1 == ++s) {
          ...
          "hidden" !== e.toLowerCase() &&
            ...
            (i(n, "right", `${r()}px`), (t.style.paddingRight = `${s + r()}px`), (l = !0)),
    ...
    69654: (e, t, n) => {
      ...
      function d(e) {
        ...
        return r.createElement(
          ...
          r.createElement(
            "div",
            { className: o()(c.inputContainer, p, d && c.withCancel) },
            i || r.createElement(u, { ...v }),
          ),
          t,
          r.createElement(s.Icon, { className: o()(c.icon, m), icon: l }),
          d &&
            r.createElement(
              "div",
    ...
    22265: (e, t, n) => {
      ...
      function d(e) {
        ...
        return r.createElement("div", { ...i, className: d, "data-role": "dialog-sidebar" });
      }
      function u(e) {
      ...
      function h(e) {
        const {
          ...
          y = d ? (null == i ? void 0 : i.active) : null == i ? void 0 : i.default;
        return r.createElement(
          h,
          {
            ...v,
            ref: p,
            className: o()(c.tab, g && c.isTablet, f && c.isMobile, d && c.active, m),
            onClick: u,
          },
    ...
    57979: (e, t, n) => {
      ...
      function w(e) {
        ...
        return r.createElement("span", { className: f()(E.title, i && E.disabled, n) }, t);
      }
      ...
      function L(e) {
        const t = (0, r.useContext)(I),
          ...
          { isFavorite: E, isLocked: T, public: L, editorsPick: F } = s,
          M = void 0 !== E,
          j = z(g, s),
          W = (0, r.useCallback)(
            (e) => {
          ...
          H =
            (0, N.useWatchedValueReadonly)({ watchedValue: S.watchedTheme }) === D.StdTheme.Dark
              ? B.dark
              : B.light,
          Z = f()(
            B.container,
        ...
        return r.createElement(
          ...
          r.createElement(
            "div",
            {
              className: f()(B.main, !M && B.paddingLeft),
            },
            M &&
            ...
            r.createElement(
              w,
              { disabled: s.isGrayed },
              r.createElement(P.HighlightedText, { queryString: l, rules: c, text: s.title }),
            ),
            !1,
            d && r.createElement(BadgeIndicator, { type: "beta", className: B.badge }),
            u && r.createElement(BadgeIndicator, { type: "new", className: B.badge }),
            h && r.createElement(BadgeIndicator, { type: "updated", className: B.badge }),
            Boolean(F && !k) &&
          ...
          L &&
            r.createElement(
              "a",
              { href: L.authorLink, className: B.author, target: "_blank", onClick: W },
              L.authorName,
            ),
          "mobile" !== a && L && r.createElement("span", { className: B.likes }, L.likesCount),
          !1,
        );
      }
      function z(e, t) {
      ...
      function q(e) {
        ...
        return r.createElement(
          ...
          a && s && r.createElement(H.Button, { onClick: s, className: Z.button }, a),
        );
      }
      function O(e) {
      ...
      function Q(e) {
        return -1 === te(e)
          ? ((function (e) {
              !ee(e) && ($.push(e), re(), K.fire(e));
            })(e),
            !0)
          : ((function (e) {
              const t = te(e);
              -1 !== t && ($.splice(t, 1), re(), J.fire(e));
            })(e),
            !1);
      }
      function ee(e) {
      ...
      function ne() {
        var e, t;
        $ = [];
        const n = Boolean(void 0 === (0, Y.getValue)("chart.favoriteLibraryIndicators")),
          r = (0, Y.getJSON)("chart.favoriteLibraryIndicators", []);
        if (($.push(...r), 0 === $.length && n && "undefined" != typeof window)) {
          const n = JSON.parse(
          ...
          n && Array.isArray(n) && $.push(...n);
        }
        X.fire();
      }
      function re() {
        const e = $.slice();
        (0, Y.setJSON)("chart.favoriteLibraryIndicators", e);
      }
      function ie(e) {
        const {
            reference: t,
          ...
          [d, u] = (0, r.useState)(""),
          p = (0, r.useMemo)(() => (0, U.createRegExpList)(d, h), [d]),
          m = (0, r.useMemo)(
            () =>
              d
                ? (0, U.rankedSearch)({
            ...
            return (
              ...
              ),
              {
                ...
                handleKeyDown: function (e) {
                  ...
                  if (
                    (40 === (0, T.hashFromEvent)(e) && (e.preventDefault(), h(), v(r)),
                    38 === (0, T.hashFromEvent)(e) && (e.preventDefault(), p(), v(t)),
        ...
        return (
          (0, r.useEffect)(() => {
            var e;
            a || u(""),
              _.CheckMobile.any() || null === (e = I.current) || void 0 === e || e.focus();
          }, [a]),
          r.createElement(y.AdaptivePopupDialog, {
            isOpened: a,
            onClose: s,
            onClickOutside: s,
            className: f()(G.dialogLibrary),
            render: function () {
              return r.createElement(
                r.Fragment,
                null,
                ...
                r.createElement(
                  ...
                  r.createElement(
                    k,
                    { reference: w, className: G.scroll },
                    S
                      ...
                      ? r.createElement(
                          ...
                          r.createElement(
                            W,
                            null,
                            r.createElement(M, { title: o.t(null, void 0, n(15491)) }),
                          ),
                          m
                            .slice()
                            .sort(oe)
                            .map((e) => {
                              ...
                              return r.createElement(L, {
                                ...
                                query: d,
                                regExpRules: p,
                                reference: t ? E : void 0,
                                isSelected: (null == x ? void 0 : x.id) === e.id,
                                isHighlighted: (null == v ? void 0 : v.id) === e.id,
        ...
        function R() {
          var e;
          d.length > 0 && (null === (e = I.current) || void 0 === e || e.select());
        }
      }
      function oe(e, t) {
        return e.isFavorite === t.isFavorite ? 0 : e.isFavorite ? -1 : 1;
      }
      ne(), Y.onSync.subscribe(null, ne);
      var ae = n(76422),
        se = n(74970),
        le = n(97145);
      function ce(e, t) {
      ...
      class de extends class {
        ...
        async _init() {
          ...
          (this._indicatorData = await (async function (e, t) {
            ...
            J.subscribe(null, () => this._refreshFavorites());
        }
        _setFavorites() {
    ...
    36189: (e, t, n) => {
      ...
      var r = n(11542),
        ...
        l = n(48010),
        c = n(14877);
      const d = { add: r.t(null, void 0, n(44629)), remove: r.t(null, void 0, n(72482)) };
      function u(e) {
        ...
        return t
          .map((e) => {
            ...
            return (
              n.forEach((e) => {
                var n, a, s, l, c;
                const { re: p, fullMatch: m } = e;
                if (
                  ((p.lastIndex = 0),
                  (0, r.isString)(t) && t && t.toLowerCase() === i.toLowerCase())
                )
                  return (
                    (h = 4), void (u = null === (n = t.match(m)) || void 0 === n ? void 0 : n.index)
                  );
                if ((0, r.isString)(t) && m.test(t))
                  return (
                    (h = 3), void (u = null === (a = t.match(m)) || void 0 === a ? void 0 : a.index)
                  );
                if ((0, r.isString)(o) && m.test(o))
                  return (
                    (h = 2), void (u = null === (s = o.match(m)) || void 0 === s ? void 0 : s.index)
                  );
                if ((0, r.isString)(o) && p.test(o))
                  return (
                    (h = 2), void (u = null === (l = o.match(p)) || void 0 === l ? void 0 : l.index)
                  );
                if (Array.isArray(d))
                  for (const e of d)
                    if (m.test(e))
                      return (
                        (h = 1),
                        void (u = null === (c = e.match(m)) || void 0 === c ? void 0 : c.index)
                      );
              }),
