  ...
  [3596],
  {
    73023: (e, t, i) => {
      ...
      const m = new v.TranslatedString(
        ...
        w = new v.TranslatedString("change symbol legend format", r.t(null, void 0, i(95071))),
        S = new v.TranslatedString(
          "change open market status visibility",
          r.t(null, void 0, i(18644)),
        ),
        D = new v.TranslatedString("change OHLC values visibility", r.t(null, void 0, i(57889))),
        _ = new v.TranslatedString(
          "change last day change visibility",
          r.t(null, void 0, i(50058)),
        ),
        V = new v.TranslatedString("change bar change visibility", r.t(null, void 0, i(45110))),
        ...
        W = new v.TranslatedString("change volume values visibility", r.t(null, void 0, i(9455))),
        M = new v.TranslatedString("change symbol field visibility", r.t(null, void 0, i(6091))),
        ...
        I = n.enabled("show_symbol_logos") && n.enabled("show_symbol_logo_in_legend");
      var q = i(74304),
        J = i(20345),
        K = i(11095),
        Q = i(42226),
      ...
      const Y = n.enabled("show_average_close_price_line_and_label"),
        $ = new v.TranslatedString("change symbol labels visibility", r.t(null, void 0, i(9402))),
        ee = new v.TranslatedString(
          "change symbol last value visibility",
          r.t(null, void 0, i(53150)),
        ),
        te = new v.TranslatedString("change symbol last value mode", r.t(null, void 0, i(28741))),
        ie =
        ...
        le = new v.TranslatedString("change no overlapping labels", r.t(null, void 0, i(83935))),
        ...
        de = new v.TranslatedString("change unit label visibility", r.t(null, void 0, i(7011))),
        he = new v.TranslatedString(
          "change currency and unit labels visibility",
          r.t(null, void 0, i(88161)),
        ),
        ue = new v.TranslatedString("change plus button visibility", r.t(null, void 0, i(50190))),
        pe = new v.TranslatedString("toggle lock scale", r.t(null, void 0, i(21203))),
        ve = new v.TranslatedString("change price to bar ratio", r.t(null, void 0, i(69510))),
        ge = new v.TranslatedString("change date format", r.t(null, void 0, i(50457))),
        ye = new v.TranslatedString("change time hours format", r.t(null, void 0, i(76991))),
        Pe =
          (new v.TranslatedString("change day of week on labels", r.t(null, void 0, i(7104))),
          r.t(null, void 0, i(35383))),
        fe = r.t(null, void 0, i(27767)),
        be = (r.t(null, void 0, i(40847)), r.t(null, void 0, i(25084)), r.t(null, void 0, i(9654))),
        me = (r.t(null, void 0, i(29687)), r.t(null, void 0, i(34905))),
        we =
          (r.t(null, void 0, i(47586)), r.t(null, void 0, i(74823)), r.t(null, void 0, i(95036))),
      ...
      const Ne = new v.TranslatedString(
        ...
        Ee = new v.TranslatedString("change sessions breaks color", r.t(null, void 0, i(1579))),
        je = new v.TranslatedString("change sessions breaks width", r.t(null, void 0, i(15035))),
        ze = new v.TranslatedString("change sessions breaks style", r.t(null, void 0, i(21460))),
        Ue = r.t(null, void 0, i(59827));
      const Ie = new v.TranslatedString(
          "change chart background color",
          r.t(null, void 0, i(99011)),
        ),
        qe = new v.TranslatedString("change chart background type", r.t(null, void 0, i(72458))),
        Je = new v.TranslatedString("change vert grid lines color", r.t(null, void 0, i(22722))),
        Ke = new v.TranslatedString("change horz grid lines color", r.t(null, void 0, i(88096))),
        Qe = new v.TranslatedString("change grid lines visibility", r.t(null, void 0, i(27764))),
        Xe = new v.TranslatedString("change scales text color", r.t(null, void 0, i(35065))),
        Ye = new v.TranslatedString("change scales font size", r.t(null, void 0, i(84382))),
        $e = new v.TranslatedString("change scales lines color", r.t(null, void 0, i(12468))),
        et = new v.TranslatedString("change pane separators color", r.t(null, void 0, i(89032))),
        tt = new v.TranslatedString("change crosshair color", r.t(null, void 0, i(29951))),
        it = new v.TranslatedString("change crosshair width", r.t(null, void 0, i(37034))),
        ot = new v.TranslatedString("change crosshair style", r.t(null, void 0, i(92027))),
        rt = new v.TranslatedString(
          "change symbol watermark visibility",
          r.t(null, void 0, i(87159)),
        ),
        nt = new v.TranslatedString("change symbol watermark color", r.t(null, void 0, i(25616))),
        lt = new v.TranslatedString(
          "change navigation buttons visibility",
          r.t(null, void 0, i(35646)),
        ),
        at = new v.TranslatedString("change pane buttons visibility", r.t(null, void 0, i(37730))),
        st = new v.TranslatedString("change top margin", r.t(null, void 0, i(98905))),
        ct = new v.TranslatedString("change bottom margin", r.t(null, void 0, i(10349))),
        dt = new v.TranslatedString("change right margin", r.t(null, void 0, i(35636))),
        ht = new v.TranslatedString("change right margin percentage", r.t(null, void 0, i(66601))),
      ...
      function Wt(e, t, o, s, c, d, h, u, p, v) {
        const g = [],
          ...
          w = (0, a.createColorPropertyDefinition)(
            {
              color: (0, a.getColorDefinitionProperty)(e, t.background, null, Ie),
          ...
          _ = (0, a.createOptionalTwoColorsPropertyDefinition)(
            {
              option: (0, a.convertToDefinitionProperty)(e, t.gridLinesMode, Qe),
          ...
          T = (0, a.createLinePropertyDefinition)(
            {
              visible: (0, a.convertFromReadonlyWVToDefinitionProperty)(V.ownership()),
              color: (0, a.getColorDefinitionProperty)(e, t.separatorColor, null, et),
            },
          ...
          k = (0, a.createLinePropertyDefinition)(
            {
              color: (0, a.getColorDefinitionProperty)(e, C.color, C.transparency, tt),
        ...
        const O = (0, a.createNumberPropertyDefinition)(
          ...
          R = (0, a.createNumberPropertyDefinition)(
            { value: (0, a.convertToDefinitionProperty)(e, t.bottomMargin, ct, [J.floor]) },
            {
              type: 0,
              id: "paneBottomMargin",
              title: Tt,
        ...
        if ((b.push(O, R), n.enabled("chart_property_page_right_margin_editor"))) {
          const t = { value: (0, a.convertFromWVToDefinitionProperty)(e, c.value, dt, [J.floor]) },
            i = {
              type: 0,
              id: "paneRightMargin",
              title: Ct,
          ...
          if (n.enabled("show_percent_option_for_right_margin")) {
            const o = (0, a.createNumberPropertyDefinition)(
              ...
              r = (0, a.createNumberPropertyDefinition)(
                {
                  checked: (0, a.convertFromWVToDefinitionProperty)(e, p, ht),
                  value: (0, a.convertFromWVToDefinitionProperty)(e, u, ht, [J.floor]),
                },
                {
                  type: 0,
      ...
      const ei = [
        ...
        { id: "symbol-text-source-ticker", value: "ticker", title: r.t(null, void 0, i(23097)) },
        {
      ...
      class ti {
        constructor(e, t, i) {
          ...
          const o = this._chartWidgetProperties.childs().paneProperties.childs(),
        ...
        _updateDefinitions() {
          (0, a.destroyDefinitions)(this._scalesPropertyPage.definitions.value());
        ...
        _createSeriesViewModel() {
          const e = {
            ...
            values: Gt.availableTimezones.map((e) => ({ value: e.id, title: e.title })),
          };
            ...
            o = (function (e, t, o, n, s) {
              ...
              if (I) {
                const i = (0, a.createCheckablePropertyDefinition)(
                  { checked: (0, a.convertToDefinitionProperty)(e, t.showLogo, S) },
                  { id: "showLogo", title: O },
                );
                d.push(i);
              }
              const h = (0, a.createOptionsPropertyDefinition)(
                {
                  checked: (0, a.convertToDefinitionProperty)(e, t.showSeriesTitle, m),
                  option: (0, a.convertToDefinitionProperty)(e, o.property, w),
                },
                { id: "symbolTextSource", title: R, options: new l.WatchedValue(o.values) },
              );
              if ((d.push(h), null !== n)) {
                const t = (0, b.combineWithFilteredUpdate)(
                    (t, i) =>
                      "market" === t && !(0, g.isEconomicSymbol)(e.mainSeries().symbolInfo()),
                    (e, t) => null !== e,
                  ...
                  i = (0, a.createCheckablePropertyDefinition)(
                    {
                      ...
                      visible: (0, a.convertFromReadonlyWVToDefinitionProperty)(t.ownership()),
                    },
              ...
              const u = (0, a.createCheckablePropertyDefinition)(
                { checked: (0, a.convertToDefinitionProperty)(e, t.showSeriesOHLC, D) },
                { id: "ohlcTitle", title: A },
              );
              if ((d.push(u), !y.alwaysShowLastPriceAndLastDayChange)) {
                const i = (0, a.createCheckablePropertyDefinition)(
                  {
                    checked: (0, a.convertToDefinitionProperty)(e, t.showBarChange, V),
              ...
              if (
                (d.push(
                  (0, a.createCheckablePropertyDefinition)(
                    { checked: (0, a.convertToDefinitionProperty)(e, t.showVolume, W) },
                    { id: "barVolume", title: F },
                  ),
                ),
                y.lastDayChangeAvailable || y.alwaysShowLastPriceAndLastDayChange)
              ) {
              ...
              if (U) {
                ...
                d.push(
                  (0, a.createCheckablePropertyDefinition)(
                    {
                      disabled: (0, a.convertFromReadonlyWVToDefinitionProperty)(
                        e.model().symbolSourceResolvingActive().weakReference(),
                      ),
                      checked: (0, a.convertToDefinitionProperty)(e, t.showPriceSource, M),
                      visible: (0, a.convertFromReadonlyWVToDefinitionProperty)(i.ownership()),
                    },
              ...
              const p = [],
                v = (0, a.createCheckablePropertyDefinition)(
                  { checked: (0, a.convertToDefinitionProperty)(e, t.showStudyArguments, T) },
                  { id: "studyArguments", title: B },
                ),
                q = (0, a.createCheckableSetPropertyDefinition)(
                  { checked: (0, a.convertToDefinitionProperty)(e, t.showStudyTitles, C) },
                  { id: "studyTitles", title: Z },
                  [v],
                ),
                J = (0, a.createCheckablePropertyDefinition)(
                  { checked: (0, a.convertToDefinitionProperty)(e, t.showStudyValues, k) },
                ...
                K = (0, P.createWVFromGetterAndSubscription)(
                  () =>
                    e
                      .model()
                      .priceDataSources()
                      .some((e) => !(0, f.isActingAsSymbolSource)(e) && e.showInObjectTree()),
              ...
              const Q = [],
                X = (0, a.createTransparencyPropertyDefinition)(
                  {
                    checked: (0, a.convertToDefinitionProperty)(e, t.showBackground, L),
              ...
              return (
                Q.push(X),
                c.push((0, a.createPropertyDefinitionsGeneralGroup)(Q, "generalLegendGroup")),
                { definitions: c }
              );
            })(
              this._undoModel,
              e,
              t,
              this._options.marketStatusWidgetEnabled ? p.showMarketOpenStatusProperty : null,
            );
        ...
        _createScalesDefinitions() {
          ...
          const o = { property: Ot.dateFormatProperty, values: this._availableDateFormatValues },
            s = {
          ...
          return (function (e, t, i, o) {
            ...
            if (o.seriesHasClosePrice) {
              const t = (0, a.createCheckablePropertyDefinition)(
                  { checked: (0, a.convertToDefinitionProperty)(e, i.showSymbolLabels, $) },
                  { id: "symbolNameLabel", title: Pe },
                ),
                o = (0, a.createOptionsPropertyDefinition)(
                  {
                    checked: (0, a.convertToDefinitionProperty)(e, i.showSeriesLastValue, ee),
                    option: (0, a.convertToDefinitionProperty)(e, i.seriesLastValueMode, te),
                  },
                  { id: "symbolLastValueLabel", title: fe, options: new l.WatchedValue(He) },
                );
              c.push(t, o);
            }
            const u = t.highLowAvgPrice.childs(),
              p = (0, a.createCheckablePropertyDefinition)(
                { checked: (0, a.convertToDefinitionProperty)(e, u.highLowPriceLabelsVisible, ie) },
              ...
              const t = (0, a.createCheckablePropertyDefinition)(
                {
                  ...
                  checked: (0, a.convertToDefinitionProperty)(e, i.showStudyPlotLabels, re),
                },
              ...
              const t = (0, a.createCheckablePropertyDefinition)(
                {
                  ...
                  checked: (0, a.convertToDefinitionProperty)(e, i.showStudyLastValue, ne),
                },
                {
            ...
            const v = (0, a.createCheckablePropertyDefinition)(
              { checked: (0, a.convertToDefinitionProperty)(e, r.alignLabels, le) },
              { id: "noOverlappingLabels", title: De },
            );
            if (
              (c.push(v),
              s.push((0, a.createPropertyDefinitionsGeneralGroup)(c, "scalesLabelsGroup", _e)),
              o.countdownEnabled)
            ) {
              const i = (0, a.createCheckablePropertyDefinition)(
                { checked: (0, a.convertToDefinitionProperty)(e, t.showCountdown, ae) },
            ...
            if (e.crossHairSource().isMenuEnabled()) {
              const t = (0, a.createCheckablePropertyDefinition)(
                { checked: (0, a.convertToDefinitionProperty)(e, K.addPlusButtonProperty, ue) },
              ...
              const t =
                ...
                r = (0, a.createOptionsPropertyDefinition)(
                  ...
                  },
                  {
                    ...
                    title: t,
                    options: new l.WatchedValue((0, Q.currencyUnitVisibilityOptions)()),
                  },
                );
              d.push(r);
            }
            const g = (0, a.createOptionsPropertyDefinition)(
                ...
                },
                {
                  ...
                  title: Le,
                  options: new l.WatchedValue((0, X.autoLogButtonsVisibilityOptions)()),
                },
              ),
              y = (0, a.createNumberPropertyDefinition)(
                ...
                },
                {
                  id: "lockScale",
                  title: Me,
                  min: new l.WatchedValue(o.mainSeriesScaleRatioProperty.getMinValue()),
                  max: new l.WatchedValue(o.mainSeriesScaleRatioProperty.getMaxValue()),
                  step: new l.WatchedValue(o.mainSeriesScaleRatioProperty.getStepChangeValue()),
                },
              ),
              b = (0, a.createOptionsPropertyDefinition)(
                {
                  option: (0, a.getPriceScaleSelectionStrategyDefinitionProperty)(
                    e,
                ...
                },
                {
                  id: "scalesPlacement",
                  title: We,
                  options: new l.WatchedValue(o.scalesPlacementPropertyObj.values),
                },
              );
            if (
              (d.push(g, y, b),
              s.push((0, a.createPropertyDefinitionsGeneralGroup)(d, "scalesPriceScaleGroup", Oe)),
              ...
              const t = (0, a.createOptionsPropertyDefinition)(
                ...
                { id: "dateFormat", title: Re, options: o.dateFormatPropertyObj.values },
              );
              h.push(t);
            }
            if (n.enabled("scales_time_hours_format")) {
              const t = (0, a.createOptionsPropertyDefinition)(
                ...
                },
                {
                  id: "timeHoursFormat",
                  title: Ae,
                  options: new l.WatchedValue(o.timeHoursFormatPropertyObj.values),
                },
              );
              h.push(t);
            }
            return (
              h.length > 0 &&
                s.push((0, a.createPropertyDefinitionsGeneralGroup)(h, "scalesTimeScaleGroup", Ge)),
              { definitions: s }
            );
        ...
        _createAppearancePropertyPage() {
          ...
          const h = (0, o.ensureNotNull)(this._maxRightOffsetPropertyObject),
            u = (0, o.ensureNotNull)(this._defaultRightOffsetPercentageWatchedValue),
            p = (0, o.ensureNotNull)(this._useRightOffsetPercentageWatchedValue),
            v = Wt(this._undoModel, t, n, i, h, l, a, u, p, this._gridColorsVisibilities);
