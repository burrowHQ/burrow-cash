          ...
          !(0, l.isIconOnly)(y, u) &&
            r.createElement(
              "span",
              {
                ...
                "data-overflow-tooltip-text": null != p ? p : (0, o.getTextForTooltip)(y),
              },
              h || c
                ? r.createElement(
                    r.Fragment,
    ...
    76068: (e, t, a) => {
      ...
      function s(e) {
        ...
        const o = (0, n.getStyleClasses)(e.size, e.className),
          s =
            null !== (a = null !== (t = e.alt) && void 0 !== t ? t : e.title) && void 0 !== a
              ? a
              : "";
    ...
    91952: (e, t, a) => {
      ...
      function h(e) {
        const { initialGoToDate: t, children: a } = e,
          ...
          l = (0, r.useMemo)(() => ({ date: n, setDate: o, isValid: s }), [n, s]);
      ...
      function p(e) {
        const { initialRanges: t, children: a } = e,
          ...
          u = (0, r.useMemo)(
            () => ({ dateFrom: n, dateTo: s, setDateFrom: o, setDateTo: i, isValid: l }),
            [n, s, l],
          );
      ...
      function T(e) {
        const { children: t } = e;
        return r.createElement("div", { className: v()(M.row, B && M.mobileRow) }, t);
      }
      var x = a(85528),
        z = a(76056);
      ...
      function P(e) {
        ...
        return r.createElement(E.Calendar, { ...a, className: v()(O.calendar, t), popupStyle: !1 });
      }
      function A(e, t) {
        const a = new Date(t);
        return (
          a.setFullYear(e.getFullYear()), a.setMonth(e.getMonth(), 1), a.setDate(e.getDate()), a
        );
      }
      function Y(e, t) {
        const a = new Date(t);
            ...
            !B &&
              r.createElement(P, {
                ...
                onSelect: function (e) {
                  var t;
                  const a = A(e, s);
                  i(a), null === (t = l.current) || void 0 === t || t.focus({ preventScroll: !0 });
                },
                onMonthSwitch: a,
                maxDate: new Date(),
              }),
      ...
      function F(e) {
        const { dateOnly: t, onCalendarMonthSwitch: a, onDateInputFocus: n } = e,
          {
            dateFrom: s,
            dateTo: i,
            setDateFrom: l,
          ...
          p = (0, r.useRef)(null),
          y = (0, r.useRef)(null),
          _ = (0, r.useMemo)(() => ("from" === c ? new Date(s) : new Date(i)), [c, i, s]);
        return (
          (0, r.useEffect)(() => {
        ...
        function v(e, t, a) {
          ...
          a(Y(s, t)),
            B || null === (r = h.current) || void 0 === r || r.focus({ preventScroll: !0 });
        }
      }
      var j = a(75983),
        U = a(90692),
      ...
      const B = H.mobiletouch,
        ...
        G = [
          ...
          { label: y.t(null, void 0, a(74615)), id: "CustomRange", dataId: "tab-item-customrange" },
        ];
      function Q(e) {
        const { dateOnly: t, onClose: n, onGoToDate: s, onGoToRange: i } = e,
          l = (0, r.useRef)(null),
          [u, c] = (0, r.useState)(b().getValue("GoToDialog.activeTab", "Date")),
          [h, p] = (0, r.useState)(0),
          { date: _, isValid: g } = (0, o.ensureNotNull)((0, r.useContext)(d)),
          { dateFrom: M, dateTo: T, isValid: x } = (0, o.ensureNotNull)((0, r.useContext)(m));
        return (
          (0, r.useEffect)(
            () => (
          ...
          r.createElement(U.MatchMedia, { rule: D.DialogBreakpoints.TabletSmall }, (e) =>
      ...
      function V(e) {
        const { activeTab: t, dateOnly: a, onCalendarMonthSwitch: n, onDateInputFocus: o } = e;
        switch (t) {
          case "Date":
      ...
      function K(e) {
        ...
        return r.createElement(
          ...
          r.createElement(
            p,
            { initialRanges: i },
            r.createElement(Q, { dateOnly: t, onClose: a, onGoToDate: n, onGoToRange: o }),
          ),
        );
      }
      var Z = a(94025),
              ...
              !(function (e, t) {
                ...
                e.model()
                  ...
                  .then((t) => {
                    ...
                    void 0 === t ? a.clearGotoDateResult() : a.setGotoDateResult(t);
                  });
              })(t, e),
                l();
            },
