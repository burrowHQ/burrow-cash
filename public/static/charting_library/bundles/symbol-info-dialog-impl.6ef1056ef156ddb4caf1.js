  ...
  [9374],
  {
    ...
    50041: (e) => {
      e.exports = {
        ...
        "text-button-light-gray-medium": "text-button-light-gray-medium-H6_2ZGVv",
    ...
    9745: (e, t, r) => {
      ...
      const o = a.forwardRef((e, t) => {
        const { icon: r = "", ...o } = e;
        return a.createElement("span", { ...o, ref: t, dangerouslySetInnerHTML: { __html: r } });
      });
    },
    99663: (e, t, r) => {
      "use strict";
      ...
      class i {
        ...
        ensureWindow(e, t = { position: "fixed", direction: "normal" }) {
          ...
          if (
            ...
            else if (t.index <= 0) this._container.insertBefore(a, this._container.firstChild);
            else {
      ...
      const a = (() => {
        ...
        return () => {
          ...
          if (void 0 === e) {
            ...
            null === (t = r.parentNode) || void 0 === t || t.removeChild(r), (e = o - n);
          }
          return e;
        };
      })();
      ...
      function c(e) {
        ...
        if (e && 1 == ++s) {
          ...
          "hidden" !== e.toLowerCase() &&
            ...
            (o(r, "right", `${a()}px`), (t.style.paddingRight = `${s + a()}px`), (l = !0)),
            ...
            (function ({ country: e, providerId: t, sourceId: r }) {
              ...
              return (o) => {
                const i = (e) => a.getProviderLogoUrl(e, m),
                  n = [
                    { value: r, resolve: i },
                    { value: e, resolve: (e) => a.getCountryFlagUrl(e.toUpperCase(), m) },
                    { value: t, resolve: i },
                  ].find(({ value: e }) => void 0 !== e && e.length > 0);
                return void 0 !== n ? n.resolve((0, p.ensureDefined)(n.value)) : d(o);
              };
      ...
      class l extends a.PureComponent {
        ...
        render() {
          ...
          return (
            ...
            o.createPortal(a.createElement(c.Provider, { value: this }, this.props.children), e)
          );
        }
        moveToTop() {
    ...
    31409: (e, t, r) => {
      "use strict";
      r.d(t, { DEFAULT_TOOL_WIDGET_BUTTON_THEME: () => s, ToolWidgetButton: () => l });
      var a = r(50959),
        o = r(97754),
        i = r(9745),
        n = r(78029);
          ...
          const {
            ...
            z =
              ...
              ("string" == typeof s
                ...
                : a.cloneElement(s, { className: o(S.icon, s.props.className) }));
          return "button" === r
            ? a.createElement(
                "button",
                {
                ...
                f && v && a.createElement("div", { className: o("js-button-text", S.text) }, v),
                z,
                !f && v && a.createElement("div", { className: o("js-button-text", S.text) }, v),
              )
            : a.createElement(
    ...
    63065: (e, t, r) => {
      ...
      var a = r(962),
        ...
        d = r(50041),
        u = r.n(d);
      const h = { small: "regular14px", medium: "semibold16px", large: "semibold18px" },
        p = (e) => {
      ...
      function m(e) {
        return o.createElement(
          ...
          o.createElement("span", {
            className: i(u().background, e.statesWithoutBg && u()["states-without-bg"]),
          }),
          e.startIcon &&
      ...
      class S extends o.PureComponent {
        constructor(e) {
          super(e),
            (this._fullSessionScheduleViewModel = new f.FullSessionScheduleViewModel(e.source));
        }
        componentWillUnmount() {
        ...
        render() {
          var e, t;
          const { className: r, showAllDays: a, timeZoneClassName: i } = this.props;
          return (
            null ===
              (t =
                null === (e = this.props.source.marketStatusModel()) || void 0 === e
                  ? void 0
      ...
      function N(e, t = {}) {
        ...
        (0, I.showOnElement)(e, {
          below: !0,
          tooltipDelay: a,
          content: { type: "html", data: `${i} <span style="vertical-align: middle;">${x}</span>` },
        }),
            ...
            render: function ({ requestResize: e }) {
              return (
                ...
                o.createElement(
                  ...
                  s.flat().length &&
                    l &&
                    o.createElement("div", { className: i(C.separator, C.widgetSeparator) }),
                  l &&
                    o.createElement(
                      o.Fragment,
                      null,
                ...
                e.length
                  ? o.createElement(
                      ...
                      o.createElement(
                        ...
                        (function (e) {
                          const t = [];
                          for (let r = 0; r < e.length; r += 2) t.push(e.slice(r, r + 2));
                          return t.map((e, t) => o.createElement(U, { key: t, fields: e }));
                        })(e),
                      ),
                      t !== s.length - 1 &&
                        o.createElement("div", { className: i(C.separator, C.groupSeparator) }),
                    )
                  : null,
              )
            : null;
      ...
      function W(e) {
        return (t = e.value || e.defValue || "-").charAt(0).toUpperCase() + t.substring(1);
        var t;
      }
      function U(e) {
        return o.createElement(
      ...
      class Y {
        constructor(e) {
          (this._symbolInfo = new B.WatchedValue(null)),
            ...
            (this._marketStatusModel = new j.MarketStatusModel(this._quotesProvider)),
            this._symbolInfo.subscribe(this._setSymbolInfo, { callWithLast: !0 });
        }
        destroy() {
      ...
      function ae(e) {
        return re(e) && void 0 !== e.pricescale
          ? new q.PriceFormatter(e.pricescale / (0, $.ensureDefined)(e.minmove2)).format(
              (0, $.ensureDefined)(e.minmove2) / e.pricescale,
            )
          : null;
      }
      function oe(e) {
      ...
      const ce = new Set(["stock", "fund", "dr", "right", "warrant", "structured"]);
      let de;
      class ue {
        constructor() {
            ...
            return [
              {
                ...
                group: 1,
                propName: (0, O.enabled)("charting_library_base") ? "name" : "pro_name",
              },
              { title: n.t(null, void 0, r(29601)), group: 1, propName: "description" },
              {
              ...
              { title: n.t(null, void 0, r(58416)), group: 2, propName: "type", getter: ie },
              {
              ...
              { title: n.t(null, void 0, r(64659)), group: 2, propName: "pointvalue" },
              {
                ...
                getStartSlot: (e, r) => {
                  var a;
                  const i =
                      null !== (a = null == r ? void 0 : r.country_code) && void 0 !== a
                        ? a
                        : e.country,
                    n = e.exchange_logo;
                  return t
                    ? o.createElement(K, { country: i, providerId: e.provider_id, sourceId: n })
                    : void 0;
                },
              },
              {
              ...
              },
              {
                ...
                visibility: (e) => Boolean((0, X.symbolOriginalCurrency)(e, !0)),
              ...
              },
              {
                ...
                visibility: (t) =>
                  Boolean((0, X.measureUnitId)(t) && (0, X.isMeasureUnitSymbol)(t) && e.showUnit),
                formatter: (e) => (null != e ? e : ""),
                defValue: "",
              },
              {
                ...
                group: 2,
                propName: "unit_id",
                getter: (t) => e.unitDescription((0, X.symbolOriginalUnit)(t, !!e.showUnit)),
                visibility: (t) => Boolean((0, X.symbolOriginalUnit)(t, !!e.showUnit)),
                formatter: (e) => (null != e ? e : ""),
                defValue: "",
              },
              {
              ...
              { title: n.t(null, void 0, r(55209)), group: 2, propName: "tick_size", getter: oe },
            ];
          })(e);
        ...
        _retrieveValues(e, t, r) {
          ...
          for (let n = 0; n < e.length; n++) {
            const s = e[n].getter,
              l = null === (o = (a = e[n]).getStartSlot) || void 0 === o ? void 0 : o.call(a, t, r);
            ...
            if (void 0 !== d) {
              const t = i[d];
              this._setFieldValue(e[n], (e[n].formatter || this._defaultFormatter)(t));
            }
          }
