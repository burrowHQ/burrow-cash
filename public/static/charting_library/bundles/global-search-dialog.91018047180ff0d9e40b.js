(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [9754, 9685],
  {
    ...
    82343: (e) => {
      e.exports = { wrap: "wrap-HAxAr6QG", image: "image-HAxAr6QG", text: "text-HAxAr6QG" };
    },
    95390: (e) => {
    ...
    26996: (e, t, n) => {
      ...
      var o = n(50959),
        ...
        i = n.n(l);
      function a(e) {
        const { className: t, size: n = "medium", staticPosition: l, color: a = "black" } = e,
          r = s(i().item, i()[a], i()[n]);
        return o.createElement(
          "span",
    ...
    89324: (e, t, n) => {
      ...
      const h = { SymbolSearchWatchlistDialogContentItem: null, SymbolSearchWatchlistDialog: null };
    },
    1861: (e, t, n) => {
      "use strict";
      ...
      function r(e) {
        ...
        function D() {
          s.unmountComponentAtNode(L), i.dialogsOpenerManager.setAsClosed("SymbolSearch"), f && f();
        }
        return (
          s.render(T, L), i.dialogsOpenerManager.setAsOpened("SymbolSearch"), S && S(), { close: D }
        );
      }
    },
    72539: (e, t, n) => {
      ...
      var T = n(95390);
      function D(e) {
        const { heading: t, selectedId: n, items: s, activeElRef: l, onExecute: i } = e;
        return o.createElement(
          "table",
          { className: T.section },
          o.createElement(
            "tbody",
            null,
            o.createElement("tr", null, o.createElement("td", { className: T.heading }, t)),
            s.map((e) =>
              o.createElement(L, {
                key: e.id,
                action: e,
        ...
        const { dialogId: t, items: s, onClose: l, shouldReturnFocus: i } = e,
          ...
          { activeIdx: f, setActiveIdx: C } = (0, E.useKeyboardNavigation)(
            ...
            function (e, t) {
              t.preventDefault();
              const n = p[f];
              n && !n.isDisabled() && (n.execute(), n.isCheckable() ? _() : l());
            },
            "keyup",
          );
      ...
      class G extends Z.Action {
        constructor({
          ...
          super({ actionId: "UnknownAction", options: { ...a, doNotCloseOnClick: !0 }, id: e }),
            (this.execute = () => {
              super.execute();
              const e = new Set(c.getJSON("GlobalSearchDialog.recent", [])),
            ...
            (this.update = (e) => {
              (this._searchOptions = Object.assign(this._searchOptions, e)), super.update(e);
            }),
      ...
      const ee = (e) => {
              ...
              t.forEach((t) => {
                o.push(
                  new G({
                    ...
                    label: `${r.t(null, void 0, n(32409))} ${q.translateStdThemeName(t)}`,
                    onExecute: () => {
            ...
            o.push(
              new G({
                ...
                onExecute: () => {
                  ...
                  q.loadTheme(e.chartWidgetCollection(), { themeName: n, standardTheme: !0 }).then(
                    () => {
                      e.readOnly() || window.saver.saveChartSilently();
                    },
                  );
        ...
        return window.is_authenticated ? q.getThemeNames().then(t) : Promise.resolve(t());
      };
      var te = n(88348),
        ne = n(18540);
      n(46100);
      ...
      const { DrawingSyncMode: ie } = te,
        ...
        re = new W.TranslatedString("stay in drawing mode", r.t(null, void 0, n(52010))),
        ce = new W.TranslatedString("sync drawings", r.t(null, void 0, n(95612))),
        he = r.t(null, void 0, n(49421)),
        de = r.t(null, void 0, n(35888)),
        ue =
          (r.t(null, void 0, n(77989)), r.t(null, void 0, n(19407)), r.t(null, void 0, n(37057))),
      ...
      class we extends G {
        constructor(e) {
          super({
            ...
            checkable: !0,
            onExecute: () => {
              this._model.invertPriceScale(this._model.mainSeries().priceScale());
            },
      ...
      class fe extends G {
        constructor(e) {
          super({
            ...
            onExecute: () => {
              this.isChecked()
                ? this._model.setPriceScaleRegularScaleMode(this._model.mainSeries().priceScale())
        ...
        constructor(e) {
          super({
            ...
            onExecute: () => {
              this.isChecked()
                ? this._model.setPriceScaleRegularScaleMode(this._model.mainSeries().priceScale())
                : this._model.togglePriceScaleLogScaleMode(this._model.mainSeries().priceScale());
            },
            ...
            (this._model = e);
          (this._props = this._model.mainSeries().priceScale().properties().childs().log).subscribe(
            this,
            () => {
              this._onUpdate.fire(this);
            },
      ...
      const ye = F.enabled("show_average_close_price_line_and_label"),
        Ee = new W.TranslatedString("change session", r.t(null, void 0, n(65303))),
        xe = new W.TranslatedString("change plus button visibility", r.t(null, void 0, n(50190))),
        ke = new W.TranslatedString(
          "change countdown to bar close visibility",
          r.t(null, void 0, n(58108)),
        ),
        Ce = new W.TranslatedString("scale price chart only", r.t(null, void 0, n(99042))),
        ...
        De = new W.TranslatedString("change symbol labels visibility", r.t(null, void 0, n(9402))),
        Ne =
        ...
        Pe =
          ...
          new W.TranslatedString("change price line visibility", r.t(null, void 0, n(67761)))),
        Oe = new W.TranslatedString(
          "change session breaks visibility",
          r.t(null, void 0, n(15403)),
        ),
        Re =
          (new W.TranslatedString("change ideas visibility on chart", r.t(null, void 0, n(65558))),
          new W.TranslatedString("show all ideas", r.t(null, void 0, n(13622))),
          new W.TranslatedString("show ideas of followed users", r.t(null, void 0, n(26267))),
          new W.TranslatedString("show my ideas only", r.t(null, void 0, n(40061))),
          new W.TranslatedString("change events visibility on chart", r.t(null, void 0, n(79574))),
          new W.TranslatedString("change earnings visibility", r.t(null, void 0, n(88217))),
          new W.TranslatedString("change dividends visibility", r.t(null, void 0, n(84944))),
          new W.TranslatedString("change splits visibility", r.t(null, void 0, n(74488))),
          {
      ...
      async function ze(e) {
            ...
            return (
              ...
              t.push(
                new G({
                  ...
                  id: "StrongMagnet",
                  category: "functionActions",
                  checked: a.value() && r.value() === oe.MagnetMode.StrongMagnet,
              ...
              e.options().goToDateEnabled &&
                t.push(
                  new G({
                    ...
                    shortcutHint: (0, h.humanReadableHash)(h.Modifiers.Alt + 71),
                  }),
                ),
              t
            );
        ...
        const b = e.model().mainSeries(),
          ...
          S = null === (o = (t = e.model()).paneForSource) || void 0 === o ? void 0 : o.call(t, b);
        u.push(
          new G({
            id: "ResetPriceScale",
            category: "functionActions",
        ...
        u.push(
          new G({
            ...
            disabled: Boolean(
              "regular" ===
                (null === (s = b.symbolInfo()) || void 0 === s ? void 0 : s.subsession_id),
            ),
            onExecute: () => {
            ...
            checked: Boolean(
              "regular" ===
                (null === (l = b.symbolInfo()) || void 0 === l ? void 0 : l.subsession_id),
            ),
          }),
        ),
          u.push(
            new G({
              ...
              category: "functionActions",
              disabled: !(null ===
                (a = null === (i = b.symbolInfo()) || void 0 === i ? void 0 : i.subsessions) ||
              void 0 === a
                ? void 0
              ...
              onExecute: () => {
                ...
                const n =
                  "extended" ===
                  (null === (t = b.symbolInfo()) || void 0 === t ? void 0 : t.subsession_id)
                    ? "regular"
                    : "extended";
              ...
              checked: Boolean(
                "extended" ===
                  (null === (c = b.symbolInfo()) || void 0 === c ? void 0 : c.subsession_id),
              ),
            }),
          ),
          u.push(
            new G({
              ...
              category: "settingsActions",
              onExecute: () => {
                e.model().togglePriceScaleLockScaleMode(e.model().mainSeries().priceScale());
              },
          ...
          u.push(
            new G({
              ...
              onExecute: () => {
                w.isIndexedTo100()
                  ? e.model().setPriceScaleRegularScaleMode(e.model().mainSeries().priceScale())
                  : e
                      .model()
                      .togglePriceScaleIndexedTo100ScaleMode(e.model().mainSeries().priceScale());
              },
              disabled: y || E,
        ...
        u.push(
          new G({
            label: k ? r.t(null, void 0, n(19567)) : r.t(null, void 0, n(76300)),
            id: "MoveScaleToSide",
            category: "functionActions",
        ...
        u.push(
          ...
          u.push(
            new G({
              ...
              shortcutHint: (0, h.humanReadableHash)(h.Modifiers.Mod + h.Modifiers.Alt + 81),
            }),
          );
        const P = e
          .model()
          ...
          for (const n of t)
            u.push(
              new G({
                id: `ChartStyle_${n}`,
                category: "functionActions",
                disabled: !(null === (d = R.linking.supportedChartStyles.value()) || void 0 === d
                  ? void 0
                  : d.includes(n)),
                onExecute: () => {
            ...
            u.push(
              new G({
                ...
                onExecute: () => {
                  ...
                  t.fullscreen().value() ? t.exitFullscreen() : t.startFullscreen();
                },
        ...
        return Fe.lineToolsFlat.map((e) =>
          (function (e) {
            ...
            const o = Be.lineToolsInfo[e],
              s = null === (t = o.selectHotkey) || void 0 === t ? void 0 : t.hash,
              l = {
                id: e,
            ...
            return (
              e.toLowerCase().includes("fib") && (l.aliases = [r.t(null, void 0, n(22305))]),
              new G(l)
            );
          })(e.name),
        );
          ...
          super(),
            ...
            (this.show = (e) => {
              (async function (e) {
                ...
                if (F.enabled("header_widget") && F.enabled("header_resolutions")) {
                  const o = {
                ...
                if (F.enabled("header_widget") && F.enabled("header_saveload")) {
                  ...
                  s &&
                    (t.push(
                      new G({
                        ...
                        category: "functionActions",
                        label: (0, V.appendEllipsis)(r.t(null, void 0, n(4142))),
                        onExecute: () => {
                          s.renameChart();
                        },
                      }),
                    ...
                    t.push(
                      new G({
                        ...
                        category: "functionActions",
                        icon: n(53707),
                        label: (0, V.appendEllipsis)(r.t(null, void 0, n(62571))),
                ...
                return (
                  t.push(
                    new G({
                      ...
                      shortcutHint: (0, h.humanReadableHash)(h.Modifiers.Alt + 83),
                    }),
                  ),
                  t
                );
                  ...
                  .concat(
                    (() => {
                      const e = new G({
                        ...
                        category: "functionActions",
                        icon: n(81111),
                        label: (0, V.appendEllipsis)(r.t(null, void 0, n(72357))),
            ...
            (this.hide = () => {
              s.unmountComponentAtNode(this._container), this._setVisibility(!1);
    ...
    98715: (e, t, n) => {
      ...
      function s(e, t) {
        (0, o.useEffect)(() => {
          var n;
          t >= 0 &&
            (null === (n = e.current) || void 0 === n || n.scrollIntoView({ block: "nearest" }));
        }, [t]);
      }
    },
    37404: (e, t, n) => {
    ...
    10772: (e, t, n) => {
      ...
      const S = (0, o.forwardRef)(function (e, t) {
        ...
        return o.createElement(v.ContextMenuItem, {
          ...
          tabIndex: i,
          onKeyDown: function (e) {
            if (!w.PLATFORM_ACCESSIBILITY_ENABLED || e.target !== e.currentTarget) return;
          ...
          "aria-disabled": (w.PLATFORM_ACCESSIBILITY_ENABLED && e.disabled) || void 0,
        });
      });
      class y extends o.PureComponent {
        ...
        componentDidUpdate(e, t) {
          ...
          t.loading !== this.state.loading &&
            (null === (o = (n = this.props).onRequestUpdate) || void 0 === o || o.call(n)),
            0 === t.subItems.length &&
              this.state.subItems.length > 0 &&
              (this._unsubscribe = this._registerSubmenu()),
            t.subItems.length > 0 &&
              0 === this.state.subItems.length &&
              (null === (s = this._unsubscribe) || void 0 === s || s.call(this)),
          ...
          return this.state.loading
            ...
            : o.createElement(
                S,
                {
                  ...
                  ref: null !== (t = this.props.reference) && void 0 !== t ? t : this._setItemRef,
        ...
        _trackEvent() {
          ...
          (0, a.trackEvent)("ContextMenuClick", this.props.menuStatName || "", e);
        }
        _getStatName() {
    ...
    50267: (e, t, n) => {
      "use strict";
      n.d(t, { ContextMenuItem: () => f, DEFAUL_CONTEXT_MENU_ITEM_THEME: () => b });
      var o = n(50959),
        s = n(97754),
        l = n(70673),
        i = n(49483),
      ...
      class f extends o.PureComponent {
        ...
        render() {
          const {
            ...
            S = this.props.checkable && this.props.checkboxInput ? "label" : "div";
          return o.createElement(
            o.Fragment,
            null,
            o.createElement(
              ...
              o.createElement(
                ...
                o.createElement(
                  ...
                  o.createElement(
                    "span",
                    { className: s(r.label, this.props.checked && r.checked), "data-label": !0 },
                    !b && f
                      ? f.map(({ text: e, ...t }, n) =>
                  ...
                  !e &&
                    t &&
                    !i.CheckMobile.any() &&
                    o.createElement(h.Hint, { className: s(l && r.invisibleHotkey), text: t }),
        ...
        _toolbox(e) {
          return this.props.toolbox
            ? o.createElement(
                "span",
                {
                  className: s(e.toolbox, this.props.showToolboxOnHover && e.showToolboxOnHover),
        ...
        _renderToolboxContent() {
          return this.props.toolbox && this.props.toolbox.type === d.ToolboxType.Delete
            ? o.createElement(r.RemoveButton, { onClick: this.props.toolbox.action })
            : null;
        }
      }
    },
    91561: (e, t, n) => {
      ...
      function w(e) {
        var t;
        const n = null !== (t = e.action.custom()) && void 0 !== t ? t : e.action,
          ...
          o.createElement(
            ...
            c &&
              o.createElement(
                g.Drawer,
                { onClose: h },
                o.createElement(y, { items: s.subItems, parentAction: n, closeNested: h }),
              ),
          )
        );
        function h(e) {
        ...
        render() {
          ...
          return e
            ? o.createElement(
                d.DrawerManager,
                null,
                o.createElement(c, { keyCode: 27, eventType: "keyup", handler: this._handleClose }),
                o.createElement(u.MatchMedia, { rule: "screen and (max-width: 430px)" }, (t) =>
                  this._isDrawer(t)
                    ? o.createElement(
                        E.Provider,
                        {
          ...
          this._menuRef.current && this._menuRef.current.update(),
            this.props.isKeyboardEvent &&
              (null === (e = this.props.menuElementReference) || void 0 === e
                ? void 0
                : e.current) &&
              document.activeElement === this.props.menuElementReference.current &&
      ...
      function m(e) {
        ...
        return s
          ...
          : o.createElement(
              ...
              !L && y && o.createElement(c.Hint, { className: v.shortcut, text: y }),
    ...
    41590: (e, t, n) => {
      ...
      var o = n(50959),
        ...
        d = n(66076);
      function u(e) {
        const { position: t = "Bottom", onClose: n, children: h, className: u, theme: m = d } = e,
    ...
    96040: (e, t, n) => {
      ...
      function c(e) {
        ...
        return s.createElement(i.Icon, {
          ...p,
          "data-name": m,
          className: l(r.button, "apply-common-tooltip", c && r.active, v && r.hidden, t),
          icon: a,
          onClick: h,
          onMouseDown: d,
    ...
    81261: (e, t, n) => {
      ...
      function r(e) {
        ...
        const p = v(c),
          ...
          b = -1 !== g,
          w = (e) => {
            a && (0, s.becomeSecondaryElement)(a), (0, s.becomeMainElement)(e), e.focus();
          };
        switch ((0, o.mapKeyCodeToDirection)(n)) {
          case "inlinePrev":
            if (!p.length) return;
            e.preventDefault(), w(0 === g ? r[m] : b ? h(p, g, -1) : p[p.length - 1]);
            break;
          case "inlineNext":
            if (!p.length) return;
            e.preventDefault(), g === p.length - 1 ? w(r[m]) : w(b ? h(p, g, 1) : p[0]);
            break;
          case "blockPrev": {
            e.preventDefault();
            const t = h(r, m, -1);
      ...
      function u(e) {
        return Array.from(
          e.querySelectorAll('[data-role="menuitem"]:not([disabled]):not([aria-disabled])'),
    ...
    28127: (e, t, n) => {
      ...
      function l(e) {
        return o.createElement(
          "tr",
          { className: s.row },
          o.createElement("td", null, o.createElement("div", { className: s.line })),
          o.createElement(
            "td",
            null,
            o.createElement("div", { className: s.line }),
            e.hint ? o.createElement("div", { className: s.hint }, e.hint) : null,
          ),
        );
      }
      var i = n(10772);
    ...
    45876: (e, t, n) => {
      ...
      var o = n(94670),
        ...
        v = n(3904),
        m = n(9450);
      const p = { 3: o, 16: s, 0: l, 1: i, 8: a, 9: r, 2: c, 14: h, 15: d, 10: u, 12: v, 13: m };
    },
    65890: (e) => {
      e.exports =
