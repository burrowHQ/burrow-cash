  ...
  [4716],
  {
    ...
    88601: (t) => {
      (t.exports = Object.create(null)),
        ...
        (t.exports.from_input = ["от"]),
        (t.exports.to_input = ["до"]),
        ...
        (t.exports.Close_input = ["Цена закрытия"]),
        (t.exports.Style_input = ["Стиль"]),
        (t.exports["Box size assignment method_input"] = ["Метод определения размера коробки"]),
        (t.exports["Color bars based on previous close_input"] = [
          "Цвет баров основан на цене предыдущего закрытия",
        ]),
        (t.exports.Candles_input = ["Японские свечи"]),
        (t.exports.Borders_input = ["Границы"]),
        (t.exports.Wick_input = ["Фитиль"]),
        (t.exports["HLC bars_input"] = ["Бары HLC"]),
        (t.exports["Price source_input"] = ["Источник цены"]),
        (t.exports.Type_input = ["Тип"]),
        ...
        (t.exports["Up bars_input"] = ["Восходящие бары"]),
        (t.exports["Down bars_input"] = ["Нисходящие бары"]),
        (t.exports["Projection up bars_input"] = ["Проекция восходящего бара"]),
        (t.exports["Projection down bars_input"] = ["Проекция нисходящего бара"]),
        (t.exports["Projection up color_input"] = ["Цвет проекции восходящего бара"]),
        (t.exports["Projection down color_input"] = ["Цвет проекции нисходящего бара"]),
        (t.exports.Line_input = ["Линия"]),
        (t.exports.Fill_input = ["Заливка"]),
        (t.exports["Up color_input"] = ["Цвет роста"]),
        (t.exports["Down color_input"] = ["Цвет падения"]),
        (t.exports.Traditional_input = ["Традиционный"]),
        (t.exports["Box size_input"] = ["Размер коробки"]),
        (t.exports["Number of line_input"] = ["Количество линий"]),
        (t.exports["ATR length_input"] = ["Длина ATR"]),
        (t.exports["Reversal amount_input"] = ["Величина разворота"]),
        (t.exports["Phantom bars_input"] = ["Фантомные бары"]),
        (t.exports["One step back building_input"] = [
          "Объединять одиночные сегменты с предыдущим баром",
        ]),
        (t.exports.Source_input = ["Данные"]),
        (t.exports.Wicks_input = ["Фитили"]),
        (t.exports.Range_input = ["Диапазон"]),
        ...
        (t.exports["Bollinger Bands %B_input"] = ["Полосы Боллинджера %B"]),
        ...
        (t.exports["Leading Span Periods_input"] = ["Опаздывающая линия 2 периода"]),
        (t.exports["Leading Shift Periods_input"] = ["Периоды ведущей линии"]),
    ...
    68716: (t) => {
      (t.exports = Object.create(null)),
        ...
        (t.exports["All Chart Patterns_study"] = ["Все графические паттерны"]),
        ...
        (t.exports["Bollinger Bands %B_study"] = ["Полосы Боллинджера %B"]),
        ...
        (t.exports["Relative Volume at Time_study"] = ["Относительный объём в момент времени"]),
        ...
        (t.exports["Stochastic Momentum Index_study"] = ["Индекс стохастического моментума"]),
        ...
        (t.exports["Time Weighted Average Price_study"] = ["Средневзвешенная по времени цена"]),
        ...
        (t.exports["Vortex Indicator_study"] = ["Индикатор Vortex"]),
        ...
        (t.exports["Harami Cross - Bearish_study"] = ["Медвежий Крест Харами"]),
        (t.exports["Harami Cross - Bullish_study"] = ["Бычий Крест Харами"]),
        ...
        (t.exports["Anchored Volume Profile_study"] = ["Профиль объёма, Anchored"]);
    },
    59791: (t) => {
      t.exports = ["Профиль объёма, Anchored"];
    },
    40434: (t) => {
    ...
    35696: (t) => {
      t.exports = ["Изменить интервал. Нажмите на число или запятую"];
    },
    71705: (t) => {
      t.exports = ["Сменить инструмент. Начните вводить имя инструмента"];
    },
    86715: (t) => {
      t.exports = ["График #{index}"];
    },
    14412: (t) => {
    ...
    69916: (t) => {
      t.exports = ["График {symbol}, {interval}"];
    },
    12011: (t) => {
    ...
    93213: (t) => {
      t.exports = ["Интервал не поддерживается"];
    },
    71778: (t) => {
    ...
    21585: (t) => {
      t.exports = ["Индикаторы, показатели и стратегии. Нажмите слэш"];
    },
    27677: (t) => {
    ...
    14702: (t) => {
      t.exports = ["Загрузить график. Нажмите точку"];
    },
    42284: (t) => {
    ...
    37611: (t) => {
      t.exports = ["Изменение последнего дня"];
    },
    25846: (t) => {
      t.exports = ["Лима"];
    },
    ...
    29787: (t) => {
      t.exports = ["Для начала работы с навигацией с помощью клавиатуры нажмите {shortcut}"];
    },
    93161: (t) => {
    ...
    4868: (t) => {
      t.exports = ["Быстрый поиск. Нажмите {shortcut}"];
    },
    9998: (t) => {
    ...
    74327: (t) => {
      t.exports = ["Включить/выключить автоматический масштаб"];
    },
    84112: (t) => {
      t.exports = ["Включить/выключить логарифмическую шкалу"];
    },
    20466: (t) => {
      t.exports = ["Токелау"];
    },
    ...
    81214: (t) => {
      t.exports = ["Скрипт содержит ошибку. Свяжитесь с его автором."];
    },
    74986: (t) => {
      t.exports = ["Доступ к этому скрипту ограничен. Запросите доступ у автора скрипта."];
    },
    58018: (t) => {
      t.exports = ["Инструмент доступен только на {linkStart}TradingView{linkEnd}."];
    },
    98538: (t) => {
    ...
    82772: (t) => {
      t.exports = ["В подписку на данные BIST MIXED не входят данные объёма."];
    },
    78560: (t) => {
      t.exports = ["Кластерный объём"];
    },
    15771: (t) => {
      t.exports = ["Ванкувер"];
    },
    ...
    30107: (t) => {
      t.exports = ["восстановление настроек стратегии по умолчанию"];
    },
    63060: (t) => {
      t.exports = ["включение/выключение автоматического масштаба"];
    },
    74724: (t) => {
      t.exports = ["состояние свёрнутой/развёрнутой панели"];
    },
    98860: (t) => {
    ...
    47228: (t) => {
      t.exports = ["В данный момент график {chartStyle} не доступен на тиковых интервалах."];
    },
    33355: (t) => {
    ...
    87826: (t) => {
      t.exports = [
        "{p_start}Для этого инструмента не поддерживаются тиковые интервалы. Ваш интервал автоматически переключится на дневной.{p_end}",
      ];
    },
    88841: (t) => {
    ...
    18562: (t) => {
      (t.exports = Object.create(null)),
        ...
        (t.exports["#NASDAQ:LCID-symbol-description"] = "Lucid Group, Inc."),
