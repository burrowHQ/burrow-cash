...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  ...
  {
    98653: (e, t, o) => {
      o.r(t), o.d(t, { SavingLineToolsError: () => i, SavingLineToolsLibraryError: () => s });
      ...
      class M {
        constructor(e, t, o) {
          (this._pendingRequests = new Map()),
            (this._startRequestingDebounced = (0, i.default)(() => this._startNextRequest(), 500)),
            (this._layoutId = e),
            (this._chartId = t),
        ...
        resolveLinkKey(e, t, o) {
          ...
          const s = (function (e, t) {
            ...
            n = null !== (i = this._pendingRequests.get(s)) && void 0 !== i ? i : new Map();
        ...
        async _startNextRequest() {
          ...
          const e = await (0, p.getChartStorage)(),
            ...
            { symbol: o, brokerName: i } = (function (e) {
          ...
          try {
            const t = await e.loadLineToolsAndGroups(this._layoutId, this._chartId, n, o);
            null !== t &&
              null !== t.sources &&
        ...
        return n().catch(() =>
          O.value()
            ...
            : (0, A.retriesWithDelays)(
                async () => (
                  await (async function (e = null) {
                    return !0 === navigator.onLine || void 0 === navigator.onLine
                      ? Promise.resolve()
                      : (0, I.respectAbort)(
                          e,
                          new Promise((e) => {
      ...
      class B {
        constructor(e, t, o, s, n) {
          (this._invalidatedLineToolsAndStudyStubs = new Map()),
            ...
            (this._debouncedSave = (0, i.default)(() => this._saveInvalidatedIfRequired(!1), 500)),
            ...
            this._chartModel
              ...
              .subscribe(this, this._processDataSourceCollectionChanged.bind(this)),
            this._chartModel
              .lineToolsGroupModel()
              .onChanged()
              .subscribe(this, this._processLineToolsGroupModelChanged.bind(this)),
            this._chartModel
              .mainSeries()
              .dataEvents()
              .symbolResolved()
            ...
            this._chartModel
              .sourceZOrderChanged()
              .subscribe(this, this._processPropertiesChanged.bind(this)),
            (this._linkKeyResolver = new M(e.layoutId, e.chartId, t.mainSeries().id())),
        ...
        setSaveChartService(e) {
          this._saveChartService &&
            this._saveChartService.autoSaveEnabled().unsubscribe(this._onChangeAutosave),
        ...
        resetInvalidated(e, t, o) {
                ...
                if (0 === o) {
                  t(s, {
                    sharingMode: this._doNotSaveSharedLineToolsToCharts.value()
                      ? o
                      : null !== (n = null == i ? void 0 : i.sharingMode) && void 0 !== n
                      ? n
                      : o,
                    duplicatedInChart: !this._doNotSaveSharedLineToolsToCharts.value(),
                  });
                } else
                  t(s, {
                    sharingMode: o,
                    duplicatedInChart:
                      null !== (r = null == i ? void 0 : i.duplicatedInChart) && void 0 !== r && r,
                  });
              }
            } else {
              const i = e.get(s);
          ...
          const { groups: s, sources: n, lineToolsToValidate: r, groupsToValidate: a } = t,
            l = K(this._invalidatedLineToolsAndStudyStubs, e, new Set(null != r ? r : n.keys()));
          ...
          const d = K(this._invalidatedLineToolGroups, e, new Set(null != a ? a : s.keys()));
          l.validated.forEach(
            i.bind(
              this,
        ...
        applyLineToolUpdateNotification(e, t) {
          ...
          (i.clientId === this._origin.clientId && i.chartId === this._origin.chartId) ||
            ...
            void 0 !== e.symbol && null === e.sources
              ? this._withoutInvalidating(() => {
                  const o = this._chartModel
                    .dataSources()
                    .filter(g.isLineTool)
                    .filter((o) => o.sharingMode().value() === t && o.symbol() === e.symbol);
                  o.length > 0 && this._chartModel.undoModel().removeSources(o, !0, null);
                })
        ...
        async markSyncedLineToolAsDeleted(e, t) {
          if (this._linkKeyResolver) {
            const o = await this._linkKeyResolver.resolveLinkKey(t, e, this._brokerName);
            if (null !== o) {
              const t = (0, g.lineToolByLinkKey)(this._chartModel, e);
              null === t
                ? this._invalidateLineToolOrStudyStub(o, performance.now())
                : this._withoutInvalidating(() => {
                    const e = (0, c.ensureNotNull)(this._chartModel.paneForSource(t)),
                      o = this._allLineToolsAndStudyStubs.get(e.id()) || new Map();
                    t.detachAlert(), this._chartModel.removeSource(t), o.delete(t.id());
                  }),
                this._debouncedSave();
            }
            return o;
        ...
        _processLineToolsGroupModelChanged(e, t) {
          ...
          this._invalidateLineToolGroup(e, o),
            t &&
              (t.affectedLineTools || []).forEach((e) => this._invalidateLineToolOrStudyStub(e, o));
        }
        _processPanesCollectionChanged(e) {
          ...
          Array.from(this._allLineToolsAndStudyStubs.keys())
            ...
            .forEach((e) => {
              Array.from(
                (0, c.ensureDefined)(this._allLineToolsAndStudyStubs.get(e)).keys(),
              ).forEach((e) => {
            ...
            e
              ...
              .forEach((e) => {
                e.dataSources()
                  .filter(x)
                  .forEach((e) => this._invalidateLineToolOrStudyStub(e.id(), i));
              }),
        ...
        _processDataSourceCollectionChanged(e) {
          ...
          if (this._allLineToolsAndStudyStubs.has(e.id())) {
            const o = (0, c.ensureDefined)(this._allLineToolsAndStudyStubs.get(e.id()));
          ...
          } else (s = t), t.forEach((e) => this._invalidateLineToolOrStudyStub(e.id(), n));
          s.forEach((e) => {
            if ((0, g.isLineTool)(e)) {
        ...
        _unloadLineTools(e, t, o) {
          ...
          this._withoutInvalidating(() => {
            i.forEach((e) => {
              ...
              (null !== (t = this._allLineToolsAndStudyStubs.get(o.id())) && void 0 !== t
                ? t
                : new Map()
              ).delete(e.id());
            }),
        ...
        _unloadLinesOnSeries(e, t, o) {
          ...
          this._unloadLineTools(s, (e) => e.boundToSymbol() && e.ownerSource() === i, t);
        }
        _isAutosaveEnabled() {
          return !1;
        }
                  ...
                  return (
                    ...
                    (0, c.ensureNotNull)(this._saveChartService)
                      ...
                      .catch(async (t) => {
                        ...
                        {
                          const { SavingLineToolsLibraryError: e } = await Promise.resolve().then(
                            o.bind(o, 98653),
                          );
        ...
        async _savePromise(e, t) {
          ...
          return this._isAutosaveEnabled()
            ? null !==
                (i = null === (o = this._debouncedSave) || void 0 === o ? void 0 : o.flush()) &&
              void 0 !== i
              ? i
              : Promise.resolve()
        ...
        _onSymbolResolved(e) {
          const t = this._sharingModesToUse().map((t) => {
            const o = {
              ...
              i = this._seriesLineToolsUnloader.bind(this, o, this._mainPaneLineToolsAndStubs());
            return this._makeLoadRequestAndMerge(o, i, e.pro_name || e.ticker || e.full_name);
          });
            ...
            Promise.all(t).then(() => {
              this._withoutInvalidating(() => {
                this._chartModel
                  .dataSources()
                  .filter(g.isLineTool)
                  .filter((e) => 0 === e.sharingMode().value() && e.linkKey().value())
                  .forEach((e) => {
        ...
        async _makeLoadRequestAndMerge(e, t, o) {
          ...
          const s = this._chartModel.mainSeries(),
            n =
              null !== (i = this._currentlyLoadedSymbol.get(e.sharingMode)) && void 0 !== i
                ? i
                : "";
            ...
            .then(async (o) => {
              if (null !== o && null !== o.sources) {
                ...
                t((e) => i.has(e)),
                  ...
                  o.serverRequestId && console.log(`PROCESSED:${o.serverRequestId}`);
              }
            });
        }
          ...
          return (
            (t.groups || new Map()).forEach((t, n) => {
              ...
              if (null === t) {
                if (r) {
                  const e =
                    i && i.layoutId === this._origin.layoutId && i.chartId === this._origin.chartId;
        ...
        _createNewLineTool(e) {
          ...
          if (null !== s) {
            ...
            e.set(s.id(), s.linkKey().value()), this._allLineToolsAndStudyStubs.set(o.id(), e);
          }
          return s;
        }
        _migrateStateFromMetainfo(e) {
          ...
          const o = void 0 !== e.currencyId && e.currencyId !== e.state.state.currencyId;
        ...
        _restoreLineTool(e, t, o, i) {
          ...
          if (
            ...
            return null;
          if (this._origin.clientId === (null == i ? void 0 : i.clientId) && !n) return null;
          if (n && t.serverUpdateTime) {
            ...
            this._origin.clientId !== (null == i ? void 0 : i.clientId) &&
              (this._chartModel.restoreLineToolState(n, t.state, !1), n.calcIsActualSymbol());
          }
          0 !== o &&
          ...
          return (
            a &&
              (r && this._invalidateLineToolOrStudyStub(t.id, performance.now(), !0),
              t.serverUpdateTime && a.setServerUpdateTime(t.serverUpdateTime),
              t.state.alertId ? a.setAlert(+t.state.alertId) : a.detachAlert(),
              (0 !== o || this._doNotSaveSharedLineToolsToCharts.value()) && a.share(o)),
            a
          );
        }
        _removeLineTool(e) {
          const t = this._chartModel.dataSourceForId(e);
          null !== t && new m.RemoveSourcesUndoCommand(this._chartModel, [t], null).redo();
        }
        _restoreLineDTO(e, t, o, i, s, n) {
          if (!this._invalidatedLineToolsAndStudyStubs.get(t))
            if (null === e) {
              ...
              const o =
                n && n.layoutId === this._origin.layoutId && n.chartId === this._origin.chartId;
              (e.sharingMode().value() === s ||
                (0 === s && !this._doNotSaveSharedLineToolsToCharts.value())) &&
                (0 === s ||
                  this._doNotSaveSharedLineToolsToCharts.value() ||
                  (e.share(0), o || this._invalidateLineToolOrStudyStub(t, performance.now(), !0)),
                this._origin.clientId !== (null == n ? void 0 : n.clientId) &&
                  ((o && 0 !== s && !this._doNotSaveSharedLineToolsToCharts.value()) ||
                    (this._removeLineTool(t), this._setOriginalLineToolSharingMode(t, null))));
            } else {
              const r = this._restoreLineTool(i, e, s, n);
              if (r) {
                if (e.groupId) {
                  const t = this._chartModel.lineToolsGroupModel().groupForLineTool(r),
                    i = this._chartModel.lineToolsGroupModel().groupForId(e.groupId);
                  ...
                  if (
                    ...
                    this._chartModel.lineToolsGroupModel().createGroup([r], t.name, t.id);
                  }
                } else {
                  this._chartModel
                    .lineToolsGroupModel()
                ...
                (void 0 === i || (0 !== s && !this._doNotSaveSharedLineToolsToCharts.value())) &&
                  this._setOriginalLineToolSharingMode(t, {
                    sharingMode: s,
                    duplicatedInChart: !1,
                  });
                const n = !(!i || (i.sharingMode === s && !i.duplicatedInChart));
                (0, c.ensureDefined)(this._originalLineToolSharingMode.get(t)).duplicatedInChart =
                  n;
              }
            }
        }
        async _applyLineToolsAndGroupsDTO(e, t, o) {
          const i = this._chartModel.chartSaveTime(),
            s = this._withoutInvalidating(() => this._restoreGroups(i, e, t, o)),
        ...
        _invalidateLineToolOrStudyStub(e, t, o) {
          ...
          const s =
              null === (i = this._invalidatedLineToolsAndStudyStubs.get(e)) || void 0 === i
                ? void 0
          ...
          return (
            this._invalidatedLineToolsAndStudyStubs.forEach((n, r) => {
              ...
              const h = () => {
                ...
                this._doNotSaveSharedLineToolsToCharts.value() &&
                  0 === t &&
                  (null === (e = this._originalLineToolSharingMode.get(r)) || void 0 === e
                    ? void 0
                    : e.duplicatedInChart) &&
                  o.set(r, null);
              };
              if (null === d) {
                ((null === (a = this._originalLineToolSharingMode.get(r)) || void 0 === a
                  ? void 0
                  : a.sharingMode) === t ||
                ...
                const s = d.ownerSource() === this._chartModel.mainSeries(),
                  ...
                  a =
                    ...
                    (0 === t && !this._doNotSaveSharedLineToolsToCharts.value());
                if (n) {
                  const e = this._chartModel.lineToolsGroupModel().groupForLineTool(d);
                  if (a)
                    o.set(
                      r,
                      (function (e, t) {
                        ...
                        return (
                          ...
                          (i.currencyId = e.properties().childs().currencyId.value()),
                    ...
                    const s =
                      null === (l = this._originalLineToolSharingMode.get(r)) || void 0 === l
                        ? void 0
                        : l.sharingMode;
                    s === t && o.set(r, null), null !== e && s === t && i.set(e.id, null);
                  }
                }
        ...
        _loadAndMergeLineToolsOnStudies(e, t) {
          ...
          this._makeLoadRequestAndMerge(
            ...
            (o) => {
              const s = t
                ? u(
                    Array.from(this._allLineToolsAndStudyStubs.values()).map((e) =>
                      Array.from(e.keys()),
                    ),
                  ).filter((e) => !o(e))
                : [];
        ...
        _loadAndMergeLineToolsWithoutSymbol(e, t) {
          ...
          this._makeLoadRequestAndMerge(
            ...
            (o) => {
              ...
              this._unloadLineTools(s, (e) => !e.boundToSymbol() && e.ownerSource() === i, e);
            },
            void 0,
          );
        }
        _recalculateHasChanges() {
          const e = Array.from(this._invalidatedLineToolsAndStudyStubs.values()).some(
        ...
        _applyToolsAndGroupsDTOToNonDeserializedCharts(e, t) {
          ...
          if (
            ...
            for (const [s, n] of e.sources)
              ...
              0 !==
                U(
                  null === (o = this._originalLineToolSharingMode.get(s)) || void 0 === o
                    ? void 0
                    : o.sharingMode,
                ) &&
              0 === U(n.state.sharingMode)
                ...
                : ((null === n &&
                    0 !==
                      U(
                        null === (i = this._originalLineToolSharingMode.get(s)) || void 0 === i
                          ? void 0
                          : i.sharingMode,
                      )) ||
                    (null !== n &&
