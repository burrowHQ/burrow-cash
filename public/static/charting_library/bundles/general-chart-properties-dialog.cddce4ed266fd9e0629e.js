    ...
    22265: (e, t, a) => {
      ...
      function h(e) {
        const {
          ...
          v = d ? (null == n ? void 0 : n.active) : null == n ? void 0 : n.default;
        return i.createElement(
          h,
          {
            ..._,
            ref: u,
            className: l()(c.tab, b && c.isTablet, g && c.isMobile, d && c.active, p),
            onClick: m,
          },
    ...
    56080: (e, t, a) => {
      ...
      class H extends n.PureComponent {
        constructor(e) {
          super(e),
              ...
              if (P) {
                ...
                window.runOrSignIn(
                  () =>
                    ...
                    })(e.model().theme(), this._syncThemeList, this._handleRenameClose),
            ...
            (this._handleRenameClose = () => {
              var e;
              null === (e = this._reference.current) || void 0 === e || e.focus();
            }),
            (this.state = { themes: [] }),
            this._syncThemeList();
        }
        ...
        _getPlaceHolderItem(e) {
          return e ? n.createElement(_.Icon, { className: z.themesButtonIcon, icon: M }) : N;
        }
        _getThemeItems(e) {
          const {
      ...
      class se extends n.PureComponent {
        constructor(e) {
          ...
          super(e),
            ...
            (this._renderApplyToAllButton = () =>
              n.createElement(p.MatchMedia, { rule: R.DialogBreakpoints.TabletNormal }, (e) =>
          ...
          let s = null !== (t = l.find((e) => e.id === i)) && void 0 !== t ? t : null;
          if (!s) {
        ...
        render() {
          ...
          return n.createElement(p.MatchMedia, { rule: R.DialogBreakpoints.TabletSmall }, (r) =>
            n.createElement(o.AdaptiveConfirmDialog, {
              ...
              onForceFocus: F.PLATFORM_ACCESSIBILITY_ENABLED ? this._handleForceFocus : void 0,
        ...
        _renderTabs(e) {
          ...
          return n.createElement(p.MatchMedia, { rule: R.DialogBreakpoints.TabletNormal }, (e) =>
            n.createElement(p.MatchMedia, { rule: R.DialogBreakpoints.TabletSmall }, (t) => {
        ...
        show(e) {
          l.render(
            ...
            re.emit("edit_object_dialog", {
              ...
              scriptTitle: this._model.mainSeries().title(ce.TitleDisplayTarget.StatusLine),
            });
        }
        _ensureCheckpoint(e) {
      ...
      function d(e) {
        ...
        return r.PLATFORM_ACCESSIBILITY_ENABLED
          ? i.createElement(
              ...
              i.createElement(o.RemoveButton, { "aria-label": t, ...n, "data-tooltip": t }),
            )
