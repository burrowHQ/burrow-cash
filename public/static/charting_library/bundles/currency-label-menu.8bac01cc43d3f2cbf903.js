  ...
  [2704],
  {
    ...
    41153: (e, t, n) => {
      ...
      const S = i.memo(
        function (e) {
          ...
          return i.createElement(
            "div",
            {
              className: v()(b.action, l && b.active, E, m && b.withDescription, d && b.selected),
              onClick: C,
              ref: h,
            },
            p &&
            ...
            i.createElement(
              ...
              m && i.createElement("span", { className: v()(b.description, E) }, a ? y(a) : ""),
            ),
            void 0 !== f &&
              i.createElement(
                "div",
                { className: v()(b.action__favoriteIcon, f && b.action__favoriteIcon_active) },
      ...
      function R(e) {
        const {
          ...
          [k, w] = (0, i.useState)(() => o.reduce((e, t, n) => (t.name && (e[t.id] = !0), e), {}));
        function A(e) {
          const { id: t, ...n } = e;
                ...
                c
                  ...
                  : r.map((e, t) =>
                      i.createElement(
                        i.Fragment,
                        { key: e.id },
                        e.name && i.createElement("div", { className: M.section }, e.name),
                        e.actions.map((n, l) => {
                          const { id: u, ...h } = n,
                          ...
                          return i.createElement(
                            ...
                            !f && p && i.createElement("div", { className: M.separator }),
                          );
                        }),
                      ),
                    ),
      ...
      function U(e) {
        ...
        return i.createElement(a.MatchMedia, { rule: d.DialogBreakpoints.TabletSmall }, (e) =>
          e
      ...
      class H {
        constructor(e, t, n, i) {
          (this._rootElem = document.createElement("div")),
            ...
            this._render(),
            r.favoriteCurrencyUnitConversionService.getOnChange().subscribe(this, this._render);
        }
        _render() {
          const e = {
            title: this._title,
    ...
    36189: (e, t, n) => {
      ...
      var i = n(11542),
        ...
        c = n(48010),
        l = n(14877);
      const u = { add: i.t(null, void 0, n(44629)), remove: i.t(null, void 0, n(72482)) };
      function d(e) {
        const { className: t, isFilled: n, isActive: i, onClick: d, ...h } = e;
        return o.createElement(a.Icon, {
          ...h,
          className: r(l.favorite, "apply-common-tooltip", n && l.checked, i && l.active, t),
          icon: n ? s : c,
          onClick: d,
    ...
    19785: (e, t, n) => {
      "use strict";
      n.d(t, { createRegExpList: () => r, getHighlightedChars: () => a, rankedSearch: () => o });
      var i = n(1722);
      function o(e) {
        const {
          data: t,
          ...
          .map((e) => {
            ...
            return (
              n.forEach((e) => {
                ...
                if (
                  ((m.lastIndex = 0),
                  (0, i.isString)(t) && t && t.toLowerCase() === o.toLowerCase())
                )
                  return (
                    (h = 4), void (d = null === (n = t.match(v)) || void 0 === n ? void 0 : n.index)
                  );
                if ((0, i.isString)(t) && v.test(t))
                  return (
                    (h = 3), void (d = null === (a = t.match(v)) || void 0 === a ? void 0 : a.index)
                  );
                if ((0, i.isString)(r) && v.test(r))
                  return (
                    (h = 2), void (d = null === (s = r.match(v)) || void 0 === s ? void 0 : s.index)
                  );
                if ((0, i.isString)(r) && m.test(r))
                  return (
                    (h = 2), void (d = null === (c = r.match(m)) || void 0 === c ? void 0 : c.index)
                  );
                if (Array.isArray(u))
                  for (const e of u)
                    if (v.test(e))
                      return (
                        (h = 1),
                        void (d = null === (l = e.match(v)) || void 0 === l ? void 0 : l.index)
                      );
              }),
    ...
    24637: (e, t, n) => {
      ...
      function s(e) {
        const { queryString: t, rules: n, text: s, className: c } = e,
          l = (0, i.useMemo)(() => (0, r.getHighlightedChars)(t, s, n), [t, n, s]);
        return i.createElement(
          i.Fragment,
          null,
          l.length
            ? s
                ...
                .map((e, t) =>
                  i.createElement(
                    ...
                    { key: t },
                    l[t]
                      ? i.createElement("span", { className: o(a.highlighted, c) }, e)
    ...
    10381: (e, t, n) => {
      ...
      function c(e) {
        ...
        return i.createElement(r.Icon, { className: o(n, a.icon, { [a.dropped]: t }), icon: s });
      }
    },
    40173: (e, t, n) => {
      "use strict";
      ...
      const c = (0, i.forwardRef)(function (e, t) {
        ...
        return i.createElement(
          ...
          i.createElement(
            ...
            o,
            i.createElement(a.ToolWidgetCaret, { className: s.caret, dropped: Boolean(n) }),
          ),
          n && c,
        );
      });
    ...
    12811: (e, t, n) => {
      ...
      function l(e, t) {
        return (n) => {
          ...
          let y = null !== (l = t.verticalAttachEdge) && void 0 !== l ? l : c.verticalAttachEdge,
            x =
              null !== (u = t.verticalDropDirection) && void 0 !== u ? u : c.verticalDropDirection;
          y === i.AutoStrict &&
            (m < v.y + v.height + C + h
    ...
    84298: (e, t, n) => {
      ...
      function s(e, t, s) {
        ...
        for (const e of g) {
          ...
          p.actions.push(
            (0, r.createAction)(
              ...
              () => l(e.id),
              v.has(e.id),
              () => a.favoriteCurrencyUnitConversionService.toggle("currencies", e.id),
            ),
          );
        }
        ...
        return (
          (y.length > 0 || E.length > 0) && c.push({ id: "second_section", actions: E.concat(y) }),
          c
        );
      }
    },
    ...
    14818: (e, t, n) => {
      ...
      function s(e, t, s) {
        ...
        (C.length > 0 || E.length > 0) &&
          p.actions.push(
            ...E.sort((e, t) => e.label.toLowerCase().localeCompare(t.label.toLowerCase())),
            ...C,
          ),
          p.actions.length > 0 && c.push(p);
              ...
              n.id === u ||
                ...
                t.push(
                  (0, r.createAction)(
                    ...
                    () => l(n.id),
                    !1,
                    () => a.favoriteCurrencyUnitConversionService.toggle("units", n.id),
                  ),
                );
