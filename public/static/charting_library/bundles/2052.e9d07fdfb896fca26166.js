        ...
        return n.createElement(
          Y,
          {
            ...
            onContextMenu: function (e) {
              K && V && (0, i.trackEvent)(K.category, K.event, `${K.label}_rightClick`);
            },
            onMouseUp: function (e) {
              if (1 === e.button && x && K) {
                let e = K.label;
                q && (e += "_mouseWheelClick"), (0, i.trackEvent)(K.category, K.event, e);
              }
            },
            onMouseOver: B,
            onMouseOut: L,
          ...
          (void 0 !== f || v) &&
            n.createElement("span", { className: S.shortcut }, (X = f) && X.split("+").join(" + ")),
          void 0 !== O &&
            n.createElement(
              "span",
              {
                onClick: A ? d : void 0,
                className: r(m, S.toolbox, { [S.showOnHover]: y, [S.showOnFocus]: N }),
              },
              O,
            ),
        );
        ...
        return (
          ...
          (0, n.useLayoutEffect)(() => {
            if (a.CheckMobile.iOS())
              return (
                null !== s.current && (0, r.disableBodyScroll)(s.current, { allowTouchMove: l(s) }),
                () => {
    ...
    81261: (e, t, o) => {
      ...
      function l(e) {
        ...
        const f = p(c),
          ...
          g = -1 !== v,
          b = (e) => {
            s && (0, r.becomeSecondaryElement)(s), (0, r.becomeMainElement)(e), e.focus();
          };
        switch ((0, n.mapKeyCodeToDirection)(o)) {
          case "inlinePrev":
            if (!f.length) return;
            e.preventDefault(), b(0 === v ? l[m] : g ? d(f, v, -1) : f[f.length - 1]);
            break;
          case "inlineNext":
            if (!f.length) return;
            e.preventDefault(), v === f.length - 1 ? b(l[m]) : b(g ? d(f, v, 1) : f[0]);
            break;
          case "blockPrev": {
            e.preventDefault();
            const t = d(l, m, -1);
    ...
    12811: (e, t, o) => {
      ...
      function c(e, t) {
        return (o) => {
          ...
          let w = null !== (c = t.verticalAttachEdge) && void 0 !== c ? c : l.verticalAttachEdge,
            C =
              null !== (d = t.verticalDropDirection) && void 0 !== d ? d : l.verticalDropDirection;
          w === n.AutoStrict &&
            (p < m.y + m.height + b + h
          ...
          const {
            ...
            T =
              ...
              ("string" == typeof s
                ...
                : n.cloneElement(s, { className: r(E.icon, s.props.className) }));
          return "button" === o
            ? n.createElement(
                "button",
                {
                ...
                g && v && n.createElement("div", { className: r("js-button-text", E.text) }, v),
                T,
                !g && v && n.createElement("div", { className: r("js-button-text", E.text) }, v),
              )
            : n.createElement(
