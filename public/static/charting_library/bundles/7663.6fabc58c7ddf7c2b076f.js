(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [7663],
  {
    ...
    34392: (e, t, n) => {
      ...
      function m(e) {
        const { segment: t, forceStart: n, forceEnd: i } = e,
          ...
          o = a < 0.03,
          l = { left: 100 * t.start.value + "%", width: `calc(${100 * a}% + ${o ? 2 : 0}px)` },
          d = r(
            u.segment,
            y.get(t.type),
          ...
          c = (function (e, t) {
            return `<div class="${u.tooltip}">\n\t\t<span class="${y.get(t)}">${v.get(
              t,
            )}</span>\n\t\t<span class="${u.time}">${e}</span>\n\t</div>`;
          })(t.tooltip, t.type);
        return s.createElement("div", { className: d, style: l, "data-tooltip": c });
      }
      function D(e) {
      ...
      function h(e) {
        const { sessionDays: t, currentTimeMark: n } = e,
          i = [],
          a = parseInt(Object.keys(t).filter((e) => t[parseInt(e)].isActive)[0]),
          o = t[a],
        ...
        !l.start.isFirstOrLastPoint && l.showStartForLastEntry
          ...
          : i.push(l.start);
        const d = !l.end.isFirstOrLastPoint && l.showEndForFirstEntry ? o.entries[0].end : l.end;
        if ((i[0].value !== d.value && i.push(d), 0 === i.length)) return null;
        i.sort((e, t) => e.value - t.value);
        const y = i.map((e) =>
            s.createElement("div", { key: c(e), className: u.timeMark }, e.title),
          ),
        ...
        return s.createElement(
          ...
          s.createElement(
            ...
            s.createElement(
              "div",
              { className: f, style: { left: 100 * i[0].value + "%", width: `${v}%` } },
              y,
            ),
          ),
        );
          ...
          s.createElement(
            ...
            l
              ? s.createElement(
                  s.Fragment,
                  null,
                  Object.values(c).map((e, t) => s.createElement(D, { key: t, sessionDay: e })),
                )
              : s.createElement(D, { sessionDay: y }),
            s.createElement(
              "div",
              { className: u.nowWrapper },
              s.createElement("div", { className: u.now, style: { left: 100 * i + "%" } }),
            ),
          ),
    ...
    76413: (e, t, n) => {
      ...
      function A(e) {
        for (
          (0, c.assert)(Number.isInteger(e), "timeMinutes expected to be integer number");
          e > i.minutesPerDay;
      ...
      function L(e, t, n, s = t) {
        const r = n(t),
          i = e[r];
        return r !== s && 0 === i.entries.length ? L(e, r, n, s) : _(r, e[r].entries);
      }
      function N(e) {
        return (t, n) => L(t, n, e);
      }
      const I = N(h),
        Y = N(k);
      function b(e, t, n, s) {
        return (r, i, a) => (void 0 === r ? [s, a] : r === e ? [t, n(i)] : [r, i]);
      }
      const T = b(1, 0, k, 0),
        U = b(0, 1, h, 1);
      ...
      function F(e, t, n, s, r) {
        var i, a;
        return R(
          null === (i = null == e ? void 0 : e.end) || void 0 === i ? void 0 : i.value,
          t,
          null === (a = null == n ? void 0 : n.start) || void 0 === a ? void 0 : a.value,
          s,
          r,
        );
      }
      ...
      function V(e, t) {
        var n, s;
        const i = { thisDay: _(e, t[e].entries), prevDay: I(t, e), nextDay: Y(t, e) };
        return null !==
          (s =
            null !==
              (n = (function ({ thisDay: e, prevDay: t, nextDay: n }) {
          ...
          ? s
          : (function (e) {
              return [...$(e.thisDay, e.prevDay), ...O(e.thisDay), ...B(e.thisDay, e.nextDay)];
            })(i);
      }
      function C(e, t, n, s) {
        const [r, i] = e[t],
      ...
      function z(e, t, n, s) {
        ...
        const y = (function (e, t) {
            ...
            return M(t, n, s === i.minutesPerDay ? t : m(t, Math.floor(o(n + r))), s);
          })(l, r),
          v = [];
      ...
      var H = n(57333);
      const J = (0, n(5849).default)(f.map((e) => [e, { title: E[e], isActive: !1, entries: [] }]));
      function j(e) {
        return (t, n) => {
          return (
      ...
      function X(e, t) {
        return (
          e.type === t.type &&
          (3 === e.type || t.end.value - t.start.value + e.end.value - e.start.value <= 1)
        );
      }
      function ee(e, t) {
        var n;
        ...
        const r = (function (e) {
            ...
            if (void 0 === e.subsessions)
              return new Map([
                [0, new H.SessionSpec(e.timezone, e.session, e.session_holidays, e.corrections)],
              ]);
            const t = "regular",
              n = "premarket",
              s = "postmarket",
        ...
        for (const e of Array.from(r.keys())) {
          Q(
            i,
            (0, c.ensureDefined)(r.get(e)).getEntriesForWeekByCalendar((0, c.ensureNotNull)(t)),
            e,
          );
        }
        return (
          ...
          (function (e) {
            for (const t of f) {
              ...
              a.start.isFirstOrLastPoint || (a.showStartForLastEntry = G(n, e[s].entries)),
                i.end.isFirstOrLastPoint || (i.showEndForFirstEntry = Z(n, e[r].entries));
            }
          })(i),
      ...
      class te {
        constructor(e) {
          (this.sessionsDays = new a.WatchedValue((0, r.clone)(J))),
            (this.todaySession = new a.WatchedValue((0, r.clone)({ entries: [] }))),
        ...
        _updateEntriesBySubSessions(e) {
          ...
          const { newSessionsDays: t, newTodaySession: n } = ee(e, this._todayInExchangeTime);
