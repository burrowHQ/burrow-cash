(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [7550],
  {
    ...
    94720: (e, t, n) => {
      ...
      function u(e) {
        ...
        return r(
          ...
          l()[`variant-${s}`],
          i && l().stretch,
          (a || u) && l()["with-start-icon"],
          d && l()["with-end-icon"],
          h && l()["icon-only"],
          _,
          m && l().grouped,
          m && !g && l()["adjust-position"],
          m && f.isTop && l()["first-row"],
      ...
      function d(e) {
        ...
        return s.createElement(
          s.Fragment,
          null,
          p && s.createElement(i.Icon, { icon: p, className: l()["start-icon-wrap"] }),
          a && s.createElement("span", { className: l().content }, a),
          u && !o && s.createElement(i.Icon, { icon: u, className: l()["end-icon-wrap"] }),
          m &&
            (function (e) {
              return (
                e.primaryText &&
                ...
                s.createElement(
                  ...
                  "string" == typeof e.secondaryText
                    ...
                    : s.createElement(
                        "span",
                        { className: l()["secondary-text"] },
                        s.createElement("span", null, e.secondaryText.firstLine),
                        s.createElement("span", null, e.secondaryText.secondLine),
                      ),
                )
              );
            })(e),
      ...
      function g(e) {
        const { reference: t, tooltipText: n, ...r } = e,
          ...
          } = (0, s.useContext)(p.ControlGroupContext),
          l = u({ ...r, isGrouped: o, cellState: i, disablePositionAdjustment: a });
        return s.createElement(
          "button",
          {
            ...f(r),
      ...
      function _(e) {
        const { intent: t, size: n, appearance: s, useFullWidth: r, icon: o, ...i } = e;
        return { ...i, color: y(t), size: w(n), variant: v(s), stretch: r, startIcon: o };
      }
      function b(e) {
        return s.createElement(g, { ..._(e) });
      }
    },
    86332: (e, t, n) => {
      "use strict";
      n.d(t, { ControlGroupContext: () => s });
      const s = n(50959).createContext({
        isGrouped: !1,
    ...
    95604: (e, t, n) => {
      ...
      n.d(t, { getGroupCellRemoveRoundBorders: () => s });
    },
    67029: (e, t, n) => {
      "use strict";
      ...
      function p(e, t, n, s) {
        const {
          ...
          w = h(null != o ? o : (0, c.getGroupCellRemoveRoundBorders)(n));
        return r(
          d().container,
          d()[`container-${u}`],
          d()[`intent-${a}`],
      ...
      function m(e, t, n) {
        ...
        if (!s) return d().highlight;
        const i = h(null != o ? o : (0, c.getGroupCellRemoveRoundBorders)(t));
        return r(d().highlight, d().shown, d()[`size-${n}`], i);
      }
      const f = {
      ...
      function v(e, t) {
        const {
          ...
          k = (function (e, t = null, n) {
            ...
            return (0, s.useEffect)(() => ((o.current = [e, t, n]), i(), a), [e, t, n]), l;
          })("wheel", R, g);
        return s.createElement(
          "span",
          {
          ...
          x,
          C,
          s.createElement("span", { className: m(e, S, E) }),
        );
      }
      v.displayName = "ControlSkeleton";
      const y = s.forwardRef(v);
    },
    78274: (e, t, n) => {
      "use strict";
      n.d(t, { AfterSlot: () => u, EndSlot: () => c, MiddleSlot: () => l, StartSlot: () => a });
      var s = n(50959),
        r = n(97754),
        o = n(7236),
        i = n.n(o);
      function a(e) {
        const { className: t, interactive: n = !0, icon: o = !1, children: a } = e;
        return s.createElement(
          "span",
          { className: r(i()["inner-slot"], n && i().interactive, o && i().icon, t) },
          a,
        );
      }
      function l(e) {
      ...
      function u(e) {
        const { className: t, children: n } = e;
        return s.createElement("span", { className: r(i()["after-slot"], t) }, n);
      }
    },
    31261: (e, t, n) => {
      "use strict";
      ...
      function v(e) {
        const {
          ...
          H = (0, o.filterProps)(q, g),
          K = {
            ...(0, o.filterAriaProps)(q),
            ...(0, o.filterDataProps)(q),
            id: t,
            title: n,
            role: i,
            tabIndex: a,
      ...
      function y(e) {
        ...
        const {
          ...
          _ = t ? void 0 : y ? -1 : r,
          b = t ? void 0 : y ? r : -1,
          { isMouseDown: x, handleMouseDown: C, handleMouseUp: D } = (0, d.useIsMouseDown)(),
          R = (0, i.createSafeMulticastEventHandler)(
            w.onFocus,
            function (e) {
              n && !x.current && (0, a.selectAllContent)(e.currentTarget);
            },
            o,
          ),
          E = (0, i.createSafeMulticastEventHandler)(w.onBlur, h),
          P = (0, s.useCallback)(
            (e) => {
              (f.current = e),
    ...
    48027: (e, t, n) => {
      ...
      var s = n(47201),
        r = n(29202);
      function o(e) {
        const { onFocus: t, onBlur: n, intent: o, highlight: i, disabled: a } = e,
          [l, c] = (0, r.useFocus)(void 0, a),
          u = (0, s.createSafeMulticastEventHandler)(a ? void 0 : c.onFocus, t),
          d = (0, s.createSafeMulticastEventHandler)(a ? void 0 : c.onBlur, n);
        return {
          ...e,
      ...
      function o(e) {
        ...
        return (
          (0, s.useLayoutEffect)(() => {
            ...
            return (0, r.addOutsideEventListener)(d.current, s, a, c, e);
          }, [t, n, o, i, a]),
          l || u
        );
      }
    ...
    9745: (e, t, n) => {
      ...
      const r = s.forwardRef((e, t) => {
        const { icon: n = "", ...r } = e;
        return s.createElement("span", { ...r, ref: t, dangerouslySetInnerHTML: { __html: n } });
      });
    },
    26996: (e, t, n) => {
      "use strict";
      ...
      var s = n(50959),
        ...
        i = n.n(o);
      function a(e) {
        const { className: t, size: n = "medium", staticPosition: o, color: a = "black" } = e,
          l = r(i().item, i()[a], i()[n]);
        return s.createElement(
          "span",
      ...
      const s = (() => {
        ...
        return () => {
          ...
          if (void 0 === e) {
            ...
            null === (t = n.parentNode) || void 0 === t || t.removeChild(n), (e = r - i);
          }
          return e;
        };
      })();
      ...
      function c(e) {
        ...
        if (e && 1 == ++a) {
          ...
          "hidden" !== e.toLowerCase() &&
            ...
            (r(n, "right", `${s()}px`), (t.style.paddingRight = `${a + s()}px`), (l = !0)),
      ...
      class m extends o.PureComponent {
        constructor(e) {
          if (
            ...
            (this._handleChange = (e) => {
              ...
              if (t && "" === i)
                ...
                this.setState({
                  queryValue: i,
                  isOpened: t,
                  active: n ? void 0 : this._getActiveKeyByValue(i),
                }),
                  t && r && r();
              }
              n && s && s(i);
              ...
              switch (e.which) {
                ...
                case s.UpArrow:
                  ...
                  if (void 0 === i) {
                    ...
                    d = 0;
                  } else d = u.indexOf(i) + (e.which === s.UpArrow ? -1 : 1);
                ...
                case s.Enter:
                  let m = i;
                  t && (a && m ? this.setState(this._valueToQuery(m)) : (m = l)),
                    void 0 !== m &&
                      (this._close(),
                      a || this._blur(),
                      m !== n ? r && r(m) : this.setState(this._valueToQuery(m)));
              }
            }),
            ...
            (this._scrollIfNotVisible = (e, t) => {
              const n = t.scrollTop,
                ...
                r = e.offsetTop,
                o = r + e.clientHeight;
              r <= n ? e.scrollIntoView(!0) : o >= s && e.scrollIntoView(!1);
            }),
          ...
          this.state = {
            ...
            isOpened: !1,
            active: e.value,
            queryValue: f(e.source)[e.value] || (e.allowUserDefinedValues ? e.value : ""),
          };
        }
        componentDidMount() {
        ...
        render() {
          return o.createElement(
            ...
            (e) =>
              o.createElement(
                "div",
                { className: i(h.autocomplete, "js-dialog-skip-escape"), ref: e },
                o.createElement(c.InputControl, {
                  id: this.props.id,
                  ...
                  endSlot: Object.keys(this._suggestions(this.state.queryValue)).length
                    ? o.createElement(
                        ...
                        o.createElement(
                          "span",
                          { className: h.caret, onClick: this._handleCaretClick, tabIndex: -1 },
        ...
        static getDerivedStateFromProps(e, t) {
          const { allowUserDefinedValues: n, value: s, source: r } = e;
          if (s === t.valueFromProps && t.isOpened) return null;
          const o = n ? s : "" === s ? "" : f(r)[s] || t.queryValue;
          return { ...t, valueFromProps: s, active: s, queryValue: o };
        }
        _renderSuggestions() {
        ...
        _renderPortalSuggestions() {
          return o.createElement(d.Portal, null, this._renderSuggestionsItems());
        }
        _focus() {
        ...
        _renderSuggestionsItems() {
          const e = this._suggestions(this.state.queryValue),
            t = Object.keys(e).map((t) => {
              const n = i(h.suggestion, this.state.active === t && h.selected);
              return o.createElement(
                "li",
            ...
            s = o.createElement("li", { className: h.noResults }, r.t(null, void 0, n(56614)));
        ...
        _getActiveKeyByValue(e) {
          const { filter: t = p } = this.props,
            ...
            s = Object.keys(n);
          for (const r of s) if (t(e, n[r])) return r;
          return s[0];
        }
        _valueToQuery(e) {
      ...
      class l extends s.PureComponent {
        ...
        render() {
          ...
          return (
            ...
            r.createPortal(s.createElement(c.Provider, { value: this }, this.props.children), e)
          );
        }
        moveToTop() {
    ...
    10381: (e, t, n) => {
      ...
      function l(e) {
        ...
        return s.createElement(o.Icon, { className: r(n, i.icon, { [i.dropped]: t }), icon: a });
      }
    },
    578: (e) => {
      e.exports =
