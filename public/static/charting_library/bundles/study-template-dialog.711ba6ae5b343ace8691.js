(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [6631],
  {
        ...
        constructor() {
          super(...arguments),
            ...
            (this._handleKeyDown = (e) => {
              ...
              13 === (0, m.hashFromEvent)(e) && n && (e.preventDefault(), a || t());
            });
        }
        render() {
          const {
    ...
    13932: (e, t, a) => {
      ...
      class v extends l.PureComponent {
        ...
        render() {
          ...
          return l.createElement(u.AdaptiveConfirmDialog, {
            ...
            submitButtonText: l.createElement(b, { isLoading: this.state.isLoading }),
        ...
        return (
          ...
          l.createElement(
            ...
            l.createElement(
              ...
              l.createElement(
                ...
                l.createElement(r.Checkbox, {
                  label: l.createElement(
                    ...
                    C,
                    l.createElement(c.Icon, { icon: S, className: o(k), title: a }),
                  ),
                  onChange: function () {
              ...
              l.createElement(
                ...
                l.createElement(r.Checkbox, {
                  label: l.createElement(
                    ...
                    { className: _.hintLabel },
                    N,
                    l.createElement(c.Icon, { icon: S, className: o(k), title: i }),
                  ),
                  onChange: function () {
              ...
              l.createElement("div", { className: o(_.indicators, D && _.withSuggestions) }, s),
            ),
          )
        );
      }
      ...
      class D {
        constructor(e) {
          (this._container = document.createElement("div")),
            ...
            (this.unmount = () => {
              I.unsubscribe(T.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this.unmount, null),
      ...
      function G(e, t, a) {
        const n = () => {
          E.backend.invalidateStudyTemplatesList(), E.backend.getStudyTemplatesList().then(t);
        };
      ...
      class A {
        ...
        _prepareData(e, t, a) {
          ...
          return {
            ...
            meta_info: (0, z.createStudyTemplateMetaInfo)(this._controller, n.interval),
          };
        }
        _doSave(e, t, a) {
        ...
        _getActualTemplateList() {
          return E.backend.invalidateStudyTemplatesList(), E.backend.getStudyTemplatesList();
        }
        _showTemplateSaveRenameDialog(e, t, a) {
          ...
          (this._dialog = new D({
            ...
            saveIntervalHintText: R.format({ interval: (0, B.translatedIntervalString)(a) }),
