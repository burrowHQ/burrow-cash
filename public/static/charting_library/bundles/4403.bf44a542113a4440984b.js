(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [4403],
  {
    ...
    94720: (e, t, n) => {
      ...
      function u(e) {
        const {
          ...
          })((0, l.getGroupCellRemoveRoundBorders)(p));
        return r(
          m,
          a().button,
          a()[`size-${n}`],
          ...
          a()[`variant-${o}`],
          s && a().stretch,
          (i || u) && a()["with-start-icon"],
          d && a()["with-end-icon"],
          h && a()["icon-only"],
          v,
          f && a().grouped,
          f && !b && a()["adjust-position"],
          f && p.isTop && a()["first-row"],
          f && p.isLeft && a()["first-col"],
          g && C && a()["multiline-content"],
          R && a().link,
          c,
        );
      }
      function d(e) {
        ...
        return o.createElement(
          o.Fragment,
          null,
          m && o.createElement(s.Icon, { icon: m, className: a()["start-icon-wrap"] }),
          i && o.createElement("span", { className: a().content }, i),
          u && !l && o.createElement(s.Icon, { icon: u, className: a()["end-icon-wrap"] }),
          f &&
            (function (e) {
              return (
                e.primaryText &&
      ...
      function p(e) {
        ...
        return { ...m, ...(0, f.filterDataProps)(e), ...(0, f.filterAriaProps)(e) };
      }
      function b(e) {
        const { reference: t, tooltipText: n, ...r } = e,
          ...
          a = u({ ...r, isGrouped: l, cellState: s, disablePositionAdjustment: i });
        return o.createElement(
          "button",
          {
            ...p(r),
      ...
      function v(e) {
        const { intent: t, size: n, appearance: o, useFullWidth: r, icon: l, ...s } = e;
        return { ...s, color: C(t), size: R(n), variant: g(o), stretch: r, startIcon: l };
      }
      function y(e) {
        return o.createElement(b, { ...v(e) });
      }
    },
    95604: (e, t, n) => {
      "use strict";
    ...
    67029: (e, t, n) => {
      "use strict";
      n.d(t, { ControlSkeleton: () => C, InputClasses: () => p });
      var o = n(50959),
        r = n(97754),
        l = n(50151),
        s = n(38528),
      ...
      function m(e, t, n, o) {
        const {
          ...
          R = h(null != l ? l : (0, c.getGroupCellRemoveRoundBorders)(n));
        return r(
          d().container,
          d()[`container-${u}`],
          d()[`intent-${i}`],
      ...
      function f(e, t, n) {
        const { highlight: o, highlightRemoveRoundBorder: l } = e;
        if (!o) return d().highlight;
        const s = h(null != l ? l : (0, c.getGroupCellRemoveRoundBorders)(t));
      ...
      function g(e, t) {
        const {
          ...
          Z = (function (e, t = null, n) {
            ...
            return (0, o.useEffect)(() => ((l.current = [e, t, n]), s(), i), [e, t, n]), a;
          })("wheel", S, b);
        return o.createElement(
          "span",
          {
          ...
          x,
          D,
          o.createElement("span", { className: f(e, B, w) }),
        );
      }
    ...
    78274: (e, t, n) => {
      "use strict";
      n.d(t, { AfterSlot: () => u, EndSlot: () => c, MiddleSlot: () => a, StartSlot: () => i });
      var o = n(50959),
        r = n(97754),
        l = n(7236),
        s = n.n(l);
      function i(e) {
        const { className: t, interactive: n = !0, icon: l = !1, children: i } = e;
        return o.createElement(
          "span",
          { className: r(s()["inner-slot"], n && s().interactive, l && s().icon, t) },
          i,
        );
      }
      function a(e) {
    ...
    31261: (e, t, n) => {
      ...
      function g(e) {
        const {
          ...
          G = (0, l.filterProps)(U, b),
          V = {
            ...(0, l.filterAriaProps)(U),
            ...(0, l.filterDataProps)(U),
            id: t,
            title: n,
            role: s,
            tabIndex: i,
      ...
      function C(e) {
        ...
        const {
          ...
          v = t ? void 0 : C ? -1 : r,
          y = t ? void 0 : C ? r : -1,
          { isMouseDown: x, handleMouseDown: D, handleMouseUp: P } = (0, d.useIsMouseDown)(),
          S = (0, s.createSafeMulticastEventHandler)(
            R.onFocus,
            function (e) {
          ...
          w = (0, s.createSafeMulticastEventHandler)(R.onBlur, h),
          N = (0, o.useCallback)(
            (e) => {
              (p.current = e),
      ...
      function s(e, t, n = l, r) {
        return (0, o.useCallback)(
          (o) => {
            ...
            const l = e.map((e) => ("function" == typeof e ? e() : e));
            return !(!n(o) || !l.includes(o)) && (t(o), !0);
          },
          [...e, t, n],
        );
      }
    ...
    48027: (e, t, n) => {
      ...
      var o = n(47201),
        r = n(29202);
      function l(e) {
        const { onFocus: t, onBlur: n, intent: l, highlight: s, disabled: i } = e,
    ...
    7953: (e, t, n) => {
      ...
      function c(e) {
        const {
          ...
          x = (0, o.useRef)(null),
          D = (0, o.useCallback)(() => (0, r.ensureNotNull)(x.current).focus(), [x]),
          P = (0, o.useCallback)(() => p(!0), [p]),
          S = (0, o.useCallback)(
            (e = !1, t = !1) => {
              p(!1);
              const { activeElement: n } = document;
              (n && (0, l.isTextEditingField)(n)) || t || y({ preventScroll: e });
            },
            [p, y],
          ),
          w = (0, o.useCallback)(() => {
          ...
          E = (0, i.createSafeMulticastEventHandler)(...B),
          k = (0, i.createSafeMulticastEventHandler)(...z);
        return {
          listboxId: R,
          isOpened: f,
          isFocused: C,
          ...
          toggle: w,
          onOpen: D,
          buttonFocusBindings: { onFocus: Z, onBlur: E },
          onButtonClick: k,
          buttonRef: v,
          listboxRef: x,
          buttonAria: { "aria-controls": f ? R : void 0, "aria-expanded": f, "aria-disabled": c },
        };
      }
    },
    29202: (e, t, n) => {
    ...
    36762: (e, t, n) => {
      "use strict";
      n.d(t, { useItemsKeyboardNavigation: () => s });
      var o = n(50959),
        r = n(66686);
      function l(e, t) {
        return e >= 0 ? e % t : (t - (Math.abs(e) % t)) % t;
      }
      function s(e, t, n, s, i, a, c = {}, u) {
        const d = (0, o.useCallback)(
            (e) => {
              const t = n.findIndex(s);
              if (t === n.length - 1 && !a)
                return void ((null == u ? void 0 : u.onFailNext) && u.onFailNext(e));
              const o = l(t + 1, n.length);
              i && i(n[o], "next");
            },
            [n, s, i, a],
          ),
          h = (0, o.useCallback)(
            (e) => {
              const t = n.findIndex(s);
              if (0 === t && !a)
                return void ((null == u ? void 0 : u.onFailPrev) && u.onFailPrev(e));
              const o = l(t - 1, n.length);
              i && i(n[o], "previous");
            },
            [n, s, i, a],
          ...
          { next: b = p.next, previous: g = p.previous, first: C = p.first, last: R = p.last } = c;
        return (0, r.useComposedKeyboardActionHandlers)(
          (0, r.useKeyboardActionHandler)(b, d, () => !0, e),
          (0, r.useKeyboardActionHandler)(g, h, () => !0, e),
          (0, r.useKeyboardActionHandler)(C, m, () => !0, e),
          (0, r.useKeyboardActionHandler)(R, f, () => !0, e),
        );
      }
    },
    16921: (e, t, n) => {
      ...
      function c(e, t, n, o, r, s) {
        ...
        if (
          ...
          const t = (function (e, t, n, o = 0) {
              const r = i[e],
                l = t[r.start] + Math.floor(t[r.size] / 2),
                s = n[r.start] + Math.floor(n[r.size] / 2);
              return {
        ...
        return (function (e) {
          ...
          return (
            (p = window.requestAnimationFrame(function e(t) {
              let l;
              if ((f ? (l = t - f) : ((l = 0), (f = t)), l >= n))
                return (i[h] = m + d), void (r && r());
              const s = m + d * o(l / n);
              (i[h] = Math.floor(s)), (p = window.requestAnimationFrame(e));
            })),
            function () {
      ...
      function d(e = {}) {
        const { activeItem: t, getKey: n, ...l } = e,
          s = (0, o.useRef)(null),
          ...
          m = (0, o.useCallback)(
            (e, t) => {
              ...
              const o = n ? n(e) : e,
                l = i.current.get(o);
              l && (c(), (0, r.ensureNotNull)(a.current).scrollTo(l, t));
            },
            [i, a, n],
          );
        return (0, o.useEffect)(() => m(t, l), [m, t]), [d, h, m];
      }
    },
    38528: (e, t, n) => {
      "use strict";
      n.d(t, { useMergedRefs: () => l });
      var o = n(50959),
        r = n(53017);
      function l(e) {
    ...
    22064: (e, t, n) => {
      ...
      function a(...e) {
        const t = e.map(l).filter(r).filter(s).map(i);
                ...
                o.createElement(
                  ...
                  f &&
                    o.createElement(
                      ...
                      null != m ? m : a.t(null, void 0, n(20036)),
                    ),
                  o.createElement(
                    "span",
    ...
    4523: (e, t, n) => {
      ...
      function u(e) {
        const {
            ...
            popupPositionCorrection: D = { x: 0, y: 0 },
            popupPosition: P,
          } = e,
          S = i(l, d, D),
          w = x ? c : 0;
