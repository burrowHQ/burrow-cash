(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [3263],
  {
    ...
    64530: (n, o, e) => {
      ...
      function u(n) {
        const { url: o, ...e } = n;
        return o ? s.createElement("a", { ...e, href: o }) : s.createElement("div", { ...e });
      }
      var d = e(12228);
      function m(n) {
        const {
        ...
        return s.createElement(
          ...
          {
            ...p,
            className: a()(d.itemRow, y && !w && d.active, h && d.mobile, w && d.selected),
          ...
          v &&
            ...
            s.createElement(l.FavoriteButton, {
              className: a()(d.favoriteButton, C && d.favorite, i.CheckMobile.any() && d.mobile),
              isActive: y && !w,
              isFilled: C,
    ...
    23263: (n, o, e) => {
      ...
      function p(n) {
        ...
        return { ...u, ...(0, w.filterDataProps)(n), ...(0, w.filterAriaProps)(n) };
      }
      function f(n) {
        const { reference: o, children: e, iconOnly: t, startIcon: i, endIcon: l, ...r } = n,
          u = (function (n, o) {
            const {
                className: e,
                color: s = "brand",
        ...
        return s.createElement(
          ...
          i && s.createElement(a.Icon, { className: y()(v().icon, v().startIcon), icon: i }),
          !(0, C.isIconOnly)(e, t) && s.createElement("span", { className: v().content }, e),
          l && s.createElement(a.Icon, { className: y()(v().icon, v().endIcon), icon: l }),
        );
      }
      e(21593);
      function k(n, o) {
      ...
      const N = s.forwardRef((n, o) => {
        const { tabs: e, size: t = "xsmall", variant: a = "primary", theme: i = _() } = n;
        return s.createElement(
          "div",
      ...
      i.t(null, void 0, e(87871)), i.t(null, void 0, e(10538)), i.t(null, void 0, e(74860));
      var j = e(29540),
        D = e(28355);
      ...
      function B(n) {
        ...
        return (
          s.useEffect(() => {
            ...
            return (
              n.withModel(null, () => {
                (o = n.model()), e(o), s(), o.mainSeries().symbolResolved().subscribe(null, s);
              }),
              () => {
                null == o || o.mainSeries().symbolResolved().unsubscribe(null, s), e(null);
              }
            );
          }, [n]),
          s.useEffect(() => {
            ...
            if (null !== u && null !== d) {
              ...
              if (null === s)
                for (
                  s = 2;
                  s > 0 &&
                  !(((null === (n = d[s].get(u)) || void 0 === n ? void 0 : n.size) || 0) > 0);
              ...
              s.createElement(
                ...
                `${
                  ...
                  i
                    ...
                    .format({ symbolsCount: f.toString() }))
                } ${((n) =>
                  i
                    .t(
                      null,
                    ...
                    .format({ drawingsCount: n.toString() }))(v)}`,
              ),
            0 === h.length
              ? null === d
              ...
              : h.map(({ symbol: n, drawingsCount: e, onRemove: t, onClick: a }) =>
