(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [6780],
  {
    ...
    50945: (e, t, i) => {
      ...
      class p extends a.PureComponent {
        ...
        _getPlaceHolderItem(e) {
          return e
            ? a.createElement(r.Icon, { className: u.defaultsButtonIcon, icon: d })
            : h.defaults;
        }
      }
    },
    48531: (e, t, i) => {
      ...
      function u(e) {
        return a.createElement(o.MatchMedia, { rule: "screen and (max-width: 768px)" }, (t) =>
          a.createElement(
            r.ControlDisclosure,
            {
      ...
      function g(e) {
        ...
        return a.createElement(
          ...
          a.createElement(h.PopupMenuItem, {
            ...
            onClick: o,
            toolbox:
              i && a.createElement(p.RemoveButton, { hidden: !_.mobiletouch && !n, onClick: c }),
          }),
        );
      }
      function f(e) {
          ...
          a.createElement(
            ...
            t &&
              a.createElement(
                ...
                t.definitions
                  .value()
                  .map((e) => a.createElement(l.Section, { key: e.id, definition: e })),
              ),
          ),
        );
      }
      ...
      class E extends a.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._getTranslatedStringForSource = (e) =>
              new z.TranslatedString(e.name(), e.title(g.TitleDisplayTarget.StatusLine))),
            (this._setTitle = (e) => {
            ...
            (this._renderFooterLeft = () => {
              ...
              return (0, f.isLineTool)(e)
                ? a.createElement(p.FooterMenu, { sources: [e], chartUndoModel: t })
                : a.createElement(
                    y.MatchMedia,
          ...
          (this.state = { activePageId: i, tableKey: Date.now(), isRenaming: !1 }),
        ...
        render() {
          ...
          const { onCancel: t, source: i } = this.props,
            ...
            r =
              (null === (e = i.properties().title) || void 0 === e ? void 0 : e.value()) ||
              i.title(g.TitleDisplayTarget.StatusLine),
        ...
        _renderChildren(e) {
          return ({ requestResize: t }) => {
            ...
            const { pages: i, source: s } = this.props,
              ...
              o = i.map(({ title: e, id: t }) => ({ label: e, id: t, dataId: `${r}-${t}` }));
            return a.createElement(
              a.Fragment,
              null,
    ...
    68495: (e, t, i) => {
      ...
      var a = i(50959),
        ...
        u = i(53018);
      function h(e) {
        const { isRenaming: t, onChangeMode: i, setTitle: h, defaultTitle: p, canBeRenamed: m } = e,
          _ = (0, a.useRef)(null),
          [g, f] = (0, a.useState)(p),
          [b, v] = (0, a.useState)(p);
        return (
            ...
            a.createElement(
              ...
              m &&
                a.createElement(
                  ...
                  a.createElement("div", { className: s(u.empty, !t && u.hideEmpty) }),
                ),
            ),
            m &&
              a.createElement(
      ...
      function g(e) {
        const {
          ...
          k = !!(
            ...
            f.every((e) => {
              ...
              return (
                (null == S ? void 0 : S.id) ===
                (null === (t = b.model().lineToolsGroupModel().groupForLineTool(e)) || void 0 === t
                  ? void 0
                  : t.id)
              );
            })
        ...
        return a.createElement(l.AdaptiveConfirmDialog, {
          ...
          footerLeftRenderer: function () {
            return a.createElement(c.FooterMenu, { sources: f, chartUndoModel: b });
          },
          render: function () {
            ...
            return a.createElement(
              ...
              a.createElement(
                ...
                null,
                a.createElement(d.PropertiesEditorTab, { page: e, tableKey: y }),
              ),
            );
          },
          submitOnEnterKey: !1,
