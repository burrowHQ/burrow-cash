  ...
  [6265],
  {
    ...
    63374: (e, t, l) => {
        ...
        constructor(e) {
          ...
          super(e),
            ...
            (this._renderFooterLeft = (e) => {
              ...
              if ((0, w.isLineTool)(t))
                return r.createElement(f.FooterMenu, { sources: [t], chartUndoModel: l });
              if ((0, g.isStudy)(t))
          ...
          const { pages: l, initialActiveTab: n } = this.props,
            o = null !== (t = l.find((e) => e.id === n)) && void 0 !== t ? t : l[0];
            ...
            return r.createElement(
              ...
              r.createElement(
                ...
                "Component" in s
                  ...
                  : r.createElement(b.PropertiesEditorTab, { page: a, tableKey: s.id }),
              ),
            );
          };
        }
      ...
      var k = l(22064),
        ...
        D = l(4781),
        R = l(17948);
      const V = new s.TranslatedString("change visibility", i.t(null, void 0, l(21511)));
      ...
      const K = {
        ...
        $ = Object.values(K)
          ...
          .map((e) => ({
            ...
            content: r.createElement(A.DropItem, { icon: e.icon, label: e.label }),
          })),
      ...
      var ee = l(41552),
        te = l(62433);
      const le = new s.TranslatedString("change plot type", i.t(null, void 0, l(15683))),
              ...
              r.createElement(
                ...
                r.createElement(
                  ...
                  a
                    ...
                    : r.createElement(M, { id: m, title: h, visible: s.visible }),
                ),
              ),
            ie(m, l, n, s, v, p),
      ...
      class pe extends r.PureComponent {
        ...
        render() {
          ...
          return r.createElement(M, { id: e, title: t, disabled: l, visible: this._visible });
        }
        componentWillUnmount() {
          this._visible.destroy();
        }
      ...
      var de = l(50890);
      const ue = new s.TranslatedString("change plot type", i.t(null, void 0, l(15683))),
      ...
      class ye extends r.PureComponent {
        render() {
          ...
          return r.createElement(
            B.InputRow,
            {
              label: c ? r.createElement(M, { id: e, title: l, visible: n, disabled: u }) : l,
              offset: p,
              grouped: d,
            },
            t
            ...
            r.createElement(
              ...
              r.createElement(
                ...
                r.createElement(
                  ...
                  r.createElement(pe, { id: e, title: Ze((0, o.ensureNotNull)(a), e), display: s }),
                ),
              ),
              !t &&
                r.createElement(
      ...
      const Ie = new s.TranslatedString("change char", i.t(null, void 0, l(98491))),
      ...
      class De extends r.PureComponent {
        ...
        render() {
          ...
          return r.createElement(
            B.InputRow,
            { grouped: a, label: r.createElement(pe, { id: t, title: l, display: h }) },
            !a &&
              !i &&
              r.createElement(ee.ColorWithThicknessSelect, {
                disabled: 0 === h.value(),
      ...
      Object.keys(Re.plotShapesData).forEach((e) => {
        ...
        Be.push({
          ...
          content: r.createElement(A.DropItem, { icon: Me(t.icon), label: t.guiName }),
        });
      });
      ...
      const We = new s.TranslatedString("change shape", i.t(null, void 0, l(86888))),
      ...
      class ze extends r.PureComponent {
        ...
        render() {
          const { id: e, title: t, isRGB: l, hasPalette: n, property: o } = this.props,
            { color: i, transparency: s, plottype: a, location: c, display: p } = o.childs();
          return r.createElement(
            B.InputRow,
            { grouped: n, label: r.createElement(pe, { id: e, title: t, display: p }) },
            !n &&
              !l &&
              r.createElement(ee.ColorWithThicknessSelect, {
                disabled: 0 === p.value(),
        ...
        render() {
          ...
          if ((0, x.isOhlcPlot)(n)) {
            const e = n.target,
              ...
              l = (0, o.ensureDefined)((0, o.ensureDefined)(s.metaInfo().ohlcPlots)[e]),
      ...
      var Ye = l(47510),
        qe = l(53598);
      const Ke = new s.TranslatedString("change line style", i.t(null, void 0, l(28691)));
      ...
      const Xe = new s.TranslatedString("change value", i.t(null, void 0, l(50463)));
      class Je extends r.PureComponent {
        ...
        render() {
          ...
          return r.createElement(
            B.InputRow,
            { labelAlign: "adaptive", label: r.createElement(M, { id: e, title: t, visible: a }) },
            r.createElement(
              "div",
              { className: te.block },
              r.createElement(
      ...
      var tt = l(90164),
        lt = l(96438);
      const nt = new s.TranslatedString("change percent width", i.t(null, void 0, l(51081))),
        ...
        it = [
          { value: tt.HHistDirection.LeftToRight, content: i.t(null, void 0, l(19286)) },
          { value: tt.HHistDirection.RightToLeft, content: i.t(null, void 0, l(21141)) },
        ],
        ...
        render() {
          ...
          return r.createElement(
            ...
            r.createElement(
              B.InputRow,
              {
                label: r.createElement("div", { className: te.childRowContainer }, st),
                grouped: !0,
              },
            ...
            r.createElement(
              B.InputRow,
              {
                label: r.createElement("div", { className: te.childRowContainer }, at),
                grouped: !0,
              },
            ...
            r.createElement(
              B.InputRow,
              {
                label: r.createElement("div", { className: te.childRowContainer }, pt),
                grouped: !0,
              },
              r.createElement(ee.ColorWithThicknessSelect, { disabled: s && !s.value(), color: i }),
            ),
            this._renderColors(),
            r.createElement(oe.PropertyTable.GroupSeparator, null),
          );
            ...
            .map((e) =>
              r.createElement(
                B.InputRow,
                {
                  key: e,
                  grouped: !0,
                  label: r.createElement("div", { className: te.childRowContainer }, i[+e]),
                },
                r.createElement(ee.ColorWithThicknessSelect, {
                  disabled: !o.value(),
                  color: l[+e],
      ...
      var yt = l(66045);
      const gt = new s.TranslatedString("change font size", i.t(null, void 0, l(7378))),
      ...
      const ft = new s.TranslatedString("change visibility", i.t(null, void 0, l(21511))),
      ...
      class Et extends r.PureComponent {
        ...
        render() {
          ...
          return r.createElement(
            ...
            r.createElement(
              B.InputRow,
              { labelAlign: "adaptive", label: r.createElement("span", null, Ct) },
              r.createElement(
                "div",
                { className: te.block },
                r.createElement(
      ...
      const Tt = i.t(null, void 0, l(91502)),
        ...
        kt = new s.TranslatedString("change visibility", i.t(null, void 0, l(21511))),
          ...
          return r.createElement(
                    ...
                    return r.createElement(
                      B.InputRow,
                      {
                        ...
                        label: r.createElement(
                          "div",
                          { className: te.childRowContainer },
                          (o && i.t(o.titles[n], { context: "input" }, l(88601))) || "",
                        ),
                      },
                      r.createElement(ee.ColorWithThicknessSelect, {
                        disabled: !C.value(),
            ...
            V &&
              r.createElement(
                ...
                {
                  id: "developingPoc",
                  title: (W.title && i.t(W.title, { context: "input" }, l(88601))) || "",
              ...
              r.createElement(
                ...
                h &&
                  r.createElement(
                    oe.PropertyTable.Cell,
                    { placement: "first", colSpan: 2 },
                    r.createElement(M, { id: "showLabelsOnPriceScale", title: Vt, visible: h }),
                  ),
                m &&
                  r.createElement(
                    oe.PropertyTable.Cell,
                    { placement: "first", colSpan: 2 },
                    r.createElement(M, { id: "showLegendValues", title: Rt, visible: m }),
                  ),
              ),
          );
        }
          ...
          return r.createElement(ve.Consumer, null, (t) =>
            r.createElement(
              ...
              r.createElement(
                oe.PropertyTable,
                null,
                this._renderCustomContent((0, o.ensureNotNull)(t).metaInfo().shortId),
              ),
            ),
          );
        }
      ...
      var zt = l(43886);
      const Ft = new s.TranslatedString("change precision", i.t(null, void 0, l(164))),
      ...
      const jt = new s.TranslatedString("change min tick", i.t(null, void 0, l(20834))),
      ...
      class Jt extends r.PureComponent {
        render() {
          ...
          return r.createElement(
            B.InputRow,
            {
              label: c ? r.createElement(M, { id: e, title: l, visible: n }) : l,
              offset: p,
              grouped: d,
            },
            t
      ...
      class rl extends r.PureComponent {
        ...
        render() {
          ...
          return r.createElement(
            ...
            u &&
              r.createElement(Kt, { id: (0, k.createDomId)(t.id, "min-tick-select"), minTick: i }),
            I.StudyMetaInfo.isScriptStrategy(t) && r.createElement(et, { orders: o.orders }),
            (d || p) &&
              r.createElement(
                oe.PropertyTable.Row,
                null,
                ...
                p &&
                  r.createElement(
                    ...
                    r.createElement(
                      oe.PropertyTable.Cell,
                      { placement: "first", colSpan: 2 },
                      r.createElement(M, { id: "showLabelsOnPriceScale", title: ll, visible: s }),
                    ),
                    r.createElement(
                      oe.PropertyTable.Cell,
                      { placement: "first", colSpan: 2 },
                      r.createElement(M, { id: "showLegendValues", title: tl, visible: a }),
                    ),
                  ),
              ),
          );
        ...
        _plotsElement() {
          ...
          return new T.MetaInfoHelper(t)
            ...
            .map((t) => {
              ...
              return r.createElement(Qe, { key: t.id, plot: t, palettes: n, study: e });
            });
        }
        _bandsElement() {
          const { study: e } = this.props,
          ...
          return (
            ...
            t.map((e, t) => {
              if (!e.isHidden)
                return r.createElement(Je, { key: t, id: e.name, name: e.name, property: l[t] });
            })
          );
        }
        ...
        _graphicsElement() {
          ...
          return (
            t &&
            Object.keys(t).map((t, l) => r.createElement(vt, { key: t, graphicType: t, study: e }))
          );
        }
        _findPalettesByTargetId(e) {
          ...
          for (const l of n) {
            if (((0, x.isPaletteColorerPlot)(l) || (0, x.isOhlcColorerPlot)(l)) && l.target === e) {
              ...
              i.main = { palette: r[l.palette], paletteProps: t.properties().palettes[l.palette] };
            }
            (0, x.isUpColorerPlot)(l) &&
              l.target === e &&
              (i.up = { palette: r[l.palette], paletteProps: t.properties().palettes[l.palette] }),
      ...
      function ol(e) {
        return (0, L.bindPropertyContext)(rl, { ...e, property: e.study.properties() });
      }
      ...
      class dl extends al.DialogRenderer {
        ...
        show(e = {}) {
          ...
          h.hasUserEditableInputs() &&
            s.push({ id: "inputs", label: i.t(null, void 0, l(66304)), Component: _ }),
            h.hasUserEditableProperties(),
            h.hasUserEditableStyles() &&
              s.push({ id: "style", label: i.t(null, void 0, l(32733)), Component: il }),
            this._propertyPages ||
              s.push({
                id: "visibilities",
          ...
          let v = (0, a.clean)(o.shortDescription, !0);
    ...
    48531: (e, t, l) => {
      ...
      function d(e) {
        return n.createElement(s.MatchMedia, { rule: "screen and (max-width: 768px)" }, (t) =>
          n.createElement(
            i.ControlDisclosure,
            {
      ...
      function y(e) {
        ...
        return n.createElement(
          ...
          n.createElement(u.PopupMenuItem, {
            ...
            onClick: s,
            toolbox:
              l && n.createElement(h.RemoveButton, { hidden: !v.mobiletouch && !o, onClick: c }),
          }),
        );
      }
      function g(e) {
    ...
    69297: (e, t, l) => {
      "use strict";
      l.d(t, { DEFAULT_MENU_ITEM_SWITCHER_THEME: () => g, MenuItemSwitcher: () => b });
      var n = l(50959),
        r = l(97754),
        o = l.n(r),
        i = l(17946),
      ...
      function b(e) {
        const {
          ...
          T = o()(t, w.wrapper, l && w.wrapperWithOnLabel, s && w.wrapperWithDescription);
        return n.createElement(
          "label",
          {
            className: o()(T, C && w.withIcon, u.PLATFORM_ACCESSIBILITY_ENABLED && y.accessible),
            htmlFor: r,
            ref: g,
            onKeyDown: function (e) {
              ...
              (13 !== t && 32 !== t) ||
                (e.preventDefault(), P.current instanceof HTMLElement && P.current.click());
            },
            tabIndex: S,
          ...
          void 0 !== C && n.createElement(d.Icon, { className: w.icon, icon: C }),
          n.createElement(
            "div",
    ...
    97456: (e, t, l) => {
      ...
      const d = new r.TranslatedString(
        ...
        _ = new r.TranslatedString("change {title} weeks to", n.t(null, void 0, l(68643))),
      ...
      function ae(e, t, l) {
        ...
        const r = (0, i.createRangePropertyDefinition)(
          ...
          c = (0, i.createRangePropertyDefinition)(
            {
              ...
              from: (0, i.convertToDefinitionProperty)(e, t.hoursFrom, w.format({ title: l })),
              to: (0, i.convertToDefinitionProperty)(e, t.hoursTo, f.format({ title: l })),
            },
            {
          ...
          p = (0, i.createRangePropertyDefinition)(
            {
              checked: (0, i.convertToDefinitionProperty)(e, t.days, C.format({ title: l })),
              from: (0, i.convertToDefinitionProperty)(e, t.daysFrom, P.format({ title: l })),
              to: (0, i.convertToDefinitionProperty)(e, t.daysTo, S.format({ title: l })),
            },
            {
        ...
        const W = (0, i.createRangePropertyDefinition)(
            {
              ...
              from: (0, i.convertToDefinitionProperty)(e, t.weeksFrom, T.format({ title: l })),
          ...
          A = (0, i.createRangePropertyDefinition)(
            {
              ...
              to: (0, i.convertToDefinitionProperty)(e, t.monthsTo, I.format({ title: l })),
            },
            {
    ...
    62513: (e, t, l) => {
      ...
      class a extends i.default {
        ...
        setValue(e, t) {
          this._propertyApplier.beginUndoMacro(s.format({ propertyName: this._propertyName })),
            (this._isProcess = !0),
