  ...
  [5164],
  {
      ...
      function d(e) {
        ...
        (0, n.useEffect)(() => {
          ...
          return (
            N
              ? (f && f(),
                e && (e.addEventListener("mousemove", O), e.addEventListener("mouseup", W)))
              : p && p(),
            () => {
              e && (e.removeEventListener("mousemove", O), e.removeEventListener("mouseup", W));
            }
          );
        }, [N]);
        const x = t / r || 0,
        ...
        return n.createElement(
          "div",
          {
            ...
            onMouseDown: function (e) {
              ...
              const i = j(D);
              o < 0 ? ((o = 0), (P.current = t)) : o > i && ((o = i), (P.current = t - r * i));
              d(A(r * o)), k(!0);
            },
          },
          n.createElement(
            "div",
            {
              ...
              onMouseDown: function (e) {
                e.preventDefault(),
                  (P.current = I(e.nativeEvent, (0, a.ensureNotNull)(z.current))),
                  k(!0);
              },
            },
            n.createElement("div", { className: i()(m.barInner, w && m["barInner--horizontal"]) }),
          ),
        );
        function O(e) {
    ...
    36189: (e, t, r) => {
      ...
      var n = r(11542),
        ...
        l = r(48010),
        c = r(14877);
      const u = { add: n.t(null, void 0, r(44629)), remove: n.t(null, void 0, r(72482)) };
      function v(e) {
    ...
    70412: (e, t, r) => {
      "use strict";
      r.d(t, { hoverMouseEventFilter: () => i, useAccurateHover: () => s, useHover: () => o });
      var n = r(50959);
      function o() {
    ...
    96040: (e, t, r) => {
      ...
      function c(e) {
        ...
        return o.createElement(s.Icon, {
          ...f,
          "data-name": m,
          className: i(l.button, "apply-common-tooltip", c && l.active, h && l.hidden, t),
          icon: a,
          onClick: u,
          onMouseDown: v,
