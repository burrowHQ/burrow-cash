(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [4713],
  {
    ...
    28746: (e, t, n) => {
      ...
      function f(e) {
        const {
          ...
          _ = (0, s.useCallback)(
            (e) =>
              D || (0, c.isDayDisabled)({ day: e, minDate: p, maxDate: h, disableWeekends: m }),
            [p, h, m, D],
          ),
          {
            itemsRefs: F,
      ...
      function v(e) {
        const {
          ...
          w = (0, s.useCallback)((e) => d || !(0, c.isInRange)(e, o, r, "month"), [o, r, d]),
          D = (0, s.useCallback)(
            (e) => {
              if (!e) return null;
              let n = null;
      ...
      function w(e) {
        const {
          ...
          D = (0, s.useCallback)((e) => p || !(0, c.isInRange)(e, h, l, "year"), [h, l, p]),
              ...
              t.map((e) => {
                ...
                return s.createElement(
                  a.LightButton,
                  {
                    ...
                    disabled: l,
                    isSelected: o,
                    className: r(i["decade-button"], !d && i["hide-focus-ring"]),
                    onClick: () => f(e),
                    reference: _(e),
      ...
      function E(e) {
        ...
        return s.createElement(
          "div",
          { className: r(i.calendar, g && i.popupStyle, o), tabIndex: -1, onKeyDown: I },
          s.createElement(l, {
        ...
        constructor(e) {
          super(e),
            ...
            (this._getErrors = () => {
              ...
              return this.state.isInvalid && e.push(s.t(null, void 0, n(5122))), e;
            }),
            (this.state = {
              pickerInputKey: 0,
              date: e.initial,
    ...
    76056: (e, t, n) => {
      ...
      const p = n(53209);
      function m(e) {
        const { hasErrors: t, onClick: l, errors: c, className: u, theme: m = p, ...g } = e;
        return s.createElement(
          "div",
          ...
          t && s.createElement(h, { text: r.t(null, void 0, n(32457)), className: m.tooltip }),
        );
      }
    },
    23935: (e, t, n) => {
    ...
    36565: (e, t, n) => {
      ...
      function N(e) {
        ...
        const n = (0, r.useRef)(null),
          ...
          D = x(f) ? f : T(f),
          [b, y] = (0, r.useState)(D),
          C = u || L().some((e) => null !== e && e.contains(document.activeElement));
        ...
        function V(e) {
          return u && (null !== z(document.activeElement) || null !== z(e.relatedTarget));
        }
        function z(e) {
          return (e instanceof Node && L().find((t) => null !== t && t.contains(e))) || null;
        }
        function L() {
      ...
      function T(e) {
        const [t, n] = e.split(":"),
          [s, r] = [(0, w.clamp)(parseInt(t), 0, 23), (0, w.clamp)(parseInt(n), 0, 59)],
    ...
    95263: (e, t, n) => {
      ...
      class m extends s.PureComponent {
        render() {
          const {
            ...
            l = e.map((e, t) => s.createElement(w, { key: t, messageIdCallback: o }, e));
          let c = {
            position: "absolute",
            top: this.props.top,
      ...
      function D(e) {
        const { children: t, messageIdCallback: n, ...r } = e,
          o = s.useId();
        return (
          a(o, n), s.createElement("span", { ...r, className: d["visually-hidden"], id: o }, t)
        );
      }
      var b = n(9745),
        y = n(16658),
      ...
      function k(e) {
        const {
          ...
          { attachment: h, targetAttachment: d, attachmentOffsetY: p } = null != a ? a : S[r];
        return s.createElement(
          s.Fragment,
          null,
          s.createElement(
      ...
      function I(e) {
        ...
        const {
          ...
          $ = L || H ? s.createElement(E, { intent: L ? "danger" : "warning" }) : void 0,
          K = x
            ? s.createElement(k, {
                errorAttachment: p,
                customErrorsAttachment: m,
          ...
          j = O
            ? s.createElement(
                ...
                null == u
                  ? void 0
                  : u.map((e, t) => s.createElement(P, { key: t, messageIdCallback: R }, e)),
              )
            : void 0,
          J = V
            ? s.createElement(
                ...
                null == h
                  ? void 0
                  : h.map((e, t) => s.createElement(P, { key: t, messageIdCallback: R }, e)),
              )
            : void 0,
          q = z
            ? s.createElement(
                ...
                null == d
                  ? void 0
                  : d.map((e, t) => s.createElement(P, { key: t, messageIdCallback: R }, e)),
              )
            : void 0,
          U =
            !O && !V && !z && w
          ...
          renderedErrors:
            null !==
              (c =
                null !==
                  (a =
                    null !== (n = null !== (t = null != K ? K : W) && void 0 !== t ? t : j) &&
                    void 0 !== n
                      ? n
                      : J) && void 0 !== a
                  ? a
      ...
      function P(e) {
        const { children: t, messageIdCallback: n, ...r } = e,
          o = s.useId();
        return a(o, n), s.createElement("span", { ...r, className: M.message, id: o }, t);
      }
    },
    16396: (e, t, n) => {
      "use strict";
        ...
        return s.createElement(
          Z,
          {
            ...
            onContextMenu: function (e) {
              W && J && (0, a.trackEvent)(W.category, W.event, `${W.label}_rightClick`);
            },
            onMouseUp: function (e) {
              if (1 === e.button && _ && W) {
                let e = W.label;
                j && (e += "_mouseWheelClick"), (0, a.trackEvent)(W.category, W.event, e);
              }
            },
            onMouseOver: T,
            onMouseOut: x,
          ...
          (void 0 !== g || f) &&
            s.createElement("span", { className: A.shortcut }, (X = g) && X.split("+").join(" + ")),
          void 0 !== N &&
            s.createElement(
              "span",
              {
                onClick: P ? u : void 0,
                className: r(m, A.toolbox, { [A.showOnHover]: F, [A.showOnFocus]: M }),
              },
              N,
            ),
        );
