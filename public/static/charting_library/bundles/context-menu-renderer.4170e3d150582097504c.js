  ...
  [1584],
  {
    ...
    41590: (e, t, n) => {
      ...
      var r = n(50959),
        ...
        d = n(66076);
      function m(e) {
        const { position: t = "Bottom", onClose: n, children: l, className: m, theme: f = d } = e,
        ...
        return (
          ...
          (0, r.useLayoutEffect)(() => {
            if (a.CheckMobile.iOS())
              return (
                null !== s.current && (0, o.disableBodyScroll)(s.current, { allowTouchMove: c(s) }),
                () => {
    ...
    81261: (e, t, n) => {
      ...
      function c(e) {
        ...
        const v = h(u),
          ...
          E = -1 !== p,
          _ = (e) => {
            s && (0, o.becomeSecondaryElement)(s), (0, o.becomeMainElement)(e), e.focus();
          };
        switch ((0, r.mapKeyCodeToDirection)(n)) {
          case "inlinePrev":
            if (!v.length) return;
            e.preventDefault(), _(0 === p ? c[f] : E ? l(v, p, -1) : v[v.length - 1]);
            break;
          case "inlineNext":
            if (!v.length) return;
            e.preventDefault(), p === v.length - 1 ? _(c[f]) : _(E ? l(v, p, 1) : v[0]);
            break;
          case "blockPrev": {
            e.preventDefault();
            const t = l(c, f, -1);
              ...
              position: (t) => {
                ...
                if (void 0 !== e.box) f = e.box;
                  ...
                  f = {
                    x:
                      null !==
                        (r = null === (n = e.touches) || void 0 === n ? void 0 : n[0].clientX) &&
                      void 0 !== r
                        ? r
                        : e.clientX,
                    y:
                      null !==
                        (i = null === (o = e.touches) || void 0 === o ? void 0 : o[0].clientY) &&
                      void 0 !== i
                        ? i
                        : e.clientY,
                    w: 0,
                ...
                "auto-strict" === g && (g = h < f.y + f.h + p + d ? "bottom" : "top");
                let w = f.y;
                switch (g) {
                  case "top":
                    ...
                    break;
                  case "bottom":
                    (w = Math.max(0, f.y - p - d)), (b = 0 === w ? f.y - p : void 0);
                }
