  ...
  [5128],
  {
                ...
                (i = [].concat(t(i), [d])),
                  ...
                  (e.ontouchmove = function (t) {
                    ...
                    1 === t.targetTouches.length &&
                      ...
                      !u(n.target) &&
                        ((o && 0 === o.scrollTop && 0 < i) ||
                        ((s = o) && s.scrollHeight - s.scrollTop <= s.clientHeight && i < 0)
                          ? h(n)
                          : n.stopPropagation()));
                  }),
                  r ||
                    (document.addEventListener("touchmove", h, n ? { passive: !1 } : void 0),
                    (r = !0));
              }
            } else {
              (p = o),
            ...
            (e.clearAllBodyScrollLocks = function () {
              s
                ? (i.forEach(function (e) {
                  ...
                  r &&
                    (document.removeEventListener("touchmove", h, n ? { passive: !1 } : void 0),
                    (r = !1)),
                  (i = []),
                  (a = -1))
                : (d(), (i = []));
    ...
    26996: (e, t, n) => {
      ...
      var o = n(50959),
        ...
        r = n.n(i);
      function a(e) {
        const { className: t, size: n = "medium", staticPosition: i, color: a = "black" } = e,
          l = s(r().item, r()[a], r()[n]);
        return o.createElement(
          "span",
          {
      ...
      const w = (0, o.forwardRef)(function (e, t) {
        ...
        return o.createElement(m.ContextMenuItem, {
          ...
          onKeyDown: function (e) {
            if (!g.PLATFORM_ACCESSIBILITY_ENABLED || e.target !== e.currentTarget) return;
          ...
          "aria-disabled": (g.PLATFORM_ACCESSIBILITY_ENABLED && e.disabled) || void 0,
        });
      });
    ...
    50267: (e, t, n) => {
      "use strict";
      n.d(t, { ContextMenuItem: () => f, DEFAUL_CONTEXT_MENU_ITEM_THEME: () => E });
      var o = n(50959),
        s = n(97754),
        i = n(70673),
        r = n(49483),
      ...
      class f extends o.PureComponent {
        ...
        render() {
          const {
            ...
            w = this.props.checkable && this.props.checkboxInput ? "label" : "div";
          return o.createElement(
            o.Fragment,
            null,
            o.createElement(
              ...
              o.createElement(
                ...
                o.createElement(
                  ...
                  o.createElement(
                    "span",
                    { className: s(l.label, this.props.checked && l.checked), "data-label": !0 },
                    !E && f
                      ? f.map(({ text: e, ...t }, n) =>
                  ...
                  !e &&
                    t &&
                    !r.CheckMobile.any() &&
                    o.createElement(u.Hint, { className: s(i && l.invisibleHotkey), text: t }),
        ...
        _renderToolboxContent() {
          return this.props.toolbox && this.props.toolbox.type === h.ToolboxType.Delete
            ? o.createElement(l.RemoveButton, { onClick: this.props.toolbox.action })
            : null;
        }
      }
    },
          ...
          o.createElement(
            ...
            c &&
              o.createElement(
                b.Drawer,
                { onClose: u },
                o.createElement(x, { items: s.subItems, parentAction: n, closeNested: u }),
              ),
          )
        );
        function u(e) {
        ...
        render() {
          ...
          return e
            ? o.createElement(
                ...
                o.createElement(d.MatchMedia, { rule: "screen and (max-width: 430px)" }, (t) =>
                  this._isDrawer(t)
                    ? o.createElement(
                        k.Provider,
                        { value: { type: "drawer" } },
      ...
      function p(e) {
        ...
        return s
          ...
          : o.createElement(
              ...
              !D && x && o.createElement(c.Hint, { className: m.shortcut, text: x }),
    ...
    36189: (e, t, n) => {
      ...
      var o = n(11542),
        ...
        l = n(48010),
        c = n(14877);
      const u = { add: o.t(null, void 0, n(44629)), remove: o.t(null, void 0, n(72482)) };
      function h(e) {
        const { className: t, isFilled: n, isActive: o, onClick: h, ...d } = e;
        return s.createElement(r.Icon, {
          ...d,
          className: i(c.favorite, "apply-common-tooltip", n && c.checked, o && c.active, t),
          icon: n ? a : l,
          onClick: h,
