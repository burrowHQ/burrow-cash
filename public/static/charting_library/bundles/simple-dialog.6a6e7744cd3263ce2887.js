  ...
  [8890],
  {
                ...
                (a = [].concat(t(a), [m])),
                  ...
                  (e.ontouchmove = function (t) {
                    ...
                    1 === t.targetTouches.length &&
                      ...
                      !u(n.target) &&
                        ((o && 0 === o.scrollTop && 0 < a) ||
                        ((l = o) && l.scrollHeight - l.scrollTop <= l.clientHeight && a < 0)
                          ? d(n)
                          : n.stopPropagation()));
                  }),
                  r ||
    ...
    70493: (e, t, n) => {
      ...
      var o = n(50959),
        ...
        g = n(76974),
        C = n(50655);
      const E = o.createContext({ isSmallTablet: !1, dialogCloseHandler: () => {} });
      var N = n(30507);
      function w(e) {
        const {
            disabled: t,
      ...
      function b(e) {
        ...
        const [T, U] = (0, o.useState)(!0),
          k = (0, o.useRef)(null);
        return o.createElement(u.MatchMedia, { rule: m.DialogBreakpoints.TabletSmall }, (i) =>
          o.createElement(
            E.Provider,
            ...
            o.createElement(
              ...
              o.createElement(
                ...
                o.createElement(
                  "div",
                  { className: a(_.main, !b && _.marginWithoutCloseButton, i && _.small) },
                  t && o.createElement("div", { className: a(_.title, i && _.small) }, t),
                  (function (t) {
                    if ("html" in e)
                  ...
                  l &&
                    ...
                    o.createElement(
                      ...
                      l.map((e, t) =>
                        o.createElement(w, { ...e, key: e.name, reference: 0 === t ? k : void 0 }),
                      ),
                    ),
                ),
                b &&
        ...
        function O(e) {
          switch ((0, c.hashFromEvent)(e)) {
            ...
            case 13:
              ...
              if (e.defaultPrevented || (t instanceof HTMLButtonElement && "submit" !== t.type))
                return;
              if (T && l && l.length) {
                e.preventDefault();
                const t = k.current;
      ...
      function U(e) {
        ...
        return (
          ...
          o.createElement(
            ...
            null,
            (function () {
              if ("content" in e) return o.createElement("div", { className: T.label }, e.content);
              if ("html" in e)
      ...
      const D = function (e) {
            ...
            actions: [
              {
                ...
                handler: ({ dialogClose: e, innerManager: t }) =>
                  f({ newValue: C, focusInput: _, dialogClose: e, innerManager: t }),
              },
              {
                name: "cancel",
                type: "button",
        ...
        P = function (e, t, n) {
          const { title: l } = e;
          let a = `${l}_`;
          if (((a += "text" in e ? e.text : "html" in e ? e.html : e.id), M.isOpened(a)))
        ...
        return (
          ...
          (0, o.useLayoutEffect)(() => {
            if (r.CheckMobile.iOS())
              return (
                null !== i.current && (0, l.disableBodyScroll)(i.current, { allowTouchMove: s(i) }),
                () => {
