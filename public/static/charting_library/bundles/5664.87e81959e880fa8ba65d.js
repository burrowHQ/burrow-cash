  ...
  [5664],
  {
    ...
    41590: (e, t, n) => {
      ...
      var o = n(50959),
        ...
        u = n(66076);
      function v(e) {
        const { position: t = "Bottom", onClose: n, children: m, className: v, theme: d = u } = e,
          p = (0, r.ensureNotNull)((0, o.useContext)(l.DrawerContext)),
          ...
          o.createElement(
            ...
            o.createElement(
              ...
              o.createElement(
                h,
                {
                  className: a(d.drawer, u[`position${t}`], v),
                  ref: w,
    ...
    173: (e, t, n) => {
      ...
      const k = [
        {
          title: r.t(null, { context: "emoji_group" }, n(15426)),
          emojis: [],
          content: o.createElement(a.IconItem, { icon: i }),
        },
        {
          title: r.t(null, { context: "emoji_group" }, n(96330)),
          emojis: p,
          content: o.createElement(a.IconItem, { icon: c }),
        },
        {
          title: r.t(null, { context: "emoji_group" }, n(60558)),
          emojis: f,
          content: o.createElement(a.IconItem, { icon: l }),
        },
        {
          title: r.t(null, { context: "emoji_group" }, n(35305)),
          emojis: w,
          content: o.createElement(a.IconItem, { icon: s }),
        },
        {
          title: r.t(null, { context: "emoji_group" }, n(14232)),
          emojis: E,
          content: o.createElement(a.IconItem, { icon: m }),
        },
        {
          title: r.t(null, { context: "emoji_group" }, n(15395)),
          emojis: g,
          content: o.createElement(a.IconItem, { icon: u }),
        },
        {
          title: r.t(null, { context: "emoji_group" }, n(72302)),
          emojis: b,
          content: o.createElement(a.IconItem, { icon: v }),
        },
        {
          title: r.t(null, { context: "emoji_group" }, n(6878)),
          emojis: C,
          content: o.createElement(a.IconItem, { icon: h }),
        },
        {
          title: r.t(null, { context: "emoji_group" }, n(49546)),
          emojis: z,
          content: o.createElement(a.IconItem, { icon: d }),
        },
      ];
    },
    47291: (e, t, n) => {
      ...
      function l(e) {
        ...
        return o.createElement("div", { className: i()(c.wrapper, n) }, t);
      }
      var s = n(26601),
        m = n(77762),
        u = n(38223),
      ...
      function d(e) {
        ...
        const f = (0, o.useCallback)((e) => ("title" === a[e].type ? 30 : i), [a, i]),
          w = (0, o.useCallback)(
            ({ visibleStartIndex: e }) => {
        ...
        return o.createElement(
          ...
          o.createElement(r.VariableSizeList, {
            direction: (0, u.isRtl)() ? "rtl" : "ltr",
            className: v.list,
            ref: t,
            outerRef: n,
            width: "100%",
      ...
      const p = o.memo((e) => {
        const { style: t, index: n, data: r } = e,
          a = r[n],
          {
            ...
            onSelect: c,
            ItemComponent: u,
            RowComponent: v = s.EmojisRow,
          } = (0, m.useEnsuredContext)(h);
        return "title" === a.type
          ? o.createElement("div", { style: t }, o.createElement(l, { title: a.relatedTitle }))
          : o.createElement(
              "div",
              { style: t },
              o.createElement(v, {
    ...
    38297: (e, t, n) => {
      ...
      function h(e) {
        ...
        const [A, j] = (0, o.useState)(
            (null === (t = M[0]) || void 0 === t ? void 0 : t.relatedTitle) || "",
          ),
          y = (0, o.useCallback)((e) => {
            b.current || j(e);
          }, []);
        return o.createElement(
          ...
          o.createElement(c.GroupTabs, {
            ...
            onTabClick: function (e) {
              ...
              N(
                (function (e) {
                  return M.findIndex(({ relatedTitle: t, type: n }) => "title" === n && t === e);
                })(e),
              );
            },
          }),
          o.createElement(
            "div",
            { ref: k, onKeyDown: z },
            o.createElement(l.EmojiListContent, {
              listRef: g,
              outerRef: C,
              emojiGroups: M,
              emojiSize: E,
        ...
        function N(e) {
          var t;
          s.CheckMobile.iOS() && C.current && (C.current.style.overflow = "hidden"),
            (b.current = !0),
            null === (t = g.current) || void 0 === t || t.scrollToItem(e, "start"),
            requestAnimationFrame(() => {
              var t;
              null === (t = g.current) || void 0 === t || t.scrollToItem(e, "start"),
                s.CheckMobile.iOS() && C.current && (C.current.style.overflow = "auto"),
                (b.current = !1);
            });
        }
      }
    ...
    26601: (e, t, n) => {
      ...
      var o = n(50959),
        ...
        c = n(11123);
      const l = o.memo((e) => {
        const { emojis: t, itemSize: n, onEmojiClick: r, ItemComponent: l, className: s } = e;
        return o.createElement(
          "div",
          { "data-role": "row", className: a()(c.wrapper, s) },
          t.map((e) =>
            o.createElement(i.EmojiWrap, {
              key: e,
    ...
    85034: (e, t, n) => {
      ...
      var o = n(50959),
        ...
        s = n(17373);
      function m(e) {
        const { tab: t, isActive: n, onTabClick: r, children: i, className: m } = e,
        ...
        return l.PLATFORM_ACCESSIBILITY_ENABLED
          ...
          : o.createElement(
              "div",
              { className: a()(s.wrapper, n && s.isActive, m), onClick: h },
              i,
            );
        function h() {
          r(t);
      ...
      var u = n(12134);
      function v(e) {
        const { activeTab: t, tabs: n, onTabClick: r, className: c, tabClassName: l } = e;
        return o.createElement(
          i.Toolbar,
          { orientation: "horizontal", className: a()(u.wrapper, c), blurOnEscKeydown: !1 },
          n.map(({ title: e, content: n }) =>
            o.createElement(
              m,
              { key: e, tab: e, className: l, isActive: t === e, onTabClick: r },
              n,
            ),
          ),
        );
    ...
    99616: (e, t, n) => {
      ...
      function l(e) {
        return o.createElement(
          ...
          o.createElement(i.Icon, { icon: e.icon }),
        );
      }
    },
    83682: (e, t, n) => {
      ...
      const v = 34;
      function h(e) {
        const { className: t, emoji: n, size: r = v, onClick: i, ItemComponent: c = l } = e,
          [h, d] = (0, m.useRovingTabindexElement)(null);
        return s.PLATFORM_ACCESSIBILITY_ENABLED
          ? o.createElement(
              ...
              o.createElement(c, { emoji: n }),
            )
          : o.createElement(
              "div",
              { className: a()(u.wrapper, t), style: { width: r, height: r }, onClick: p },
              o.createElement(c, { emoji: n }),
            );
        function p() {
          i(n);
    ...
    81261: (e, t, n) => {
      ...
      function l(e) {
        ...
        const l = v(e.currentTarget).sort(o.navigationOrderComparator);
        ...
        const p = h(s),
          ...
          w = -1 !== f,
          E = (e) => {
            c && (0, r.becomeSecondaryElement)(c), (0, r.becomeMainElement)(e), e.focus();
          };
    ...
    54079: (e, t, n) => {
      ...
      const u = (0, o.forwardRef)(function (e, t) {
        const {
            onKeyDown: n,
            orientation: u,
            blurOnEscKeydown: v = !0,
            blurOnClick: h = !0,
            ...d
          } = e,
          p = c.PLATFORM_ACCESSIBILITY_ENABLED ? { role: "toolbar", "aria-orientation": u } : {},
        ...
        return (
          ...
          o.createElement("div", {
            ...
            onKeyDown: (0, a.createSafeMulticastEventHandler)(function (e) {
              ...
              if (v && 27 === t) return e.preventDefault(), void document.activeElement.blur();
              if ("vertical" !== u && 37 !== t && 39 !== t) return;
              if ("vertical" === u && 38 !== t && 40 !== t) return;
              const n = e.currentTarget,
                o = (0, c.queryFocusableElements)(n).sort(c.navigationOrderComparator);
              ...
              const a = () => {
                  ...
                  (0, l.becomeSecondaryElement)(o[r]), (0, l.becomeMainElement)(o[e]), o[e].focus();
                },
                s = () => {
                  const e = (r + o.length + 1) % o.length;
                  (0, l.becomeSecondaryElement)(o[r]), (0, l.becomeMainElement)(o[e]), o[e].focus();
                };
              switch ((0, c.mapKeyCodeToDirection)(t)) {
                case "inlinePrev":
                  "vertical" !== u && a();
                  break;
                case "inlineNext":
