  ...
  [1583],
  {
            ...
            if (t === g.LineToolBarsPatternMode.Bars || t === g.LineToolBarsPatternMode.OpenClose) {
              ...
              for (let t = 0; t < _; t++) {
                const i = Math.round(L + t * d + 0.5),
                  r = e(p[t]).map((e, t) => new n.Point(i + (2 * t - 1), Math.round(m(e)) + C)),
    ...
    47346: (e, t, i) => {
      ...
      class c extends a.LineSourcePaneView {
        ...
        _updateImpl(e, t) {
          ...
          this._trendRenderer.setData(_), this._renderer.append(this._trendRenderer);
      ...
      class T extends x.DateAndPriceRangeBasePaneView {
        ...
        _updateImpl(e, t) {
          ...
          this._distancePriceRenderer.setData({
            ...
            leftend: p.LineEnd.Normal,
            rightend:
              Math.abs(C.y - S.y) >= 25 * d.linewidth.value() ? p.LineEnd.Arrow : p.LineEnd.Normal,
            excludeBoundaries: null != f ? f : void 0,
          }),
      ...
      class m extends g.DateAndPriceRangeBasePaneView {
        ...
        _updateImpl(e, t) {
          ...
          this._distancePriceRenderer.setData({
            ...
            leftend: c.LineEnd.Normal,
            rightend:
              Math.abs(y.x - b.x) >= 15 * r.linewidth.value() ? c.LineEnd.Arrow : c.LineEnd.Normal,
      ...
      class _ extends u.AlertableLineSourcePaneView {
        ...
        _updateImpl(e, t) {
          ...
          const o = this._source.priceScale(),
            a = null === (i = this._source.ownerSource()) || void 0 === i ? void 0 : i.firstValue();
          if (!o || null == a) return;
          ...
          let w, R;
          if (this._points.length >= 3) {
            (w = (0, r.point)(m.x, this._points[2].y)), (w.data = 2), (w.square = !0);
            const e = m.y - x.y;
            if (((R = (0, r.point)(x.x, w.y + e)), (R.data = 3), v.fillBackground.value())) {
          ...
          this._model.lineBeingCreated() === this._source && T.pop(),
            this._renderer.append(this.createLineAnchor({ points: T, pointsCursorType: p }, 0)),
    ...
    46406: (e, t, i) => {
      ...
      class u extends d.LineToolPaneViewFibWithLabels {
        ...
        _updateImpl(e, t) {
          ...
          if (this._points.length < 2) return this.addAnchors(p), void (this._renderer = p);
          ...
          for (let i = 1; i < v; i++) {
            ...
            null !== I &&
              (p.append(I),
              (A = null !== (a = (0, h.getTextBoundaries)(I, t, e)) && void 0 !== a ? a : void 0));
            const k = {
          ...
          if (null !== m) {
            const i = (0, n.ensureDefined)(this._source.properties().child("level" + m)).childs();
            if (i.visible.value()) {
              ...
              null !== c &&
                (p.append(c),
                (v =
                  null !== (l = (0, h.getTextBoundaries)(c, t, e)) && void 0 !== l ? l : void 0));
              const w = {
                points: [r, o],
                color: i.color.value(),
                linewidth: _.levelsStyle.childs().linewidth.value(),
              ...
              this._lastLevelTrendRenderer.setData(w), p.append(this._lastLevelTrendRenderer);
            }
          }
          ...
          if (
            ...
            if (!(this._points.length < 2)) {
              ...
              if (s.trendline.visible.value()) {
                ...
                this._trendLineRenderer.setData(T), x.append(this._trendLineRenderer);
              }
      ...
      class c extends s.LineToolPaneViewFibWithLabels {
        ...
        _updateRenderer(e = NaN, t = NaN) {
          ...
          const i = new l.CompositeRenderer(),
            ...
            [r, s] = this._points,
            o = n.trendline.childs().visible.value() ? n.trendline.childs().linewidth.value() : 0,
          ...
          for (let r = this._levels.length - 1; r >= 0; r--) {
            ...
            o.setData({
              ...
              o.setHitTest(new a.HitTestResult(a.HitTarget.MovePoint, void 0, s.index)),
              i.append(o);
      ...
      class u extends c.AlertableLineSourcePaneView {
        ...
        _updateImpl() {
          ...
          if ((super._updateImpl(), this._renderer.clear(), this._source.points().length < 2))
            return;
          const t = this._source.priceScale(),
            i = null === (e = this._source.ownerSource()) || void 0 === e ? void 0 : e.firstValue();
          if (!t || null == i) return;
          ...
          if ((x(this._p1LabelRenderer, this._p2LabelRenderer, u, p, l, d), !_ || !g))
            return void this.addAnchors(this._renderer);
      ...
      t.GannSquarePaneView = class extends r {
        ...
        _updateImpl() {
          if (
            ...
            if (((this._hfans = []), (this._vfans = []), S.fans.visible.value()))
              for (p = 1; p <= 7; p++) {
            ...
            for (p = 0; p < this._hlevels.length; p++) {
              ...
              var D = {
                points: [(e = new n(T, this._hlevels[p].y)), (t = new n(L, this._hlevels[p].y))],
                width: this._model.timeScale().width(),
                height: this._source.priceScale().height(),
              ...
              if (((V = new a()).setData(D), b.append(V), S.showLeftLabels.value())) {
                var B = {
                  points: [e],
            ...
            for (p = 0; p < this._vlevels.length; p++) {
              (e = new n(this._vlevels[p].x, P)), (t = new n(this._vlevels[p].x, C));
              if (p > 0 && A) {
                N = this._vlevels[p - 1];
                var E,
                  H = new n(N.x, P);
              ...
              if (((V = new a()).setData(D), b.append(V), S.showTopLabels.value())) {
                var O = {
                  points: [e],
            ...
            (j.data = 3),
              b.append(this.createLineAnchor({ points: [...this._points, Y, j] }, 0)),
              (this._renderer = b);
          }
          function U(e, t, i) {
            var r = new n(T, P),
    ...
    134: (e, t, i) => {
      ...
      class d extends r.LineSourcePaneView {
        ...
        _updateLabelForLevel({
          ...
          const b = !((i.x > this._model.timeScale().width() && !h) || (r.x < 0 && !c));
          let T,
            P,
            L = a;
          switch (L) {
            ...
            case "right":
              (P = r.y),
                c ? (T = b ? this._model.timeScale().width() : i.x) : ((T = r.x), (L = "left"));
              break;
            default:
    ...
    34658: (e, t, i) => {
      ...
      class x {
        ...
        _drawTooltipOn(e, t) {
          ...
          e.moveTo(R, y),
            x || "top" !== m || (e.lineTo(w - b, y), e.lineTo(w, y - b), e.lineTo(w + b, y)),
            e.lineTo(R + _, y),
            e.lineTo(R + _, y + g),
            x ||
              "bottom" !== m ||
              (e.lineTo(w + b, y + g), e.lineTo(w, y + g + b), e.lineTo(w - b, y + g)),
            e.lineTo(R, y + g),
            e.closePath(),
            e.fill(),
            e.stroke(),
      ...
      class f extends d.MediaCoordinatesPaneRenderer {
        ...
        _drawImpl(e) {
          ...
          const t = e.context,
            ...
            { left: o, right: a } = (0, p.orderLineLocation)(this._adapter, i, s),
          ...
          0 !== n &&
            ...
            (h = !0)),
            0 !== r &&
              (this._drawQuantity(t, o + n, d, h), this._drawQuantityText(t, o + n, d), (h = !0)),
            0 !== this._cancelButtonWidth() && this._drawCancelButton(t, o + n + r, d, h);
        }
        _height() {
          return Math.max(
            20,
        ...
        _updateImpl() {
          ...
          if (3 === this._points.length) {
            ...
            (o = i.add((0, n.point)(0, e))),
              ...
              t.showMidline.value() && ((d = i.add(o).scaled(0.5)), (h = s.add(l).scaled(0.5)));
          }
          const u = t.linewidth.value(),
            ...
            g = {
              ...
              fillBackground: t.fillBackground.value(),
              backColor: (0, r.generateColor)(t.backgroundColor.value(), t.transparency.value()),
              hittestOnBackground: !0,
            };
          ...
          if (
            (this._model.lineBeingCreated() !== this._source || m || (x.pop(), x.pop()),
            f.append(this.createLineAnchor({ points: x, pointsCursorType: c }, 0)),
            this._points.length >= 2)
          ) {
            const e = this._points;
        ...
        hitTest(e) {
          return null === this._data ||
            ...
            ? new s(o.Custom, {
                ...
                tapHandler: this._adapter.callOnModify.bind(this._adapter),
                tooltip: {
                  text: this._adapter.getProtectTooltip() || d(i.tf(null, void 0, i(11810))),
                  rect: {
            ...
            ? new s(o.Custom, {
                ...
                tooltip: {
                  text: this._adapter.getReverseTooltip() || i.tf(null, void 0, i(19780)),
                  rect: {
            ...
            ? new s(o.Custom, {
                ...
                tooltip: {
                  text: this._adapter.getCloseTooltip() || i.tf(null, void 0, i(37431)),
                  rect: {
            ...
            (e.fillStyle = B),
              "up" === this._data.direction
                ? (R(e, T.x - 1, T.y - H - 2, this._targetWidth + 2, H, 5),
                  ...
                  E &&
                    e.drawImage(E, T.x + O - E.width - 4, T.y - H - 2 + Math.abs(H - E.height) / 2))
                : (R(e, T.x - 1, T.y + this._targetHeight + 2, this._targetWidth + 2, H, 5),
                  e.fill(),
                  (e.fillStyle = z),
                  ...
                  E &&
                    e.drawImage(
                      E,
                      T.x + O - E.width - 4,
                      T.y + this._targetHeight + 10 - Math.abs(H - E.height) / 2,
                    )),
              e.restore();
          } else e.restore();
        }
      ...
      t.PredictionPaneView = class extends r {
        constructor(e, t) {
          ...
          (this._clockWhite = null),
            ...
            d("prediction-clock-white", i(99620)).then(function (e) {
              (n._clockWhite = e), r();
            }),
        ...
        _updateImpl() {
          if (
            ...
            if (d && a) {
              ...
              this._targetLine2 =
                i.tf(null, { context: "dates" }, i(91481)) + " " + L(new f().format(m));
            }
      ...
      class v extends g.DateAndPriceRangeBasePaneView {
        ...
        _updateImpl(e, t) {
          ...
          let y = m,
            b = w;
          y === b && (h && (y -= 1), g && (b += 1)),
            R(this._topBorderRenderer, new r.Point(y, v.y), new r.Point(b, v.y)),
            R(this._bottomBorderRenderer, new r.Point(y, x.y), new r.Point(b, x.y));
          ...
          const N = (0, n.ensureNotNull)(this._source.ownerSource()).formatter(),
            D =
              null !==
                (a = null === (i = N.formatChange) || void 0 === i ? void 0 : i.call(N, M, S)) &&
              void 0 !== a
                ? a
                : N.format(I),
            B = (0, s.forceLTRStr)(
          ...
          (null === (l = d.fillLabelBackground) || void 0 === l ? void 0 : l.value()) &&
            ((V.boxShadow = { shadowColor: d.shadow.value(), shadowBlur: 4, shadowOffsetY: 1 }),
        ...
        _updateImpl(e, t) {
          ...
          if (s.middleLine.childs().showLine.value()) {
            ...
            s.showLabel.value() &&
              ...
              (n =
                null !== (i = (0, a.getTextBoundaries)(this._textRenderer, t, e)) && void 0 !== i
                  ? i
                  : void 0);
            const { lineColor: r, lineWidth: o, lineStyle: d } = s.middleLine.state();
            l.middleLine = { lineColor: r, lineWidth: o, lineStyle: d, excludeBoundaries: n };
          }
          this._rectangleRenderer.setData(l), this._addAnchors(h, c, d), (this._renderer = d);
        }
        _addAnchors(e, t, i) {
        ...
        _updateImpl() {
          ...
          for (let t = 1; t < i.length; t++) {
            const n = i[t].color,
              ...
              u = new a.ParallelChannelRenderer(new s.HitTestResult(s.HitTarget.Regular));
            u.setData(c), e.append(u);
          }
    ...
    56457: (e, t, i) => {
      ...
      class A extends o.LineSourcePaneView {
        ...
        _creareMiddleLabel(e, t, i) {
          ...
          return (
            d < 0 ? (b = _.stopBackground.value()) : d > 0 && (b = _.profitBackground.value()),
    ...
    26294: (e, t, i) => {
      ...
      class L extends l.LineSourcePaneView {
        ...
        async _updateEmoji() {
          ...
          this._emojiCache = o;
          const [a, { svgRenderer: l }] = await Promise.all([s, i.e(2616).then(i.bind(i, 50765))]);
          !this._destroyed &&
            o.abortController &&
    ...
    67998: (e, t, i) => {
      ...
      class m extends x.TrendToolWithStatsPaneView {
        ...
        _updateImpl(e, t) {
          ...
          (S.data = 1), this._renderer.append(this.createLineAnchor({ points: [v, S] }, 0));
        }
      }
    },
    38058: (e, t, i) => {
    ...
    96310: (e, t, i) => {
      ...
      class g extends _.TrendToolWithStatsPaneView {
        ...
        _updateImpl(e, t) {
          ...
          this._trendRenderer.setData(b), this._renderer.append(this._trendRenderer);
          const T = (0, r.box)(new r.Point(0, 0), new r.Point(t, e));
          let P = !1;
          x.statsPosition.value() === d.StatsPosition.Auto &&
            (P = (0, r.equalPoints)(m, w)
              ? !(0, s.pointInBox)(m, T)
              : null === (0, o.intersectLineSegmentAndBox)((0, r.lineSegment)(m, w), T));
          if (
          ...
          this._middlePoint &&
            ...
            this.addAnchors(this._renderer),
            b.points.length >= 2 && this._addAlertRenderer(this._renderer, b.points);
        }
      }
    },
    48063: (e, t, i) => {
        ...
        L = new (class {
          constructor(e, t) {
            ...
            e.forEach((e) => {
              ...
              n.set(e.theme, new b(e.imageData, t, i)), this._icons.set(e.name, n);
            });
          }
          getIcon(e, t) {
      ...
      function E(e, t) {
        return (
          !(!e && !t) && (Boolean(e) !== Boolean(t) || e.index !== t.index || e.price !== t.price)
        );
      }
      function H(e, t) {
        return !(!e && !t) && (Boolean(e) !== Boolean(t) || e.valueOf() !== t.valueOf());
      }
      class V {
        constructor(e) {
        ...
        updateSource(e, t) {
          ...
          if (
            !(function (e, t) {
              ...
              return !H(i.leftUserTime, r.leftUserTime) && !H(i.rightUserTime, r.rightUserTime);
            })(o, a)
          ) {
            const e = t();
    ...
    2436: (e, t, i) => {
      ...
      function a(e, t, i, r, s, a) {
        const l = t.subtract(e).length() + i.subtract(t).length() + r.subtract(i).length(),
          d = Math.max(3 / l, 0.02);
        let h;
        for (let l = 0; ; l += d) {
          const d = o(e, t, i, r, l);
    ...
    23966: (e, t, i) => {
      ...
      class f extends _.MediaCoordinatesPaneRenderer {
        ...
        _drawImpl(e) {
          ...
          const t = e.context;
          t.fillStyle = (0, p.generateColor)(this._data.backcolor, this._data.transparency);
    ...
    18690: (e, t, i) => {
      ...
      function o(e, t, i, o, a, l, d) {
        ...
        if (e.x === t.x) {
          ...
          e.y < t.y
            ? u.push(
                new n.Point(e.x, 0 === d ? 0 : e.y < 0 ? e.y % d : -(d - (e.y % d))),
                new n.Point(t.x, l),
              )
            : u.push(
                new n.Point(
                  e.x,
                  0 === d ? l : e.y > l ? l + ((e.y - l) % d) : l + (d - ((l - e.y) % d)),
                ),
                new n.Point(t.x, 0),
              );
        } else if (e.y === t.y) {
          ...
          e.x < t.x
            ? u.push(
                new n.Point(0 === d ? 0 : e.x < 0 ? e.x % d : -(d - (e.x % d)), e.y),
                new n.Point(a, t.y),
              )
            : u.push(
                new n.Point(
                  0 === d ? a : e.x > a ? a + ((e.x - a) % d) : a + (d - ((a - e.x) % d)),
                  e.y,
                ),
                new n.Point(0, t.y),
              );
            ...
            if (d > 0 && (e.x <= 0 || (i && e.x < t.x))) {
              const t =
                e.x <= 0
                  ...
                  : d - (Math.sqrt(Math.pow(0 - e.x, 2) + Math.pow(p - e.y, 2)) % d);
              (h = Math.cos(Math.atan(s)) * t), (c = s * h), u.push(new n.Point(-h, p - c));
            ...
            if (d > 0 && (e.x >= a || (i && e.x > t.x))) {
              const t =
                e.x >= a
                  ...
                  : d - (Math.sqrt(Math.pow(e.x - a, 2) + Math.pow(e.y - _, 2)) % d);
              (h = Math.cos(Math.atan(s)) * t), (c = s * h), u.push(new n.Point(a + h, _ + c));
            ...
            if (d > 0 && (e.y <= 0 || (i && e.y < t.y))) {
              const t =
                e.y <= 0
                  ...
                  : d - (Math.sqrt(Math.pow(e.x - g, 2) + Math.pow(e.y - 0, 2)) % d);
            ...
            if (d > 0 && (e.y >= l || (i && e.y > t.y))) {
              const t =
                e.y >= l
                  ...
                  : d - (Math.sqrt(Math.pow(e.x - f, 2) + Math.pow(e.y - l, 2)) % d);
              (h = Math.cos(Math.atan(s)) * t),
                (c = s * h),
      ...
      class f extends p.MediaCoordinatesPaneRenderer {
        constructor(e, t) {
          super(),
            ...
            (this._hittestResult = e || new c.HitTestResult(c.HitTarget.MovePoint)),
            (this._backHittestResult = t || new c.HitTestResult(c.HitTarget.MovePointBackground));
        }
        setData(e) {
          (this._data = e), (this._backgroundPolygon = null), this._clippedLines.clear();
        }
        hitTest(e, t) {
          if (null === this._data) return null;
          ...
          for (const t of [i, n, r]) {
            ...
            if (i) {
              if ((0, d.distanceToSegment)(i.points[0], i.points[1], e).distance <= l)
          ...
          if (this._data.hittestOnBackground && this._data.fillBackground) {
            ...
            if (t.length > 0 && (0, a.pointInPolygon)(e, t)) return this._backHittestResult;
          }
          return null;
        }
        _drawImpl(e) {
          ...
          n && !this._data.skipLines && this._drawLine(l, n, this._data, e.mediaSize);
        }
        _drawLine(e, t, i, n) {
        ...
        _getClippedLine(e, t, i) {
          ...
          if (void 0 === n) {
            ...
            (n = null == h ? null : { ...e, points: h }), this._clippedLines.set(e, n);
          }
          return n;
        }
        _getBackgroundPolygon(e, t) {
          ...
          return (
            this._backgroundPolygon ||
              (this._backgroundPolygon =
                null !== (i = this._getBackgroundPolygonImpl(e, t)) && void 0 !== i ? i : []),
            this._backgroundPolygon
          );
        }
    ...
    10695: (e, t, i) => {
      ...
      class p extends o.MediaCoordinatesPaneRenderer {
          ...
          return (
            ...
            n.distance <= o
              ...
              : ((n = (0, r.distanceToSegment)(l, t, e)),
                n.distance <= o
                  ? new a.HitTestResult(a.HitTarget.MovePoint)
                  : this._data.fillBackground && (0, s.pointInTriangle)(e, t, i, l)
        ...
        _drawImpl(e) {
          ...
          const i = e.context,
            r =
              (null !== (t = this._data.linestyle) && void 0 !== t ? t : c.LINESTYLE_SOLID) ===
              c.LINESTYLE_SOLID
                ? "round"
                : "butt";
          (i.lineCap = r),
            ...
            void 0 !== this._data.linestyle && (0, h.setLineStyle)(i, this._data.linestyle);
          const [s, o, a = o] = this._data.points,
            { mediaSize: d } = e;
          if (
            this._data.fillBackground &&
            Math.abs((s.x - a.x) * (o.y - a.y) - (o.x - a.x) * (s.y - a.y)) > 1e-10
          ) {
            let e = [
              new n.Point(0, 0),
            ...
            if (
              ...
              (i.fillStyle = (0, l.generateColor)(this._data.backcolor, this._data.transparency)),
                i.fill(),
                i.restore();
            }
          }
          ...
          [
            ...
            const i = (0, u.intersectLineWithViewport)(e, t, !1, !1, d.width, d.height, _);
            i && p.push(i);
          }),
            p.length &&
              (i.beginPath(),
