    ...
    29638: (t, i, e) => {
      ...
      function d(t) {
        ...
        function C() {
          ...
          for (const i of r) if ("symbol" === i.type && !i.optional && "" === t[i.id]) return !0;
          return !1;
        }
        function M(t, i) {
          null == I || I(t, i), v(C());
      ...
      async function u(t, i, n, u, c) {
              ...
              if (i) {
                const { time: r, price: n } = i,
                  s = r.inline
                    ? o.t(
                        null,
                        { replace: { inputInline: r.inline, studyShortDescription: u } },
                        e(59877),
                      )
                    : o.t(null, { replace: { studyShortDescription: u } }, e(80481)),
                  p = y(t.id);
          ...
          const i = "time" === t.type,
            ...
            n = (function () {
              ...
              const r = t.name
                  ? o.t(
                      null,
                      { replace: { inputTitle: t.name, studyShortDescription: u } },
                      e(18571),
                    )
                  : o.t(null, { replace: { studyShortDescription: u } }, e(42917)),
                n = t.name
                  ? o.t(
                      null,
                      { replace: { inputTitle: t.name, studyShortDescription: u } },
                  ...
                  : o.t(null, { replace: { studyShortDescription: u } }, e(6083));
              return i ? r : n;
            })(),
            s = i ? t.id : void 0,
            p = i ? void 0 : t.id;
        ...
        async function S(i, e, o, s, u) {
          const c = await t.requestSelectPoint(
            { pointType: e, pane: a, lineColor: void 0, selectPointMode: p.SelectPointMode.Study },
            o,
          );
          void 0 === a && (a = c.pane);
          const h = n.childs().inputs;
          h &&
            (s && (0, r.ensureDefined)(h.child(s)).setValue(1e3 * (c.point.time || 0)),
