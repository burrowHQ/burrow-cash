  ...
  [4716],
  {
    ...
    88601: (t) => {
      (t.exports = Object.create(null)),
        ...
        (t.exports.from_input = ["从"]),
        (t.exports.to_input = ["致"]),
        (t.exports["{number} item_combobox_input"] = ["{number}个项目"]),
        (t.exports.Close_input = ["关闭"]),
        (t.exports.Style_input = ["样式"]),
        (t.exports["Box size assignment method_input"] = ["Box大小分配方法"]),
        (t.exports["Color bars based on previous close_input"] = ["基于前一收盘价的K线颜色"]),
        (t.exports.Candles_input = ["蜡烛"]),
        (t.exports.Borders_input = ["边框"]),
        (t.exports.Wick_input = ["烛芯"]),
        (t.exports["HLC bars_input"] = ["HLC K线"]),
        (t.exports["Price source_input"] = ["价格来源"]),
        (t.exports.Type_input = ["类型"]),
        (t.exports["Show real prices on price scale (instead of Heikin-Ashi price)_input"] = [
          "在价格坐标上显示实际价格(而不是Heikin-Ashi价格)",
        ]),
        (t.exports["Up bars_input"] = ["上涨K线"]),
        (t.exports["Down bars_input"] = ["下跌K线"]),
        (t.exports["Projection up bars_input"] = "Projection up bars"),
        (t.exports["Projection down bars_input"] = "Projection down bars"),
        (t.exports["Projection up color_input"] = ["投影向上颜色"]),
        (t.exports["Projection down color_input"] = ["投影向下颜色"]),
        (t.exports.Line_input = ["线形图"]),
        (t.exports.Fill_input = ["填充"]),
        (t.exports["Up color_input"] = ["上涨颜色"]),
        (t.exports["Down color_input"] = ["下跌颜色"]),
        (t.exports.Traditional_input = ["传统"]),
        (t.exports["Box size_input"] = ["Box大小"]),
        (t.exports["Number of line_input"] = ["线条数量"]),
        (t.exports["ATR length_input"] = ["ATR长度"]),
        (t.exports["Reversal amount_input"] = ["反转数量"]),
        (t.exports["Phantom bars_input"] = ["虚拟K线"]),
        (t.exports["One step back building_input"] = ["上一步建构"]),
        (t.exports.Source_input = ["来源"]),
        (t.exports.Wicks_input = ["烛芯"]),
        (t.exports.Range_input = ["范围"]),
        ...
        (t.exports["Leading Span Periods_input"] = ["先行带周期"]),
        (t.exports["Leading Shift Periods_input"] = ["领先的转化周期"]),
    ...
    68716: (t) => {
      (t.exports = Object.create(null)),
        ...
        (t.exports["All Chart Patterns_study"] = ["所有图表形态"]),
        ...
        (t.exports["Relative Volume at Time_study"] = ["某一时间的相对交易量"]),
        ...
        (t.exports["Stochastic Momentum Index_study"] = ["随机动量指数"]),
        (t.exports["Stochastic RSI_study"] = ["随机相对强弱指数(Stoch RSI)"]),
        (t.exports.Stochastic_study = ["随机指数(Stochastic)"]),
        (t.exports["Time Weighted Average Price_study"] = ["时间加权平均价格"]),
        ...
        (t.exports["Harami Cross - Bearish_study"] = ["十字孕线 - 看跌"]),
        (t.exports["Harami Cross - Bullish_study"] = ["十字孕线 - 看涨"]),
        ...
        (t.exports["Anchored Volume Profile_study"] = ["锚定成交量分布图"]);
    },
    59791: (t) => {
      t.exports = ["锚定成交量分布图"];
    },
    ...
    35696: (t) => {
      t.exports = ["更改时间周期。按数字或逗号"];
    },
    71705: (t) => {
      t.exports = ["更改商品。开始输入商品名称"];
    },
    86715: (t) => {
      t.exports = ["图表 #{index}"];
    },
    ...
    29787: (t) => {
      t.exports = ["开始使用键盘导航模式。按{shortcut}"];
    },
    93161: (t) => {
      t.exports = ["保持绘图模式"];
    },
    ...
    81214: (t) => {
      t.exports = ["该脚本包含一个错误。请联系其作者。"];
    },
    74986: (t) => {
      t.exports = ["此脚本仅限邀请。要请求访问，请联系其作者。"];
    },
    58018: (t) => {
      t.exports = ["此商品代码仅在{linkStart}TradingView{linkEnd}上可用"];
    },
    98538: (t) => {
      t.exports = ["三驱形态"];
    },
    ...
    82772: (t) => {
      t.exports = ["BIST MIXED数据方案中不提供交易量数据。"];
    },
    78560: (t) => {
      t.exports = ["成交量轨迹"];
    },
    ...
    47228: (t) => {
      t.exports = ["{chartStyle} 图表类型目前不可用于基于tick的周期。"];
    },
    33355: (t) => {
      t.exports = ["{count}根K线"];
    },
    87826: (t) => {
      t.exports = ["{p_start}此商品不支持基于tick的时间周期。您将自动切换到D时间周期。{p_end}"];
    },
    88841: (t) => {
    ...
    18562: (t) => {
      (t.exports = Object.create(null)),
        ...
        (t.exports["#NSE:NIFTY-symbol-description"] = ["Nifty 50指数"]),
        ...
        (t.exports["#FTSEMYX:FBMKLCI-symbol-description"] = ["FTSE马来西亚吉隆坡综合指数"]),
        ...
        (t.exports["#TADAWUL:2370-symbol-description"] = ["中东特种电缆公司"]);
    },
  },
]);
