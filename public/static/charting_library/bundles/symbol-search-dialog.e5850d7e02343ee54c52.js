  ...
  [1754],
  {
    ...
    9745: (e, t, r) => {
      ...
      const i = o.forwardRef((e, t) => {
        const { icon: r = "", ...i } = e;
        return o.createElement("span", { ...i, ref: t, dangerouslySetInnerHTML: { __html: r } });
      });
    },
    99663: (e, t, r) => {
      "use strict";
      ...
      const o = (() => {
        ...
        return () => {
          ...
          if (void 0 === e) {
            ...
            null === (t = r.parentNode) || void 0 === t || t.removeChild(r), (e = i - n);
          }
          return e;
        };
      })();
      ...
      function l(e) {
        ...
        if (e && 1 == ++a) {
          ...
          "hidden" !== e.toLowerCase() &&
            ...
            (i(r, "right", `${o()}px`), (t.style.paddingRight = `${a + o()}px`), (c = !0)),
    ...
    89324: (e, t, r) => {
      ...
      function l(e) {
        ...
        const t = (0, s.getSymbolSearchCompleteOverrideFunction)(),
          ...
          m = {
            ...u,
            showSpreadActions: null != c ? c : (0, i.canShowSpreadActions)(),
        ...
        (0, n.showSymbolSearchItemsDialog)({ ...m, defaultValue: r });
      }
    ...
    1861: (e, t, r) => {
      ...
      function c(e) {
        ...
        function M() {
          i.unmountComponentAtNode(N), n.dialogsOpenerManager.setAsClosed("SymbolSearch"), g && g();
        }
        return (
          i.render(E, N), n.dialogsOpenerManager.setAsOpened("SymbolSearch"), b && b(), { close: M }
        );
      }
    },
    51826: (e, t, r) => {
    ...
    50655: (e, t, r) => {
      "use strict";
      r.d(t, { Slot: () => o.Slot, SlotContext: () => o.SlotContext });
      var o = r(99663);
    },
    16936: (e) => {
      e.exports = {
